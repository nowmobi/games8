...
*********************************************/
	...
	*********************************************/
	...
	leaderboard.prototype.version = "1.0.1";
	/*********************************************
				function
	*********************************************/
	leaderboard.prototype.init = function() {
		window.eventToFire.registerEvent("leaderboard:onSubmitScoreSucceeded", function(result){	c2_callFunction("leaderboard_onSubmitScoreSucceeded");	});
		window.eventToFire.registerEvent("leaderboard:onSubmitScoreFailed", function(result){	c2_callFunction("leaderboard_onSubmitScoreFailed");	});
		var that = this;
