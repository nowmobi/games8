...
document.addEventListener("deviceready", 
	function() {
		...
		AppRate.preferences.storeAppURL.ios = '1458483490';
		AppRate.preferences.storeAppURL.android = 'market://details?id=net.playtouch.thegame13';
		checkStorage();
	}, false
);
