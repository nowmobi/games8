! function() {
    ...
    function A(t, n) {
        this.c = t, this.f = n, this.a = s(this.c, "span", {
            "aria-hidden": "true"
        }, this.f)
    }
    ...
    function F(t, n, i, e, o, a, s) {
        this.v = t, this.B = n, this.c = i, this.a = e, this.s = s || "BESbswy", this.f = {}, this.w = o || 3e3, this.u = a || null, this.o = this.j = this.h = this.g = null, this.g = new A(this.c, this.s), this.h = new A(this.c, this.s), this.j = new A(this.c, this.s), this.o = new A(this.c, this.s), t = E(t = new y(this.a.c + ",serif", x(this.a))), this.g.a.style.cssText = t, t = E(t = new y(this.a.c + ",sans-serif", x(this.a))), this.h.a.style.cssText = t, t = E(t = new y("serif", x(this.a))), this.j.a.style.cssText = t, t = E(t = new y("sans-serif", x(this.a))), this.o.a.style.cssText = t, N(this.g), N(this.h), N(this.j), N(this.o)
    }
    ...
    function L(t) {
        var n, o = t.g.a.offsetWidth,
            a = t.h.a.offsetWidth;
        (n = o === t.f.serif && a === t.f["sans-serif"]) || (n = P() && B(t, o, a)), n ? e() - t.A >= t.w ? P() && B(t, o, a) && (null === t.u || t.u.hasOwnProperty(t.a.c)) ? D(t, t.v) : D(t, t.B) : function(t) {
    ...
    F.prototype.start = function() {
        this.f.serif = this.j.a.offsetWidth, this.f["sans-serif"] = this.o.a.offsetWidth, this.A = e(), L(this)
    };
    var q = null;
            ...
            if (0 === e.length && s) T(n.a);
                ...
                for (f = 0; f < e.length; f++) {
                    var l = e[f],
                        ...
                        p = n.a,
                        d = l;
                    if (p.g && c(p.f, [p.a.c("wf", d.c, x(d).toString(), "loading")]), S(p, "fontloading", d), p = null, null === q)
                        if (window.FontFace) {
                            ...
                            q = d ? 42 < parseInt(d[1], 10) : !g
                        } else q = !1;
                    p = q ? new W(i(n.g, n), i(n.h, n), n.c, l, n.s, u) : new F(i(n.g, n), i(n.h, n), n.c, l, n.s, t, u), h.push(p)
                }
    ...
    $.prototype.g = function(t) {
        var n = this.a;
        n.g && c(n.f, [n.a.c("wf", t.c, x(t).toString(), "active")], [n.a.c("wf", t.c, x(t).toString(), "loading"), n.a.c("wf", t.c, x(t).toString(), "inactive")]), S(n, "fontactive", t), this.o = !0, H(this)
        ...
        if (n.g) {
            ...
            i || e.push(n.a.c("wf", t.c, x(t).toString(), "inactive")), c(n.f, e, o)
        }
        S(n, "fontinactive", t), H(this)
    }, M.prototype.load = function(t) {
        this.c = new o(this.j, t.context || this.j), this.g = !1 !== t.events, this.f = !1 !== t.classes,
            function(t, n, i) {
                var e = [],
                    o = i.timeout;
                ! function(t) {
            ...
            if (a["__mti_fntLst" + e]) {
                ...
                if (o)
                    for (var r = 0; r < o.length; r++) {
                        ...
                        null != o[r].fontStyle && null != o[r].fontWeight ? (i = o[r].fontStyle + o[r].fontWeight, s.push(new y(f, i))) : s.push(new y(f))
                    }
                t(s)
    ...
    Z.prototype.load = function(t) {
        ...
        ! function(t) {
            for (var n = t.f.length, i = 0; i < n; i++) {
                ...
                if (2 <= e.length) {
                    ...
                    if (s = [], r = e[1])
                        for (var r, f = (r = r.split(",")).length, c = 0; c < f; c++) {
                            var h;
                            if ((h = r[c]).match(/^[\w-]+$/))
                                if (null == (l = Y.exec(h.toLowerCase()))) h = "";
                                else {
                                    if (h = null == (h = l[2]) || "" == h ? "n" : Q[h], null == (l = l[1]) || "" == l) l = "4";
                                    else var l = J[l] || (isNaN(l) ? "4" : l.substr(0, 1));
                                    h = [h, l].join("")
                                }
                            else h = "";
                            h && s.push(h)
                ...
                for (t.c[o] || (e = X[o]) && (t.c[o] = e), e = 0; e < a.length; e += 1) t.a.push(new y(o, a[e]))
            }
        }(a), u(i, function(t) {
