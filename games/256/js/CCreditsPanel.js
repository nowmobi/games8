function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oLinkOutline = new createjs.Text("www.immanitas.com"," 26px "+FONT_GAME, "#000");
        ...
        var oLink = new createjs.Text("www.immanitas.com"," 26px "+FONT_GAME, "#fcff00");
    ...
    this._onLogoButRelease = function(){
        window.open("https://www.immanitas.com");
    };
