function CGame(oData, szTeam){
    ...
    this.controlIfCanContinue = function(){
        if(_iGoalScored >= _iGoalToScore && _iKickLeft <= 1){
            ...
            if(_iLevel === NUM_LEVEL){
                ...
                _oEndPanel = CEndPanel(s_oSpriteLibrary.getSprite('bg_win'), s_oSpriteLibrary.getSprite('you_win'));
    ...
    this.gameOver = function(){   
        _iRound = 0;
        _iScoreToAttribute = 0;
        _oEndPanel = CEndPanel(s_oSpriteLibrary.getSprite('bg_next_level'), s_oSpriteLibrary.getSprite('game_over'));
