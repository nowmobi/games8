...
function butEventHandler(_id, _oData) {
    switch (_id) {
        ...
        case "credits":
            playSound("click");
            var url = "http://www.hyhygames.com?utm_campaign=skibidi-jigsaw-puzzle&utm_source=gamemonetize.com&utm_medium=game_referral&utm_content=logo";
        ...
        case "backFromGame":
            playSound("click");
            var url = "http://www.hyhygames.com?utm_campaign=royal-skibidi-puzzle&utm_source=gamemonetize.com&utm_medium=game_referral&utm_content=logo";
            var open = window.open(url);
            if (open == null || typeof(open) == 'undefined') {
                location.href = url;
            }
