function CInterface(iPlayerTeam, iOpponentTeam) {
    ...
    this.createEndMatchText = function (iGoalPlayer, iOpponentPlayer, bWin, iScore, bEnd) {
        ...
        var oEndMatchText = new CTLText(oContainer, 
                    -300,0, 600, 100, 
                    ...
                    true, true, false,
                    false );
        oEndMatchText.setStroke(5,"#ff6000");    
    ...
    this.createExtendedTimeText = function () {
        ...
        var oExtTimeText = new CTLText(oContainer, 
                   -300,0, 600, 100, 
                    50, "center", TEXT_COLOR, FONT_GAME, 1,
                    0, 0,
                    TEXT_TIME_EXTENDED,
                    true, true, true,
                    false );
        oExtTimeText.setStroke(5,"#ff6000")            
    ...
    this.createStartMatchText = function () {
        ...
        var oStartMatchText = new CTLText(oContainer, 
                    -300,0, 600, 100, 
                    50, "center", TEXT_COLOR, FONT_GAME, 1,
                    0, 0,
                    TEXT_KICK_OFF,
                    true, true, true,
                    false );
        oStartMatchText.setStroke(5,"#ff6000");         
    ...
    this.turnAnim = function (szText) {
        ...
        var oTurnMatchText = new CTLText(oContainer, 
                    -300,0, 600, 100, 
                    50, "center", TEXT_COLOR, FONT_GAME, 1,
                    0, 0,
                    szText,
                    true, true, true,
                    false );
        oTurnMatchText.setStroke(5,"#ff6000");
