    ...
    var AudioPlayer = /** @class */ (function () {
        ...
        */
        ...
        AudioPlayer.prototype.boxPlay = function (box, xExpand, yExpand, shake, pitch) {
            ...
            AudioPlayer.viewBox.x = Game.Player.xdra - Engine.Renderer.xSizeView * 0.5 - xExpand * 0.5;
            AudioPlayer.viewBox.y = Game.Player.ydra - Engine.Renderer.ySizeView * 0.5 - yExpand * 0.5;
        ...
        AudioPlayer.prototype.autoplay = function (pitch) {
            ...
            if (Engine.AudioManager.mode == Engine.AudioManagerMode.WEB) {
                ...
                //@ts-ignore
                this.source[this.source.start ? 'start' : 'noteOn'](0, this.source.loop ? 90 * 0 : 0);
            }
            else if (Engine.AudioManager.mode == Engine.AudioManagerMode.HTML) {
                //if(AudioManager.verified){
                this.play();
...
(function (Engine) {
    ...
    var Renderer = /** @class */ (function () {
        ...
        Renderer.clearRed = 38.0 / 255.0;
        Renderer.clearGreen = 43.0 / 255.0;
        Renderer.clearBlue = 68.0 / 255.0;
...
(function (Game) {
    ...
    Engine.System.onInit = function () {
        if (Engine.Data.useLocalStorage) {
            Engine.Data.setID("com", "kez", "timwit");
        }
        else {
            Engine.Data.setID("c", "k", "timwit");
        }
                ...
                for (var yIndex = 0; yIndex < this.yCountTiles; yIndex += 1) {
                    for (var xIndex = 0; xIndex < this.xCountTiles; xIndex += 1) {
                        ...
                        if (data == 0)
                            continue;
                        data--;
                        var yPixTil = Math.floor(data / Math.floor(Game.Resources.texgam.assetData.xSize / (this.xSizeTile + this.offsetTiles)));
                        var xPixTil = data - (yPixTil * Math.floor(Game.Resources.texgam.assetData.ySize / (this.xSizeTile + this.offsetTiles)));
                        ...
                        for (var xPix = 0; xPix < this.xSizeTile; xPix += 1) {
                            for (var yPix = 0; yPix < this.ySizeTile; yPix += 1) {
                                var alpha = Game.Resources.texgam.getAlpha(xPixPut + xPix, yPixPut + yPix);
                                if (alpha != 0) {
                                    var red = Game.Resources.texgam.getRed(xPixPut + xPix, yPixPut + yPix);
                                    var green = Game.Resources.texgam.getGreen(xPixPut + xPix, yPixPut + yPix);
                                    var blue = Game.Resources.texgam.getBlue(xPixPut + xPix, yPixPut + yPix);
...
(function (Game) {
    ...
    var Credits = /** @class */ (function (_super) {
        ...
        function Credits() {
            ...
            var devone = new Utils.Text();
            devone.font = Game.FontManager.a;
            devone.scale = 1;
            devone.enabled = true;
            devone.pinned = true;
            devone.str = "DESIGN AND CODE:";
            devone.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            devone.xAlignView = Utils.AnchorAlignment.MIDDLE;
            devone.yAlignBounds = Utils.AnchorAlignment.START;
            devone.yAlignView = Utils.AnchorAlignment.MIDDLE;
            devone.yAligned = Game.CreditsFrame.spr.y + 5;
            var devtwo = new Utils.Text();
            devtwo.font = Game.FontManager.a;
            devtwo.scale = 1;
            devtwo.enabled = true;
            devtwo.pinned = true;
            devtwo.str = "NOA";
            devtwo.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            devtwo.xAlignView = Utils.AnchorAlignment.MIDDLE;
            devtwo.yAlignBounds = Utils.AnchorAlignment.START;
            devtwo.yAlignView = Utils.AnchorAlignment.MIDDLE;
            devtwo.yAligned = devone.y + OFFSET_SINGLE;
            var graone = new Utils.Text();
            graone.font = Game.FontManager.a;
            graone.scale = 1;
            graone.enabled = true;
            graone.pinned = true;
            graone.str = "GRAPHICS:";
            graone.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            graone.xAlignView = Utils.AnchorAlignment.MIDDLE;
            graone.yAlignBounds = Utils.AnchorAlignment.START;
            graone.yAlignView = Utils.AnchorAlignment.MIDDLE;
            graone.yAligned = devtwo.y + OFFSET_DOUBLE;
            var gratwo = new Utils.Text();
            gratwo.font = Game.FontManager.a;
            gratwo.scale = 1;
            gratwo.enabled = true;
            gratwo.pinned = true;
            gratwo.str = "KALPAR";
            gratwo.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            gratwo.xAlignView = Utils.AnchorAlignment.MIDDLE;
            gratwo.yAlignBounds = Utils.AnchorAlignment.START;
            gratwo.yAlignView = Utils.AnchorAlignment.MIDDLE;
            gratwo.xAligned = 0;
            gratwo.yAligned = graone.y + OFFSET_SINGLE;
            var musone = new Utils.Text();
            musone.font = Game.FontManager.a;
            musone.scale = 1;
            musone.enabled = true;
            musone.pinned = true;
            musone.str = "MUSIC:";
            musone.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            musone.xAlignView = Utils.AnchorAlignment.MIDDLE;
            musone.yAlignBounds = Utils.AnchorAlignment.START;
            musone.yAlignView = Utils.AnchorAlignment.MIDDLE;
            musone.yAligned = gratwo.y + OFFSET_DOUBLE;
            var mustwo = new Utils.Text();
            mustwo.font = Game.FontManager.a;
            mustwo.scale = 1;
            mustwo.enabled = true;
            mustwo.pinned = true;
            mustwo.str = "KOMIKU";
            mustwo.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            mustwo.xAlignView = Utils.AnchorAlignment.MIDDLE;
            mustwo.yAlignBounds = Utils.AnchorAlignment.START;
            mustwo.yAlignView = Utils.AnchorAlignment.MIDDLE;
            mustwo.xAligned = 0;
            mustwo.yAligned = musone.y + OFFSET_SINGLE;
            var thuone = new Utils.Text();
            thuone.font = Game.FontManager.a;
            thuone.scale = 1;
            thuone.enabled = true;
            thuone.pinned = true;
            thuone.str = "THUMBNAIL:";
            thuone.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            thuone.xAlignView = Utils.AnchorAlignment.MIDDLE;
            thuone.yAlignBounds = Utils.AnchorAlignment.START;
            thuone.yAlignView = Utils.AnchorAlignment.MIDDLE;
            thuone.yAligned = mustwo.y + OFFSET_DOUBLE;
            var thutwo = new Utils.Text();
            thutwo.font = Game.FontManager.a;
            thutwo.scale = 1;
            thutwo.enabled = true;
            thutwo.pinned = true;
            thutwo.str = "NIELDACAN";
            thutwo.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            thutwo.xAlignView = Utils.AnchorAlignment.MIDDLE;
            thutwo.yAlignBounds = Utils.AnchorAlignment.START;
            thutwo.yAlignView = Utils.AnchorAlignment.MIDDLE;
            thutwo.xAligned = 0;
            thutwo.yAligned = thuone.y + OFFSET_SINGLE;
            _this.backButton = new Game.DialogButton(4, 0, 5 + _this.yButtons + 16 + 8 - 4 + 2 - 1 + (Y_SIZE_BUTTON + Y_SPEARATION_BUTTONS) * Y_COUNT_BUTTONS + 2 - 7 - 0.5 - 4 - 0);
            ...
            _this.backButton.text.xAligned = _this.backButton.dialog.spr.x;
            _this.backButton.text.yAligned = _this.backButton.dialog.spr.y;
...
(function (Game) {
    ...
    Game.addAction("configure", function () {
        fra = Game.FrameSelector.complex("lastscene", Game.Resources.texgam, 200, 48);
    ...
    var LastScene = /** @class */ (function (_super) {
        ...
        function LastScene() {
            ...
            if (Game.Level.speedrun) {
                ...
                tex.text.yAligned = -20.5 + 10 + 4 + pepe + 8;
            ...
            */
            ...
            fra[Game.IS_TOUCH ? 4 : 3].applyToSprite(exi.bounds);
            ...
            exi.anchor.yAligned = pepe + 12 + 12 - 6 + 1 - 0.5;
...
(function (Game) {
    ...
    var LevelSelection = /** @class */ (function (_super) {
        ...
        function LevelSelection() {
            ...
            _this.switchButton.text.xAligned = _this.switchButton.dialog.spr.x;
            _this.switchButton.text.yAligned = _this.switchButton.dialog.spr.y;
            ...
            _this.switchButton2.text.xAligned = _this.switchButton2.dialog.spr.x;
            _this.switchButton2.text.yAligned = _this.switchButton2.dialog.spr.y;
        ...
        LevelSelection.prototype.createButtons = function () {
            ...
            for (var yIndex = 0; yIndex < Y_COUNT_BUTTONS; yIndex += 1) {
                for (var xIndex = 0; xIndex < X_COUNT_BUTTONS; xIndex += 1) {
                    ...
                    this.buttons[count].text.xAligned = this.buttons[count].dialog.spr.x;
                    this.buttons[count].text.yAligned = this.buttons[count].dialog.spr.y;
                ...
                if (count <= Game.MAX_LEVELS) {
                    ...
                    switch (Game.dataLevels[count]) {
                        case "locked":
                            ...
                            button.dialog.spr.setRGBA(1, 1, 1, 0);
                        ...
                        case "unlocked":
                            ...
                            button.dialog.setIndex(3);
                            button.dialog.spr.setRGBA(1, 1, 1, 1);
                            button.text.font = Game.FontManager.a;
    ...
    var MainMenu = /** @class */ (function (_super) {
        ...
        function MainMenu() {
            ...
            if (true || Game.IS_TOUCH) {
                //var xsize = 60;
                //var ysize = 15;
                var ypos = -12 + 6 + 4 + 8 - 8 - 1 + 3 + 0.5 + 3 + 1 - 1;
                var yoff = 20;
                var xpos = 0;
                var xoff = 29.5;
                if (Game.HAS_LINKS) {
                ...
                _this.start.text.xAligned = _this.starttouch.spr.x;
                _this.start.text.yAligned = _this.starttouch.spr.y;
                _this.start.text.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
                _this.start.control.bounds = _this.starttouch.spr;
                //this.start.arrows.yOffset -= 0.5;
                _this.speedrun.text.xAligned = _this.speedruntouch.spr.x;
                _this.speedrun.text.yAligned = _this.speedruntouch.spr.y;
                _this.speedrun.text.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
                _this.speedrun.control.bounds = _this.speedruntouch.spr;
                //this.speedrun.arrows.yOffset -= 0.5;
                _this.credits.text.xAligned = _this.creditstouch.spr.x;
                _this.credits.text.yAligned = _this.creditstouch.spr.y;
                _this.credits.text.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
                _this.credits.control.bounds = _this.creditstouch.spr;
                //this.credits.arrows.yOffset -= 0.5;
                if (Game.HAS_LINKS) {
                    _this.moregames.text.xAligned = _this.moregamestouch.spr.x;
                    _this.moregames.text.yAligned = _this.moregamestouch.spr.y + 0.5;
                    _this.moregames.text.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
                    _this.moregames.control.bounds = _this.moregamestouch.spr;
                    //this.moregames.arrows.yOffset -= 0.5;
                }
                if (MainMenu.typ == 1) {
                    _this.loadMap(Game.Resources.PATH_MAP_MAIN_MENU_TYP_1);
                }
                else {
                    if (Game.HAS_LINKS) {
                        _this.loadMap(Game.goatyp == 0 ? Game.Resources.PATH_MAP_MAIN_MENU : Game.Resources.PATH_MAP_MAIN_MENU_EX);
                    }
                    else {
                        _this.loadMap(Game.goatyp == 0 ? Game.Resources.PATH_MAP_MAIN_MENU : Game.Resources.PATH_MAP_MAIN_MENU_EX_NL);
                    }
                }
            }
            ...
            //this.fillBlue.enabled = true;
            //this.loadSky(Resources.PATH_MAP_SKY);
            new Game.TitleLabel(-31 + 1 - 4.5 - 4 + 2 + 1 - 1 - 13);
            new Game.AudioFrame();
            Game.triggerActions("mainmenu");
            new Game.Sky();
            if (MainMenu.typ == 1) {
                new Game.TerrainFill(3);
            }
            else {
        ...
        MainMenu.prototype.startPressed = function () {
            if (this.nextSceneClass == null) {
                ...
                Game.SceneFade.setColor(38, 43, 68);
        ...
        MainMenu.prototype.onTimeUpdate = function () {
            ...
            if (this.linkChecked && this.linkChecked2 < 0.25) {
                ...
                if (this.linkChecked2 >= 0.25) {
                    //this.kezarts.control.url = HAS_LINKS ? URL_KEZARTS : null;
                    if (Game.HAS_LINKS)
...
(function (Game) {
    ...
    var SpeedrunMenu = /** @class */ (function (_super) {
        ...
        function SpeedrunMenu() {
            ...
            recordA.xAligned = 0;
            recordA.yAligned = Game.SpeedrunFrame.spr.y + 5;
            ...
            _this.newButton.text.xAligned = _this.newButton.dialog.spr.x;
            _this.newButton.text.yAligned = _this.newButton.dialog.spr.y;
            ...
            _this.continueButton.text.yAligned = _this.continueButton.dialog.spr.y;
...
(function (Game) {
    var Level = /** @class */ (function (_super) {
        ...
        function Level() {
            ...
            new Game.Sky();
            new Game.TerrainFill(Level.index < 14 ? 1 : 2);
            new Game.LevelAdLoader();
            return _this;
        }
        ...
        Level.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (this.nextSceneClass == null && Game.Player.haswon) {
            ...
            if (this.nextSceneClass == null && Game.Player.haslos) {
        ...
        Level.prototype.onTimeUpdateSceneBeforeDrawFixed = function () {
            ...
            //var x = this.xSizeMap * 0.5;
            //var y = this.ySizeMap * 0.5;
            var x = Game.Player.xdra;
            var y = Game.Player.ydra;
...
(function (Game) {
    ...
    var LevelPauseUI = /** @class */ (function (_super) {
        ...
        function LevelPauseUI() {
            ...
            _this.fill.setRGBA(38 / 255.0, 43 / 255.0, 68 / 255.0, FILL_A);
            _this.onViewUpdate();
...
(function (Game) {
    var LevelSaveManager = /** @class */ (function (_super) {
        ...
        LevelSaveManager.prototype.onStepUpdate = function () {
            if (!this.winSaved && Game.Player.win) {
...
(function (Game) {
    ...
    var LevelShake = /** @class */ (function (_super) {
        ...
        LevelShake.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (!this.triggered && Game.Player.los) {
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("exit button", Game.Resources.texgam, 871, 335);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("music button", Game.Resources.texgam, 509, 335);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("pause button", Game.Resources.texgam, 669, 335);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("reset button", Game.Resources.texgam, 829, 335);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("sound button", Game.Resources.texgam, 589, 335);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("timmer button", Game.Resources.texgam, 749, 335);
    });
    var TimerButton = /** @class */ (function (_super) {
        ...
        TimerButton.prototype.onPressed = function () {
            if (Game.Scene.nextSceneClass == null) {
                ...
                this.fix();
                Engine.Data.save("timeron", TimerButton.on ? 1 : 0, 60);
            }
        };
    ...
    var SpeedrunTimer = /** @class */ (function (_super) {
        ...
        function SpeedrunTimer() {
            ...
            */
            ...
            _this.text.yAlignView = Utils.AnchorAlignment.START;
            _this.text.xAligned = 0;
            _this.text.enabled = Game.Level.speedrun;
            _this.textDown.font = Game.Level.speedrun ? Game.FontManager.b : Game.FontManager.a;
            _this.textDown.scale = 1;
            _this.textDown.enabled = true;
            _this.textDown.pinned = true;
            _this.textDown.str = "0.00";
            ...
            _this.textDown.enabled = Game.Level.speedrun;
            new Game.TimerFrame();
            _this.fix();
            return _this;
        }
        SpeedrunTimer.prototype.fix = function () {
            if (!Game.SceneFreezer.paused) {
                ...
                this.text.xAligned = -10 - 1 - 4 - 2 + 2 + 1;
                ...
                this.textDown.xAligned = -10 - 1 - 4 - 2 + 2 + 1;
                this.textDown.yAligned = Game.Level.speedrun ? 9 : 2;
            }
            else {
                this.text.xAlignView = Utils.AnchorAlignment.MIDDLE;
                this.text.yAlignView = Utils.AnchorAlignment.END;
                this.text.xAligned = 0.5;
                this.text.yAligned = Game.TimerButton.on ? -15 : -8;
                ...
                this.textDown.yAligned = Game.TimerButton.on ? -8 : -15;
            }
            /*
        ...
        SpeedrunTimer.prototype.onStepUpdate = function () {
            if (!Game.Player.win && !Game.Player.los && !Game.SceneFreezer.stoped) {
...
(function (Game) {
    var FontManager = /** @class */ (function () {
        ...
        FontManager.createFondts = function () {
            ...
            FontManager.a.setFull(Game.Resources.texgam, 0, 48, 0);
            FontManager.b = new Utils.Font();
            FontManager.b.setFull(Game.Resources.texgam, 0, 89, 0);
            FontManager.c = new Utils.Font();
            FontManager.c.setFull(Game.Resources.texgam, 0, 130, 0);
            FontManager.d = new Utils.Font();
            FontManager.d.setFull(Game.Resources.texgam, 0, 171, 0);
            FontManager.e = new Utils.Font();
            FontManager.e.setFull(Game.Resources.texgam, 0, 212, 0);
            FontManager.f = new Utils.Font();
            FontManager.f.setFull(Game.Resources.texgam, 0, 253, 0);
            FontManager.ads = new Utils.Font();
            FontManager.ads.setFull(Game.Resources.texgam, 0, 294, 0);
            FontManager.ads1 = new Utils.Font();
            FontManager.ads1.setFull(Game.Resources.texgam, 0, 294, 0);
            FontManager.ads2 = new Utils.Font();
            FontManager.ads2.setFull(Game.Resources.texgam, 0, 352, 0);
            FontManager.ads3 = new Utils.Font();
            FontManager.ads3.setFull(Game.Resources.texgam, 0, 410, 0);
            FontManager.off = new Utils.Font();
            FontManager.off.setFull(Game.Resources.texgam, 0, 294, 0);
        };
        return FontManager;
    }());
...
var Game;
(function (Game) {
    var PATH_MUSIC = "Assets/Audio/Komiku_-_54_-_Escaping_like_Indiana_Jones.omw";
    var patbre = "Assets/Audio/bre.wom";
    var patdis = "Assets/Audio/dis.wom";
    var patgem = "Assets/Audio/gem.wom";
    var pathid = "Assets/Audio/hid.wom";
    var patjum = "Assets/Audio/jum.wom";
    var patlos = "Assets/Audio/los.wom";
    var patres = "Assets/Audio/res.wom";
    var pattom = "Assets/Audio/tom.wom";
    ...
    var Resources = /** @class */ (function () {
        ...
        Resources.PATH_MAP_MAIN_MENU_TYP_1 = Resources.PATH_MAPS + "MainMenu-Typ-1.json";
        Resources.PATH_MAP_MAIN_MENU_EX = Resources.PATH_MAPS + "MainMenu-Ex.json";
        Resources.PATH_MAP_MAIN_MENU_EX_NL = Resources.PATH_MAPS + "MainMenu-Ex-NL.json";
    ...
    Game.addPath("preload", Resources.PATH_MAP_MAIN_MENU_EX);
    Game.addPath("preload", Resources.PATH_MAP_MAIN_MENU_EX_NL);
    Game.addPath("preload", Resources.PATH_MAP_MAIN_MENU_TYP_1);
    ...
    Game.addPath("load", patbre);
    Game.addPath("load", patdis);
    Game.addPath("load", patgem);
    Game.addPath("load", pathid);
    Game.addPath("load", patjum);
    Game.addPath("load", patlos);
    Game.addPath("load", patres);
    Game.addPath("load", pattom);
    ...
    Game.addAction("configure", function () {
        ...
        Resources.bgms[0].volume = Resources.bgms[0].restoreVolume = 1.9 * volumeScale;
        Resources.bgms[0].loopStart = 8.73978;
        Resources.bgms[0].loopEnd = 95.99997;
        Game.bgms.push(Resources.bgms[0]);
        Resources.audbre = new Engine.AudioPlayer(patbre);
        Resources.audbre.preserved = true;
        Resources.audbre.volume = Resources.audbre.restoreVolume = 6.5 * volumeScale * sfxsca;
        Game.sfxs.push(Resources.audbre);
        Resources.auddis = new Engine.AudioPlayer(patdis);
        Resources.auddis.preserved = true;
        Resources.auddis.volume = Resources.auddis.restoreVolume = 7.5 * volumeScale * sfxsca;
        Game.sfxs.push(Resources.auddis);
        Resources.audgem = new Engine.AudioPlayer(patgem);
        Resources.audgem.preserved = true;
        Resources.audgem.volume = Resources.audgem.restoreVolume = 6.5 * volumeScale * sfxsca;
        Game.sfxs.push(Resources.audgem);
        Resources.audhid = new Engine.AudioPlayer(pathid);
        Resources.audhid.preserved = true;
        Resources.audhid.volume = Resources.audhid.restoreVolume = 5.1 * volumeScale * sfxsca;
        Game.sfxs.push(Resources.audhid);
        Resources.audjum = new Engine.AudioPlayer(patjum);
        Resources.audjum.preserved = true;
        Resources.audjum.volume = Resources.audjum.restoreVolume = 7.5 * volumeScale * sfxsca;
        Game.sfxs.push(Resources.audjum);
        Resources.audlos = new Engine.AudioPlayer(patlos);
        Resources.audlos.preserved = true;
        Resources.audlos.volume = Resources.audlos.restoreVolume = 5.75 * volumeScale * sfxsca;
        Game.sfxs.push(Resources.audlos);
        Resources.audres = new Engine.AudioPlayer(patres);
        Resources.audres.preserved = true;
        Resources.audres.volume = Resources.audres.restoreVolume = 7.5 * volumeScale * sfxsca;
        Game.sfxs.push(Resources.audres);
        Resources.audtom = new Engine.AudioPlayer(pattom);
        Resources.audtom.preserved = true;
        Resources.audtom.volume = Resources.audtom.restoreVolume = 6.5 * volumeScale * sfxsca;
        Game.sfxs.push(Resources.audtom);
...
(function (Game) {
    var SceneColors = /** @class */ (function (_super) {
        ...
        function SceneColors() {
            ...
            _this.fillUp.setRGBA(Game.Resources.texgam.getRed(2, 0) / 255.0, Game.Resources.texgam.getGreen(2, 0) / 255.0, Game.Resources.texgam.getBlue(2, 0) / 255.0, Game.Resources.texgam.getAlpha(2, 0) / 255.0);
            ...
            _this.fillDown.setRGBA(Game.Resources.texgam.getRed(3, 0) / 255.0, Game.Resources.texgam.getGreen(3, 0) / 255.0, Game.Resources.texgam.getBlue(3, 0) / 255.0, Game.Resources.texgam.getAlpha(3, 0) / 255.0);
            return _this;
        }
...
(function (Utils) {
    var Fade = /** @class */ (function (_super) {
        ...
        function Fade() {
            ...
            _this.direction = -1;
            _this.alpha = 1;
            _this.red = 38.0 / 255.0;
            _this.green = 43.0 / 255.0;
            _this.blue = 68.0 / 255.0;
            _this.maxAlpha = 1;
            _this.sprite = new Engine.Sprite();
            _this.sprite.enabled = true;
    ...
    var Text = /** @class */ (function (_super) {
        ...
        Text.prototype.fixStr = function () {
            if (this._str != null && this._font != null) {
                ...
                if (this._underlined) {
                    this.underline.setRGBAFromTexture(Game.Resources.texgam, 1, 5);
                    this.underline2.setRGBAFromTexture(Game.Resources.texgam, 4, 5);
                    this.underline.enabled = this._enabled;
                    this.underline.pinned = this._pinned;
                    this.underline.xSize = this._bounds.xSize - 1;
                    this.underline.ySize = this._scale;
                    this.underline2.enabled = this._enabled;
                    this.underline2.pinned = this._pinned;
                    this.underline2.xSize = this._bounds.xSize - 1;
        ...
        Text.prototype.fix = function () {
            ...
            if (this._str != null && this._font != null) {
                ...
                if (this._underlined) {
                    ...
                    this.underline.y = this._bounds.y + this._bounds.ySize - this.scale - 1;
                    this.underline2.x = this._bounds.x + this.scale;
                    this.underline2.y = this._bounds.y + this._bounds.ySize - 1;
                }
            }
        };
...
(function (Game) {
    var FRAMES;
    Game.addAction("init", function () {
        FRAMES = Game.FrameSelector.complex("loadingbar", Game.Resources.texgam, 199, 307, null, 0);
    });
    Game.MAX = 0.3;
...
(function (Game) {
    var fra;
    Game.addAction("configure", function () {
        fra = Game.FrameSelector.complex("block", Game.Resources.texgam, 1007, 177);
    });
    var blo = new Array();
    ...
    var Switch = /** @class */ (function (_super) {
        ...
        Switch.prototype.switchMe = function () {
            this.setMe(!this.box.enabled);
            //Resources.sfxButton.autoplay();
        };
        Switch.prototype.onStepUpdate = function () {
            if (this.box.enabled && !Game.SceneFreezer.stoped && this.box.collideAgainst(Game.Player.box)) {
...
(function (Game) {
    ...
    var fasang;
    var sloang;
    var ColorWave = /** @class */ (function (_super) {
        __extends(ColorWave, _super);
        function ColorWave() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        ColorWave.prototype.onReset = function () {
            fasang = 0;
            sloang = 0;
        };
        ColorWave.prototype.onTimeUpdate = function () {
            if (Game.SceneFreezer.stoped || Game.Player.sto())
                return;
            fasang += 1.1 * Engine.System.deltaTime;
            sloang += 0.35 * Engine.System.deltaTime;
            fas = 2 * Math.asin(Math.sin(Math.PI * fasang)) / Math.PI;
            slo = 2 * Math.asin(Math.sin(Math.PI * sloang)) / Math.PI;
        };
        ColorWave.applyToSprite = function (spr, spesca, sca) {
            var min = 0.45;
            var max = 0.9;
            var val = fas;
            if (sca < 1 || (spesca > 1 && sca == 1))
                val = slo;
            val *= (max - min);
            spr.setRGBA(44 * (min + val) / 255.0, 232 * (min + val) / 255.0, 245 * (min + val) / 255.0, 1);
        };
        return ColorWave;
    }(Engine.Entity));
    Game.ColorWave = ColorWave;
})(Game || (Game = {}));
///<reference path="../../Game/System/Entity.ts"/>
var Game;
(function (Game) {
    var fra;
    Game.addAction("configure", function () { fra = Game.FrameSelector.complex("fraspa", Game.Resources.texgam, 396, 468); });
    var Ghost = /** @class */ (function (_super) {
        __extends(Ghost, _super);
        function Ghost(def) {
            var _this = _super.call(this, def) || this;
            _this.spr = new Engine.Sprite();
            _this.spraur = new Engine.Sprite();
            _this.box = new Engine.Box();
            def.instance.y += 2;
            _this.box = new Engine.Box();
            _this.box.enabled = true;
            ...
            _this.spr = new Engine.Sprite();
            _this.spr.enabled = _this.spraur.enabled = true;
            _this.xori = def.instance.x;
            _this.xori += Game.SceneMap.instance.xSizeTile * 0.5;
            _this.xdis = _this.getProperty("xdis") * Game.SceneMap.instance.xSizeTile;
            _this.xste = _this.getProperty("xste");
            _this.xsta = _this.getProperty("xsta");
            _this.yori = def.instance.y;
            _this.yori -= Game.SceneMap.instance.ySizeTile * 0.5;
            _this.ydis = _this.getProperty("ydis") * Game.SceneMap.instance.ySizeTile;
            _this.yste = _this.getProperty("yste");
            _this.ysta = _this.getProperty("ysta");
            _this.velani = _this.getProperty("velani");
            _this.spesca = _this.getProperty("spesca");
            return _this;
        }
        Ghost.prototype.onReset = function () {
            this.xcou = this.xsta;
            this.box.x = this.xpos(this.xcou);
            this.spr.x = this.box.x;
            this.ycou = this.ysta;
            this.box.y = this.ypos(this.ycou);
            this.spr.y = this.box.y;
            this.sca = 1;
            this.fra = 0;
            fra[0].applyToSprite(this.spr);
            fra[4].applyToSprite(this.spraur);
        };
        Ghost.prototype.onSpell = function () {
            this.sca = this.sca == 1 ? this.spesca : 1;
        };
        Ghost.prototype.xpos = function (countSteps) {
            if (this.xste == 0)
                return this.xori;
            var mov = countSteps / this.xste;
            mov *= 2 * Math.PI;
            mov = (1 + Math.sin(mov - Math.PI * 0.5)) * 0.5 * this.xdis;
            return this.xori + mov;
        };
        Ghost.prototype.ypos = function (countSteps) {
            if (this.yste == 0)
                return this.yori;
            var mov = countSteps / this.yste;
            mov *= 2 * Math.PI;
            mov = (1 + Math.sin(mov - Math.PI * 0.5)) * 0.5 * this.ydis;
            return this.yori + mov;
        };
        Ghost.prototype.onMoveUpdate = function () {
            if (!Game.SceneFreezer.stoped && !Game.Player.sto()) {
                this.xcou += 1 * this.sca;
                if (this.xcou > this.xste)
                    this.xcou = 0;
                if (this.xdis != 0)
                    this.spr.xMirror = this.xcou >= this.xste * 0.5;
                if (this.xdis < 0)
                    this.spr.xMirror = !this.spr.xMirror;
                this.ycou += 1 * this.sca;
                if (this.ycou > this.yste)
                    this.ycou = 0;
                if (this.ydis != 0)
                    this.spr.xMirror = this.ycou >= this.yste * 0.5;
                if (this.ydis < 0)
                    this.spr.xMirror = !this.spr.xMirror;
            }
            this.box.x = this.xpos(this.xcou);
        ...
        Ghost.prototype.onStepUpdate = function () {
            if (Game.SceneFreezer.stoped || Game.Player.sto())
                return;
            this.fra += this.velani * this.sca;
            var ind = Math.floor((this.fra) / 13) % 4;
            fra[ind].applyToSprite(this.spr);
            fra[ind + 4].applyToSprite(this.spraur);
        };
        Ghost.prototype.onTimeUpdate = function () {
            var xext = 0;
            if (!Game.SceneFreezer.stoped && !Game.Player.sto())
                xext = Engine.System.stepExtrapolation * (this.xcou == this.xste ? -1 : 1);
            this.spr.x = this.xpos(this.xcou + xext * this.sca);
            var yext = 0;
            if (!Game.SceneFreezer.stoped && !Game.Player.sto())
                yext = Engine.System.stepExtrapolation * (this.ycou == this.yste ? -1 : 1);
            this.spr.y = this.ypos(this.ycou + yext * this.sca);
        };
        Ghost.prototype.onDrawObjects = function () {
            if (this.spesca != 1) {
                Game.ColorWave.applyToSprite(this.spraur, this.spesca, this.sca);
                this.spraur.xMirror = this.spr.xMirror;
                this.spraur.renderAt(this.spr.x, this.spr.y);
            }
            this.spr.render();
            this.box.renderAt(this.spr.x, this.spr.y);
        };
        return Ghost;
    }(Game.Entity));
    Game.Ghost = Ghost;
...
(function (Game) {
    ...
    Game.addAction("configure", function () {
        if (Game.goatyp == 0) {
            fra = Game.FrameSelector.complex("goa", Game.Resources.texgam, 53, 468);
            fradus = Game.FrameSelector.complex("goadus", Game.Resources.texgam, 214, 468);
            off = fra.length / 3;
            var spe = 2;
            ani[0] = new Utils.Animation("goaa", false, fra, 1, [0]);
            ani[1] = new Utils.Animation("goab", false, fra, 1, [1]);
            ani[2] = new Utils.Animation("goac", false, fra, spe, [2, 3, 4, 5, 6, 7, 8, 9, 10]);
            ani[3] = new Utils.Animation("goad", false, fra, 1, [0 + off]);
            ani[4] = new Utils.Animation("goae", false, fra, 1, [1 + off]);
            ani[5] = new Utils.Animation("goaf", false, fra, spe, [2 + off, 3 + off, 4 + off, 5 + off, 6 + off, 7 + off, 8 + off, 9 + off, 10 + off]);
            ani[6] = new Utils.Animation("goag", false, fra, 1, [0 + off * 2]);
            ani[7] = new Utils.Animation("goah", false, fra, 1, [1 + off * 2]);
            ani[8] = new Utils.Animation("goai", false, fra, spe, [2 + off * 2, 3 + off * 2, 4 + off * 2, 5 + off * 2, 6 + off * 2, 7 + off * 2, 8 + off * 2, 9 + off * 2, 10 + off * 2]);
        }
        else {
            fra = Game.FrameSelector.complex("goa", Game.Resources.texgam, 768, 468);
            fradus = Game.FrameSelector.complex("goadus", Game.Resources.texgam, 838, 468);
            off = fra.length / 3;
            var spe = 14;
            ani[0] = new Utils.Animation("goaa", false, fra, 1, [0]);
            ani[1] = new Utils.Animation("goab", false, fra, 1, [1]);
            ani[2] = new Utils.Animation("goac", true, fra, spe, [2, 3]);
            ani[3] = new Utils.Animation("goad", false, fra, 1, [0 + off]);
            ani[4] = new Utils.Animation("goae", false, fra, 1, [1 + off]);
            ani[5] = new Utils.Animation("goaf", true, fra, spe, [2 + off, 3 + off]);
            ani[6] = new Utils.Animation("goag", false, fra, 1, [0 + off * 2]);
            ani[7] = new Utils.Animation("goah", false, fra, 1, [1 + off * 2]);
            ani[8] = new Utils.Animation("goai", true, fra, spe, [2 + off * 2, 3 + off * 2]);
        }
    });
    var num = 0;
    var got;
    var gotdor;
    var doo = [];
    var par = /** @class */ (function (_super) {
        __extends(par, _super);
        function par(emitter) {
            var _this = _super.call(this, emitter) || this;
            _this.col = col;
            _this.parentRelative = false;
            return _this;
        }
        Object.defineProperty(par.prototype, "xRange", {
            get: function () { return Game.range(-7, 7); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(par.prototype, "yRange", {
            get: function () { return Game.range(-6, 1); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(par.prototype, "xRangeVel", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(par.prototype, "yRangeVel", {
            get: function () { return Game.range(-0.4, -0.6); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(par.prototype, "xRangeAccel", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(par.prototype, "yRangeAccel", {
            get: function () { return Game.range(0.004, 0.008); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(par.prototype, "rangeLife", {
            get: function () { return Game.range(20, 30); },
            enumerable: false,
            configurable: true
        });
        par.prototype.emitt = function (index) {
            _super.prototype.emitt.call(this, index);
            this.lifcou = this.countLife;
            this.fra = 0;
            fra[(Game.goatyp == 0 ? 11 : 4) + off * this.col].applyToSprite(this.sprite);
        };
        par.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (!Game.SceneFreezer.stoped && this.enabled) {
                if (this.fra == 0 && this.countLife < this.lifcou * 0.55) {
                    fra[(Game.goatyp == 0 ? 12 : 5) + off * this.col].applyToSprite(this.sprite);
                    this.fra = 1;
                }
            }
        };
        par.prototype.onDrawParticles = function () { this.sprite.render(); };
        par.prototype.onDrawParticlesBack = function () { };
        return par;
    }(Game.Emission.SimpleParticle));
    var pargot = /** @class */ (function (_super) {
        __extends(pargot, _super);
        function pargot(emitter) {
            var _this = _super.call(this, emitter) || this;
            _this.col = col;
            _this.parentRelative = false;
            return _this;
        }
        Object.defineProperty(pargot.prototype, "xRange", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pargot.prototype, "yRange", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pargot.prototype, "xRangeVel", {
            get: function () {
        ...
        Object.defineProperty(pargot.prototype, "yRangeVel", {
            get: function () {
        ...
        Object.defineProperty(pargot.prototype, "xRangeAccel", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pargot.prototype, "yRangeAccel", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pargot.prototype, "rangeLife", {
            get: function () { return 14; },
            enumerable: false,
            configurable: true
        });
        pargot.prototype.emitt = function (index) {
            _super.prototype.emitt.call(this, index);
            this.lifcou = this.countLife;
            this.fra = 0;
            fra[(Game.goatyp == 0 ? 11 : 4) + off * this.col].applyToSprite(this.sprite);
        };
        pargot.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (!Game.SceneFreezer.stoped && this.enabled) {
                if (this.fra == 0 && this.countLife < this.lifcou * 0.25) {
                    fra[(Game.goatyp == 0 ? 12 : 5) + off * this.col].applyToSprite(this.sprite);
                    this.fra = 1;
                }
            }
        };
        pargot.prototype.onDrawParticles = function () { this.sprite.render(); };
        pargot.prototype.onDrawParticlesBack = function () { };
        pargot.vel = 0.9;
        pargot.ste = 2;
        return pargot;
    }(Game.Emission.SimpleParticle));
    var Gem = /** @class */ (function (_super) {
        ...
        function Gem(def) {
            ...
            _this.spr = new Engine.Sprite();
            _this.box = new Engine.Box();
            _this.wav = new Game.Wave();
            _this.col = _this.getProperty("col");
            _this.vel = _this.getProperty("vel");
            _this.spr.enabled = true;
            fra[_this.col * off].applyToSprite(_this.spr);
            _this.box.enabled = _this.box.renderable = true;
            fra[_this.col * off].applyToBox(_this.box);
            _this.wav.vel = 0.06;
            col = _this.col;
            _this.emi = new Game.Emission.Emitter(pargot, 8);
            _this.emi.sizeEmission = 4;
            _this.emibac = new Game.Emission.Emitter(par, 60);
            _this.emibac.sizeEmission = 1;
            num++;
            return _this;
        }
        Gem.prototype.onReset = function () {
            this.spr.enabled = true;
            this.spr.x = this.box.x = this.emibac.x = this.def.instance.x + 4;
            this.spr.y = this.box.y = this.emibac.y = this.def.instance.y;
            this.emibac.emissionSteps = 1;
            this.got = false;
            got = 0;
        };
        Gem.prototype.onInitScene = function () {
        };
        Gem.prototype.onMoveReady = function () {
        };
        Gem.prototype.onOverlapUpdate = function () {
            if (!this.got && this.box.collideAgainst(Game.Player.box, null, false, 0, false) != null) {
                this.box.y = this.box.y - this.wav.val;
                this.emi.x = this.box.x;
                this.emi.y = this.box.y - this.box.ySize * 0.5;
                this.emi.emittChunk();
                this.emibac.emissionSteps = 0;
                Game.Resources.audgem.autoplay();
                this.got = true;
                got++;
                if (got == num) {
                    Engine.System.triggerCustomEvent("onStopAll");
                }
            }
        };
        Gem.prototype.onStepUpdate = function () {
            if (Game.SceneFreezer.stoped)
                return;
            if (this.got) {
                if (this.spr.enabled) {
                    this.spr.enabled = !this.mov(doo[this.col].box.x, doo[this.col].box.y, true);
                    if (!this.spr.enabled) {
                        doo[this.col].pus();
                        if (Game.goatyp == 1) {
                            this.emi.onReset();
                ...
                this.emibac.y = this.box.y - this.wav.val;
        };
        Gem.prototype.mov = function (x, y, tra) {
            if (Game.SceneFreezer.stoped)
                return false;
            var dis = this.vel * Engine.System.stepExtrapolation;
            var dx = x - this.box.x;
            var dy = y - this.box.y;
            ...
            if (mag < dis) {
                ...
                this.spr.x = this.box.x + dx * dis / mag;
                this.spr.y = this.box.y + dy * dis / mag;
                if (tra) {
                    this.box.x = this.spr.x;
                    this.box.y = this.spr.y;
                }
                return false;
            }
        };
        Gem.prototype.onDrawGoal = function () {
            if (this.got)
                this.mov(doo[this.col].box.x, doo[this.col].box.y, false);
            else
                this.spr.y = this.box.y - this.wav.valdra;
            this.spr.render();
            this.box.render();
        };
        Gem.prototype.onClearScene = function () {
            num = 0;
            doo = [];
        };
        return Gem;
    ...
    Game.Gem = Gem;
    var pardoo = /** @class */ (function (_super) {
        __extends(pardoo, _super);
        function pardoo(emitter) {
            var _this = _super.call(this, emitter) || this;
            _this.col = col;
            _this.parentRelative = false;
            return _this;
        }
        Object.defineProperty(pardoo.prototype, "xRange", {
            get: function () { return Game.range(-7, 7); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pardoo.prototype, "yRange", {
            get: function () { return Game.range(0, 0); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pardoo.prototype, "xRangeVel", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pardoo.prototype, "yRangeVel", {
            get: function () { return Game.range(-0.2, -0.3); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pardoo.prototype, "xRangeAccel", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pardoo.prototype, "yRangeAccel", {
            get: function () { return Game.range(0.004, 0.008); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pardoo.prototype, "rangeLife", {
            get: function () { return Game.range(15, 20); },
            enumerable: false,
            configurable: true
        });
        pardoo.prototype.emitt = function (index) {
            _super.prototype.emitt.call(this, index);
            this.lifcou = this.countLife;
            this.fra = 0;
            fradus[0].applyToSprite(this.sprite);
        };
        pardoo.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (!Game.SceneFreezer.stoped && this.enabled) {
                if (this.fra == 0 && this.countLife < this.lifcou * 0.55) {
                    fradus[1].applyToSprite(this.sprite);
                    this.fra = 1;
                }
            }
        };
        pardoo.prototype.onDrawParticles = function () { };
        pardoo.prototype.onDrawParticlesBack = function () { };
        pardoo.prototype.onDrawDoorParticles = function () { this.sprite.render(); };
        return pardoo;
    }(Game.Emission.SimpleParticle));
    var pardooice = /** @class */ (function (_super) {
        __extends(pardooice, _super);
        function pardooice(emitter) {
            var _this = _super.call(this, emitter) || this;
            _this.col = col;
            _this.parentRelative = false;
            return _this;
        }
        Object.defineProperty(pardooice.prototype, "xRange", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pardooice.prototype, "yRange", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pardooice.prototype, "xRangeVel", {
            get: function () {
                if (this.index == 0)
                    return pargot.vel;
                if (this.index == 1)
        ...
        Object.defineProperty(pardooice.prototype, "yRangeVel", {
            get: function () {
                if (this.index == 2)
                    return pargot.vel;
                if (this.index == 3)
        ...
        Object.defineProperty(pardooice.prototype, "xRangeAccel", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pardooice.prototype, "yRangeAccel", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(pardooice.prototype, "rangeLife", {
            get: function () { return 30; },
            enumerable: false,
            configurable: true
        });
        pardooice.prototype.emitt = function (index) {
            _super.prototype.emitt.call(this, index);
            this.lifcou = this.countLife;
            this.fra = 0;
            fradus[0 + 4 * this.col].applyToSprite(this.sprite);
        };
        pardooice.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (!Game.SceneFreezer.stoped && this.enabled) {
                if (this.fra == 0 && (this.lifcou - this.countLife >= 7)) {
                    fradus[1 + 4 * this.col].applyToSprite(this.sprite);
                    this.fra = 1;
                }
                else if (this.fra == 1 && (this.lifcou - this.countLife >= 11)) {
                    fradus[2 + 4 * this.col].applyToSprite(this.sprite);
                    this.fra = 2;
                }
                else if (this.fra == 2 && (this.lifcou - this.countLife >= 15)) {
                    fradus[3 + 4 * this.col].applyToSprite(this.sprite);
                    this.fra = 3;
                }
            }
        };
        pardooice.prototype.onDrawParticles = function () { this.sprite.render(); };
        pardooice.prototype.onDrawParticlesBack = function () { };
        pardooice.vel = 0.9;
        pardooice.ste = 2;
        return pardooice;
    }(Game.Emission.SimpleParticle));
    var Doo = /** @class */ (function (_super) {
        __extends(Doo, _super);
        function Doo(def) {
            var _this = _super.call(this, def) || this;
            _this.spr = new Engine.Sprite();
            _this.box = new Engine.Box();
            _this.ani = new Utils.Animator;
            _this.wav = new Game.Wave();
            _this.spr.enabled = _this.box.enabled = _this.box.renderable = true;
            _this.spr.x = _this.box.x = def.instance.x + 4;
            _this.spr.y = _this.box.y = def.instance.y;
            Game.SceneMap.instance.boxesSolids.push(_this.box);
            _this.ani.listener = _this.ani.owner = _this;
            _this.wav.vel = 1.9 * (1 - Game.goatyp);
            _this.col = _this.getProperty("col");
            _this.emi = new Game.Emission.Emitter(pardoo, 60);
            _this.emi.sizeEmission = 1;
            _this.emi.x = _this.def.instance.x + 4;
            _this.emi.y = _this.def.instance.y;
            col = _this.col;
            _this.emiice = new Game.Emission.Emitter(pardooice, 8);
            _this.emiice.sizeEmission = 4;
            _this.emiice.x = _this.def.instance.x + 4;
            _this.emiice.y = _this.def.instance.y - 3;
            doo[_this.col] = _this;
            return _this;
        }
        Doo.prototype.onReset = function () {
            this.got = false;
            this.ani.setAnimation(ani[1 + this.col * max]);
            this.emi.emissionSteps = 0;
            gotdor = 0;
            this.end = false;
            this.spr.xMirror = false;
        };
        Doo.prototype.onSetFrame = function (_, __, fra) {
            fra.applyToSprite(this.spr);
            fra.applyToBox(this.box);
        };
        Doo.prototype.pus = function () {
            this.ani.setAnimation(ani[2 + this.col * max]);
            if (Game.goatyp == 0) {
                this.emi.emissionSteps = 1;
                Game.Resources.audtom.autoplay();
            }
            else {
                this.emiice.emittChunk();
                Game.Resources.audbre.autoplay();
            }
            this.got = true;
        };
        Doo.don = function () {
        ...
        Doo.prototype.onStepUpdate = function () {
            if (Game.goatyp == 0) {
                if (this.got && this.ani.ended) {
                    this.emi.emissionSteps = 0;
                    if (!this.end && !this.emi.hasena()) {
                        this.end = true;
                        gotdor++;
                    }
                }
                ...
                if (this.got) {
                    this.spr.xMirror = this.spr.x < Game.Player.box.x;
                }
                if (this.got && !this.end && !this.emiice.hasena()) {
                    this.end = true;
                    gotdor++;
                }
            }
        };
        Doo.prototype.onDrawDoor = function () {
            if (this.got)
                this.spr.renderAt(this.spr.x + this.wav.valdra, this.spr.y);
            else
                this.spr.render();
            this.box.render();
        };
    ...
    Game.Doo = Doo;
    var GemTit = /** @class */ (function (_super) {
        __extends(GemTit, _super);
        function GemTit(def) {
            var _this = _super.call(this, def) || this;
            _this.spr = new Engine.Sprite();
            _this.box = new Engine.Box();
            _this.wav = new Game.Wave();
            _this.spr.enabled = true;
            fra[0].applyToSprite(_this.spr);
            _this.box.enabled = _this.box.renderable = true;
            fra[0].applyToBox(_this.box);
            _this.wav.vel = 0.06;
            _this.emibac = new Game.Emission.Emitter(partit, 60);
            _this.emibac.sizeEmission = 1;
            return _this;
        }
        GemTit.prototype.onReset = function () {
            this.spr.enabled = true;
            this.spr.x = this.box.x = this.emibac.x = this.def.instance.x + 4;
            this.spr.y = this.box.y = this.emibac.y = this.def.instance.y;
            this.emibac.emissionSteps = 1;
        };
        GemTit.prototype.onInitScene = function () {
        };
        GemTit.prototype.onMoveReady = function () {
        };
        GemTit.prototype.onStepUpdate = function () {
            if (Game.SceneFreezer.stoped)
                return;
            this.emibac.y = this.box.y - this.wav.val;
        };
        GemTit.prototype.onDrawGoal = function () {
            this.spr.y = this.box.y - this.wav.valdra;
            this.spr.render();
            this.box.render();
        };
    ...
    Game.GemTit = GemTit;
    var partit = /** @class */ (function (_super) {
        __extends(partit, _super);
        function partit(emitter) {
            var _this = _super.call(this, emitter) || this;
            _this.parentRelative = false;
            return _this;
        }
        Object.defineProperty(partit.prototype, "xRange", {
            get: function () { return Game.range(-7, 7); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(partit.prototype, "yRange", {
            get: function () { return Game.range(-6, 1); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(partit.prototype, "xRangeVel", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(partit.prototype, "yRangeVel", {
            get: function () { return Game.range(-0.4, -0.6); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(partit.prototype, "xRangeAccel", {
            get: function () { return 0; },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(partit.prototype, "yRangeAccel", {
            get: function () { return Game.range(0.004, 0.008); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(partit.prototype, "rangeLife", {
            get: function () { return Game.range(20, 30); },
            enumerable: false,
            configurable: true
        });
        partit.prototype.emitt = function (index) {
            _super.prototype.emitt.call(this, index);
            this.lifcou = this.countLife;
            this.fra = 0;
            fra[Game.goatyp == 0 ? 11 : 4].applyToSprite(this.sprite);
        };
        partit.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (!Game.SceneFreezer.stoped && this.enabled) {
                if (this.fra == 0 && this.countLife < this.lifcou * 0.55) {
                    fra[Game.goatyp == 0 ? 12 : 5].applyToSprite(this.sprite);
                    this.fra = 1;
                }
            }
        };
        partit.prototype.onDrawParticles = function () { this.sprite.render(); };
        partit.prototype.onDrawParticlesBack = function () { };
        return partit;
    }(Game.Emission.SimpleParticle));
})(Game || (Game = {}));
var Game;
(function (Game) {
    ...
    var off;
    Game.addAction("configure", function () {
        fra = Game.FrameSelector.complex("JumperControl", Game.Resources.texgam, 200, 177);
    });
    var SideControl = /** @class */ (function (_super) {
        __extends(SideControl, _super);
        ...
        SideControl.prototype.inilef = function () {
            lef = new Game.Control();
            lef.enabled = true;
            lef.freezeable = true;
            lef.listener = this;
            lef.useKeyboard = true;
            lef.newInteractionRequired = false;
            lef.useMouse = false;
            lef.mouseButtons = [0];
            lef.keys = [Engine.Keyboard.A, Engine.Keyboard.LEFT];
            if (Game.IS_TOUCH) {
                lef.useTouch = true;
                lef.bounds = new Engine.Sprite();
                lef.bounds.enabled = true;
                lef.bounds.pinned = true;
                fra[0].applyToSprite(lef.bounds);
                lef.listener = this;
                lef.onPressedDelegate = function () { fra[1].applyToSprite(lef.bounds); };
                lef.onReleasedDelegate = function () { fra[0].applyToSprite(lef.bounds); };
            }
            SideControl.lef = lef;
        };
        SideControl.prototype.inirig = function () {
            rig = new Game.Control();
            rig.enabled = true;
            rig.freezeable = true;
            rig.listener = this;
            rig.useKeyboard = true;
            rig.newInteractionRequired = false;
            rig.useMouse = false;
            rig.mouseButtons = [0];
            rig.keys = [Engine.Keyboard.D, Engine.Keyboard.RIGHT];
            if (Game.IS_TOUCH) {
                rig.useTouch = true;
                rig.bounds = new Engine.Sprite();
                rig.bounds.enabled = true;
                rig.bounds.pinned = true;
                fra[2].applyToSprite(rig.bounds);
                rig.listener = this;
                rig.onPressedDelegate = function () { fra[3].applyToSprite(rig.bounds); };
                rig.onReleasedDelegate = function () { fra[2].applyToSprite(rig.bounds); };
            }
            SideControl.rig = rig;
        };
        SideControl.prototype.inijum = function () {
            jum = new Game.Control();
            jum.enabled = true;
            jum.freezeable = true;
            jum.listener = this;
            jum.useKeyboard = true;
            jum.newInteractionRequired = true;
            jum.useMouse = false;
            jum.mouseButtons = [0];
            jum.keys = [Engine.Keyboard.W, Engine.Keyboard.U, Engine.Keyboard.UP];
            if (Game.IS_TOUCH) {
                jum.useTouch = true;
                jum.bounds = new Engine.Sprite();
                jum.bounds.enabled = true;
                jum.bounds.pinned = true;
                fra[4].applyToSprite(jum.bounds);
                jum.listener = this;
                jum.onPressedDelegate = function () { fra[5].applyToSprite(jum.bounds); };
                jum.onReleasedDelegate = function () { fra[4].applyToSprite(jum.bounds); };
            }
            SideControl.jum = jum;
        };
        SideControl.prototype.iniact = function () {
            act = new Game.Control();
            act.enabled = true;
            act.freezeable = true;
            act.listener = this;
            act.useKeyboard = true;
            act.newInteractionRequired = true;
            act.useMouse = false;
            act.mouseButtons = [0];
            act.keys = [Engine.Keyboard.Y, Engine.Keyboard.V, Engine.Keyboard.I, Engine.Keyboard.SPACE];
            if (Game.IS_TOUCH) {
                act.useTouch = true;
                act.bounds = new Engine.Sprite();
                act.bounds.enabled = true;
                act.bounds.pinned = true;
                fra[8].applyToSprite(act.bounds);
                act.listener = this;
                act.onPressedDelegate = function () { fra[9].applyToSprite(act.bounds); };
                act.onReleasedDelegate = function () { fra[8].applyToSprite(act.bounds); };
            }
            SideControl.act = act;
        };
        SideControl.prototype.onViewUpdate = function () {
            if (Game.IS_TOUCH) {
                lef.bounds.x = -Engine.Renderer.xSizeView * 0.5;
                lef.bounds.y = Math.floor(Engine.Renderer.ySizeView * 0.5 - lef.bounds.ySize) + 1;
                rig.bounds.x = Math.floor(lef.bounds.x + lef.bounds.xSize);
                rig.bounds.y = Math.floor(Engine.Renderer.ySizeView * 0.5 - rig.bounds.ySize) + 1;
                jum.bounds.x = Engine.Renderer.xSizeView * 0.5 - jum.bounds.xSize;
                jum.bounds.y = Math.floor(Engine.Renderer.ySizeView * 0.5 - jum.bounds.ySize) + 1;
                act.bounds.x = Math.floor(jum.bounds.x - act.bounds.xSize);
                act.bounds.y = Math.floor(Engine.Renderer.ySizeView * 0.5 - act.bounds.ySize) + 1;
            }
        };
        SideControl.prototype.onReset = function () {
            if (Game.IS_TOUCH)
                SideControl.offjum(false);
            coujum = 0;
            couact = 0;
        };
        SideControl.prototype.onStepUpdate = function () {
            if (!Game.SceneFreezer.stoped) {
                coujum--;
                coujum = jum.pressed ? stejum : coujum;
                couact--;
                couact = act.pressed ? steact : couact;
            }
        };
        Object.defineProperty(SideControl, "coujum", {
            get: function () {
                return coujum;
            },
            set: function (value) {
        ...
        Object.defineProperty(SideControl, "couact", {
            get: function () {
                return couact;
            },
            set: function (value) {
        ...
        SideControl.offjum = function (_off) {
            off = _off ? 2 : 0;
            if (jum.down)
                fra[5 + off].applyToSprite(jum.bounds);
            else
                fra[4 + off].applyToSprite(jum.bounds);
        };
        SideControl.prototype.enaact = function (ena) {
            act.enabled = act.bounds.enabled = ena;
        };
        SideControl.prototype.draw = function () {
            if (Game.IS_TOUCH) {
                lef.bounds.render();
                rig.bounds.render();
                jum.bounds.render();
        ...
        SideControl.prototype.onDrawControlsUnpaused = function () {
            if (!Game.SceneFreezer.stoped)
                this.draw();
        };
        SideControl.prototype.onDrawControlsPaused = function () {
            if (Game.SceneFreezer.stoped)
                this.draw();
        };
        return SideControl;
    }(Engine.Entity));
    Game.SideControl = SideControl;
})(Game || (Game = {}));
var Game;
(function (Game) {
    var spr = new Engine.Sprite();
    spr.enabled = true;
    Game.addAction("init", function () { return Game.FrameSelector.complex("moon", Game.Resources.texgam, 0, 468)[0].applyToSprite(spr); });
    var Moon = /** @class */ (function (_super) {
        __extends(Moon, _super);
        function Moon(def) {
            var _this = _super.call(this) || this;
            spr.x = def.instance.x;
            spr.y = def.instance.y;
            spr.xMirror = def.flip.x;
            return _this;
        }
        Moon.prototype.onDrawMoon = function () {
            spr.render();
        };
        return Moon;
    }(Engine.Entity));
...
(function (Game) {
    ...
    var emi;
    Game.addAction("init", function () {
        fra = Game.FrameSelector.complex("Player", Game.Resources.texgam, 716, 266);
        aniidl = new Utils.Animation("idl", true, fra, 20, [0, 1], null);
        animov = new Utils.Animation("mov", true, fra, 10, [2, 0], null);
        aniasc = new Utils.Animation("asc", true, fra, 5, [4], null);
        anides = new Utils.Animation("des", true, fra, 5, [1, 3], null);
        anidesmid = new Utils.Animation("desmid", true, fra, 5, [1, 3], null);
        anilan = new Utils.Animation("lan", false, fra, 3, [1], null);
        fra[0].applyToBox(box);
    });
    function con(pla) {
        Game.Platform.sol.push(box);
        ani = new Utils.Animator();
        ani.enabled = true;
        ani.owner = ani.listener = pla;
        emi = new Game.Emission.Emitter(par, 8);
        emi.sizeEmission = 4;
        new Game.ColorWave();
        new Game.Spell();
        aur = new Game.PlayerAura();
        //Arcade.Platformer.Platform.pushInteractable(this);
        //this.emitter=new Emission.Emitter(PlayerParticle,8);
        //this.emitter.sizeEmission=4;
    }
    function res() {
        win = false;
        los = false;
        ...
        spr.enabled = true;
        box.enabled = true;
        spr.x = box.x = def.instance.x;
        spr.y = box.y = def.instance.y;
        spr.xMirror = def.flip.x;
        hasjum = false;
        holjum = false;
        xvel = 0;
    ...
    function mov() {
        xhit = box.cast(Game.SceneMap.instance.boxesSolids, null, true, xvel, true, Engine.Box.LAYER_ALL);
        box.translate(xhit, true, xvel, true);
        xvel = xhit != null ? 0 : xvel;
        yvel += gra * grasca;
        yvel = yvel > ymaxvel ? ymaxvel : yvel;
        yhit = box.cast(Game.SceneMap.instance.boxesSolids, null, false, yvel, true, Engine.Box.LAYER_ALL);
        box.translate(yhit, false, yvel, true);
        yhitdir = yhit == null ? 0 : (yvel < 0 ? -1 : 1);
        yvel = yhit != null ? 0 : yvel;
        if (yhitdir > 0) {
            for (var _i = 0, yhit_1 = yhit; _i < yhit_1.length; _i++) {
                var hit = yhit_1[_i];
                var nexpla = null;
    ...
    function updste() {
        if (sta == stasto || sta == stastolas || sta == stadea)
            return;
        if (act) {
            offact++;
            indact = Math.floor(offact / 6);
            if (las) {
                indact = 2;
                setfra();
                setsta(stastolas);
            ...
            act = Game.SideControl.couact > 0 && Game.Spell.act >= 1;
            if (act) {
                indact = 0;
                offact = 0;
                Engine.System.triggerCustomEvent("onSpell");
                setfra();
            }
        }
    }
    function updsta() {
        function mov() {
            xvel = 0.9 * (Game.SideControl.lef.down ? -1 : (Game.SideControl.rig.down ? 1 : 0));
        }
        function movfli() {
            mov();
            if (xvel != 0)
        ...
        function updjum() {
            coujum++;
            if (hasjum && coujum > 4) {
                holjum = holjum && Game.SideControl.jum.down;
                yvel *= (holjum ? 1 : 0.7);
            }
        }
        switch (sta) {
    ...
    function linsta() {
        function idl() {
            if (!Game.SideControl.lef.down && !Game.SideControl.rig.down) {
                setsta(staidl);
                return true;
            }
            return false;
        ...
        function dea() {
            if (box.collide(Game.SceneMap.instance.boxesEnemies) != null) {
                setsta(stadea);
                return true;
            }
            return false;
        ...
        switch (sta) {
            case stanul:
                if (box.cast(Game.SceneMap.instance.boxesSolids, null, false, 1, false) == null) {
                    setsta(stades);
                    return;
                }
                setsta(staidl);
    ...
    function entsta(nex) {
        ...
        switch (sta) {
            case staidl:
                ani.setAnimation(aniidl);
                return;
            case stamov:
                ani.setAnimation(animov);
                return;
            case stajum:
                Game.SideControl.coujum = 0;
                Game.Resources.audjum.autoplay();
                yvel = -2.0;
                hasjum = true;
                holjum = true;
                coujum = 0;
                ...
                return;
            case staasc:
                ani.setAnimation(aniasc);
                return;
            case stades:
                ani.setAnimation(old == staasc ? anides : anidesmid);
                hasjum = false;
                return;
            case stalan:
                ani.setAnimation(anilan);
                hasjum = false;
                linsta();
                return;
            case stadea:
                ...
                grasca = 0;
                emi.x = box.x;
                emi.y = box.y - box.ySize * 0.5;
                emi.emittChunk();
                spr.enabled = box.enabled = false;
                Game.Resources.audlos.autoplay();
                los = true;
                return;
            case stasto:
                xvel = 0;
    ...
    function setfra() {
        fra[ani.animation.indexArray[ani.indexFrame] + (act ? indact * 6 : 0)].applyToSprite(spr);
        if (las)
            fra[ani.animation.indexArray[ani.indexFrame] + (act ? indact * 6 : 0) + 18].applyToSprite(aur.spr);
    }
    function updtim() {
        var ext = box.getExtrapolation(Game.SceneMap.instance.boxesSolids, xvel + (pla == null ? 0 : pla.xvelmov()) / Engine.Box.UNIT, yvel + (pla == null ? 0 : pla.yvelmov()) / Engine.Box.UNIT, true);
        spr.x = ext.x;
        spr.y = ext.y;
    }
    function dra() {
        if (las)
            aur.ren(spr.x, spr.y, spr.xMirror);
        spr.render();
        box.renderAt(spr.x, spr.y);
    }
    var frapar;
    Game.addAction("configure", function () { frapar = Game.FrameSelector.complex("plapar", Game.Resources.texgam, 214, 480); });
    var par = /** @class */ (function (_super) {
        __extends(par, _super);
        function par(emitter) {
            var _this = _super.call(this, emitter) || this;
        ...
        par.prototype.emitt = function (index) {
            ...
            this.lifcou = this.countLife;
            this.fra = 0;
            frapar[0].applyToSprite(this.sprite);
        };
        par.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (!Game.SceneFreezer.stoped && this.enabled) {
                if (this.fra == 0 && this.countLife < this.lifcou * 0.25) {
                    frapar[1].applyToSprite(this.sprite);
                    this.fra = 1;
                }
            }
        };
    ...
    var PlayerInstancer = /** @class */ (function (_super) {
        ...
        function PlayerInstancer(_def) {
            var _this = _super.call(this, _def) || this;
            def = _def;
            def.instance.x += Game.SceneMap.instance.xSizeTile * 0.5;
            pre = _this.getProperty("preloader");
            tit = _this.getProperty("title");
            las = _this.getProperty("last");
            if (pre)
                new PlayerPreloader();
            else if (tit)
                new PlayerTitle();
    ...
    var Player = /** @class */ (function (_super) {
        ...
        Object.defineProperty(Player, "box", {
            get: function () {
                return box;
            },
            enumerable: false,
        ...
        Object.defineProperty(Player, "xdra", {
            get: function () {
                var val = spr.x;
                val = Game.SceneMap.instance.xSizeMap * 0.5;
                return val;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(Player, "ydra", {
            get: function () {
                var val = spr.y;
                val = Game.SceneMap.instance.ySizeMap * 0.5;
                return val;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(Player, "win", {
            get: function () {
                return win;
            },
            enumerable: false,
        ...
        Object.defineProperty(Player, "haswon", {
            get: function () {
                return haswon;
            },
            enumerable: false,
        ...
        Object.defineProperty(Player, "los", {
            get: function () {
                return los;
            },
            enumerable: false,
        ...
        Object.defineProperty(Player, "haslos", {
            get: function () {
                return haslos;
            },
            enumerable: false,
        ...
        Player.prototype.onSetFrame = function (_nul, _nulb, ___) {
            setfra();
        };
        ...
        Player.prototype.onStopAll = function () {
            setsta(stasto);
        };
    ...
    Game.Player = Player;
    var PlayerPreloader = /** @class */ (function (_super) {
        __extends(PlayerPreloader, _super);
        function PlayerPreloader() {
            var _this = _super.call(this, def) || this;
            spr.enabled = true;
            spr.x = def.instance.x;
            spr.y = def.instance.y;
            ...
            ani = new Utils.Animator();
            ani.enabled = true;
            ani.owner = ani.listener = _this;
            ani.setAnimation(aniidl);
            return _this;
        }
        PlayerPreloader.prototype.onSetFrame = function (_nul, _nulb, _fra) {
            setfra();
        };
        PlayerPreloader.prototype.onDrawPlayerUnpaused = function () {
            dra();
        };
        return PlayerPreloader;
    }(Game.Entity));
    Game.PlayerPreloader = PlayerPreloader;
    var PlayerTitle = /** @class */ (function (_super) {
        ...
        PlayerTitle.prototype.onSetFrame = function (_nul, _nulb, fra) {
            fra.applyToSprite(spr);
        };
...
namespace Game{
    ...
    var ANIM_STAND:Utils.Animation;
    var ANIM_WALK:Utils.Animation;
    var ANIM_ASCEND:Utils.Animation;
    var ANIM_FALL_ASCEND:Utils.Animation;
    var ANIM_FALL:Utils.Animation;

    var FRAMES:Array<Utils.AnimationFrame>;

    var STILT_SPEED=1;
    export var BASE_STILT_SIZE=7;
    export var START_STILT_SIZE=7;
    var MAX_STILT_SIZE=14;

    var BOX_Y_SIZE=6;

    addAction("init",function(){
        FRAMES=FrameSelector.complex("player sprites",Resources.texgam,716,266);
    ...
    export class Player extends Arcade.PhysicEntity implements Arcade.Platformer.IPlatformInteractable{
        static instance:Player=null;
        platformParent:Arcade.Platformer.Platform=null;
        sprite=new Engine.Sprite();
        animator:Utils.Animator;

        control:Interaction.Controls.Platformer.BasicJumperControls;
        ...
        boxContact=new Engine.Box();

        needJump:boolean;

        get xRender(){
            var x=this.sprite.x;
            if(SceneMap.instance.xSizeMap-SceneMap.instance.xSizeTile*2<Engine.Renderer.xSizeView){
                x=SceneMap.instance.xSizeMap*0.5;
            }
            else if(x<Engine.Renderer.xSizeView*0.5+SceneMap.instance.xSizeTile){
                x=Engine.Renderer.xSizeView*0.5+SceneMap.instance.xSizeTile;
            }
            else if(x>SceneMap.instance.xSizeMap-Engine.Renderer.xSizeView*0.5-SceneMap.instance.xSizeTile){
                x=SceneMap.instance.xSizeMap-Engine.Renderer.xSizeView*0.5-SceneMap.instance.xSizeTile;
            }
            return x;
        }
        ...
        get yRender(){
            var y=this.sprite.y;
            if(SceneMap.instance.ySizeMap-SceneMap.instance.ySizeTile*2<Engine.Renderer.ySizeView){
                y=SceneMap.instance.ySizeMap*0.5;
            }
            else if(y<Engine.Renderer.ySizeView*0.5+SceneMap.instance.ySizeTile){
                y=Engine.Renderer.ySizeView*0.5+SceneMap.instance.ySizeTile;
            }
            else if(y>SceneMap.instance.ySizeMap-Engine.Renderer.ySizeView*0.5-SceneMap.instance.ySizeTile){
                y=SceneMap.instance.ySizeMap-Engine.Renderer.ySizeView*0.5-SceneMap.instance.ySizeTile;
            }
            return y;
        }
        ...
        onStart(){
            if(this.getProperty("stilts")){
                ...
                box.ySize=MAX_STILT_SIZE;
                box.yOffset=-box.ySize;
            }
        }
        ...
        xMoveOnPlatform(dist:number){
            var contacts=box.cast(SceneMap.instance.noOneWaySolids,null,true,dist,true,Engine.Box.LAYER_ALL);
            box.translate(contacts,true,dist,true);
        }

        yMoveOnPlatform(dist:number){
            var contacts:Array<Engine.Contact>;
            if(yvel>0){
                box.cast(SceneMap.instance.boxesSolids,null,false,dist,true,Engine.Box.LAYER_ALL);
            }
            else{
                box.cast(SceneMap.instance.noOneWaySolids,null,false,dist,true,Engine.Box.LAYER_ALL);
            }
            box.translate(contacts,false,dist,true);
        }
        ...
        onOverlapUpdate(){
            if(SceneFreezer.stoped)return;
            if(!hur){
                hur=this.boxContact.collide(SceneMap.instance.boxesEnemies,null,false,0,false,Engine.Box.LAYER_ALL)!=null;
            }
            if(!win&&!this.title){
                win=box.collideAgainst(Goal.instance.box,null,false,0,false,Engine.Box.LAYER_ALL)!=null;
                if(win){
                    Goal.instance.getMe();
                }
            }
        ...
        onMoveUpdate(){
            ...
            if(!SceneFreezer.stoped){
                if(sta!=DEAD){
                    if(xhitdir!=0){
                        if(this.stiltActivate&&!this.last){
                            if(this.stiltSize==MAX_STILT_SIZE){
                                this.boxContact.x=box.x;
                                this.boxContact.y=box.y-(box.ySize-BOX_Y_SIZE);
                                if(this.boxContact.cast(SceneMap.instance.boxesSolids,null,true,1*this.xDir,false,Engine.Box.LAYER_ALL)==null){
                                    this.cancelStilts();
                                }
                                else{
                                    this.xDir=-this.xDir;
                    ...
                    xvel=this.xDir*VEL_MOVE;
                    this.xCanMove=true;
                    this.yCanMove=true;
                    if(yhitdir>0){
                        this.checkPlatformParent(yhit);
                    }
                    else{
                        if(this.platformParent!=null){
                            this.platformParent.removeChild(this);
            ...
            if(!this.title&&this.stiltActivate){
                ...
                if(this.stiltSize>START_STILT_SIZE){
                    box.ySize=this.stiltSize;
                    box.yOffset=-box.ySize;
                }
            ...
            if(!this.stiltActivate&&this.control.pressedDelayedAction&&yhitdir>0){
                this.boxContact.x=box.x;
                this.boxContact.y=box.y
                this.boxContact.ySize=8;
                this.boxContact.yOffset=-this.boxContact.ySize;

                if(this.boxContact.cast(SceneMap.instance.boxesSolids,null,false,-1,false,Engine.Box.LAYER_ALL)==null){
                    this.stiltSize=BASE_STILT_SIZE;
                    this.stiltActivate=true;
                    box.ySize=START_STILT_SIZE;
                    box.yOffset=-box.ySize;
                    this.control.consumeDelayedAction();
                    Resources.sfxStilts.autoplay();
                }
        ...
        cancelStilts(playSound=true){
            this.stiltActivate=false;
            this.control.consumeDelayedAction();

            //box.y -=
            box.y-=box.ySize-BOX_Y_SIZE;

            box.ySize=BOX_Y_SIZE;
            box.yOffset=-box.ySize;
            if(playSound)Resources.sfxStiltsOff.autoplay();
        }

        checkPlatformParent(contacts:Engine.Contact[]){
        ...
        onStepUpdate(){
            if(!SceneFreezer.stoped){
                ...
                haswon=win&&this.countNext>STEPS_WIN;
                haslos=los&&this.countNext>STEPS_LOSS;
                this.checkLinks();
            }
        }
        ...
        onTimeUpdate(){
            ...
            if(this.stiltActivate){
                this.sprite.y-=1;
                if(this.stiltSize>START_STILT_SIZE){
                    this.sprite.y-=this.stiltSize-START_STILT_SIZE;
                }
            }
        }
    ...
    export class PlayerTitle extends Entity implements Utils.AnimatorListener{
        sprite=new Engine.Sprite();
        animator=new Utils.Animator();
        constructor(def:any){
            super(def);
            this.sprite.enabled=true;
            this.sprite.x=def.instance.x+4;
            this.sprite.y=def.instance.y;
        ...
        protected onDrawPlayerUnpaused(){
            if(!SceneFreezer.stoped){
                this.sprite.render();
            }
        }
        protected onDrawPlayerPaused(){
            if(SceneFreezer.stoped){
                this.sprite.render();
            }
        }
    ...
    export class PlayerInstancer extends Entity{
        constructor(def:any){
            super(def);
            if(this.getProperty("preloader")){
                new PlayerTitle(def);
            }
            else{
...
(function (Game) {
    var sca;
    var PlayerAura = /** @class */ (function (_super) {
        __extends(PlayerAura, _super);
        function PlayerAura() {
            var _this = _super.call(this) || this;
            _this.spr = new Engine.Sprite();
            _this.spr.enabled = true;
        ...
        PlayerAura.prototype.onSpell = function () {
            sca = 0.5;
        };
        PlayerAura.prototype.ren = function (x, y, fli) {
            Game.ColorWave.applyToSprite(this.spr, 0.5, sca);
            this.spr.xMirror = fli;
            this.spr.renderAt(x, y);
        };
        return PlayerAura;
    }(Engine.Entity));
    Game.PlayerAura = PlayerAura;
})(Game || (Game = {}));
///<reference path="../../Game/System/Entity.ts"/>
var Game;
(function (Game) {
...
(function (Game) {
    var fra;
    Game.addAction("configure", function () {
        fra = Game.FrameSelector.complex("fraspa", Game.Resources.texgam, 340, 468);
    });
    var Skull = /** @class */ (function (_super) {
        ...
        function Skull(def) {
            ...
            _this.box.enabled = _this.box.renderable = _this.spr.enabled = _this.spraur.enabled = true;
            fra[0].applyToBox(_this.box);
            Game.SceneMap.instance.boxesEnemies.push(_this.box);
            _this.velani = _this.getProperty("velani");
            _this.spesca = _this.getProperty("spesca");
        ...
        Skull.prototype.onReset = function () {
            ...
            this.sca = 1;
            fra[0].applyToSprite(this.spr);
            fra[2].applyToSprite(this.spraur);
        };
        Skull.prototype.onSpell = function () {
            this.sca = this.sca == 1 ? this.spesca : 1;
        };
        Skull.prototype.onMoveUpdate = function () {
            if (Game.SceneFreezer.stoped || Game.Player.sto())
                return;
            this.box.x += this.vel * this.sca;
            this.cou -= Math.abs(this.vel * this.sca);
            if (this.cou <= 0) {
                this.cou = Math.abs(this.dis);
                this.vel *= -1;
                this.spr.xMirror = !this.spr.xMirror;
        ...
        Skull.prototype.onStepUpdate = function () {
            if (Game.SceneFreezer.stoped || Game.Player.sto())
                return;
            this.fra += this.velani * this.sca;
            var ind = Math.floor((this.fra) / 10) % 2;
            fra[ind].applyToSprite(this.spr);
            fra[ind + 2].applyToSprite(this.spraur);
        };
        Skull.prototype.onDrawSpark = function () {
            var x = this.box.x + this.vel * this.sca * (Game.SceneFreezer.stoped || Game.Player.sto() ? 0 : Engine.System.stepExtrapolation);
            if (this.spesca != 1) {
                Game.ColorWave.applyToSprite(this.spraur, this.spesca, this.sca);
                this.spraur.renderAt(x, this.box.y);
            }
            this.spr.renderAt(x, this.box.y);
            this.box.render();
        };
        return Skull;
    }(Game.Entity));
...
(function (Game) {
    ...
    Game.addAction("configure", function () {
        var fra = Game.FrameSelector.complex("spebar", Game.Resources.texgam, 0, 520);
        fra[2] = new Utils.AnimationFrame(Game.Resources.texgam, 36, 522, 8, 4);
    ...
    var Spell = /** @class */ (function (_super) {
        ...
        Spell.prototype.onReset = function () {
            spr[0].enabled = spr[1].enabled = spr[2].enabled = false;
            act = 1;
            sto = false;
        };
        Spell.prototype.onStepUpdate = function () {
            if (Game.SceneFreezer.stoped || sto || Game.Player.los)
                return;
            if (act < 1) {
                act += vel;
                if (act >= 1) {
        ...
        Spell.prototype.onStopAll = function () {
            sto = true;
        };
        Object.defineProperty(Spell, "act", {
            get: function () {
                return act;
            },
            enumerable: false,
        ...
        Spell.actbar = function () {
            spr[0].enabled = spr[1].enabled = spr[2].enabled = true;
            spr[2].xScale = 0;
            act = 0;
        };
        Spell.render = function (x, y) {
            Particles.render(x, y);
            if (Game.Player.los)
                return;
            y -= 12;
            spr[0].x = spr[1].x = spr[2].x = x;
            spr[0].y = spr[1].y = spr[2].y = y;
            spr[2].x -= 4;
            spr[0].render();
            spr[2].render();
            spr[1].render();
    ...
    var anires;
    Game.addAction("configure", function () {
        fra = Game.FrameSelector.complex("bubleparticle", Game.Resources.texgam, 53, 515);
        anicas = new Utils.Animation("pop", false, fra, 5, [0, 1, 2]);
        anires = new Utils.Animation("res", false, fra, 5, [2, 1, 0]);
    });
    ...
    var Particles = /** @class */ (function (_super) {
        ...
        function Particles() {
            ...
            res[0] = new Game.SimpleAnimator();
            res[1] = new Game.SimpleAnimator();
            res[2] = new Game.SimpleAnimator();
            return _this;
        }
        Particles.prototype.onSpell = function () {
            Game.Resources.auddis.autoplay();
        ...
        Particles.res = function () {
            Game.Resources.audres.autoplay();
            res[0].trigger(anires, 0 - disres * dir, -disres * dir - off);
            res[1].trigger(anires, 0, -disres - off);
            res[2].trigger(anires, 0 + disres * dir, -disres * dir - off);
        };
        Particles.render = function (x, y) {
            ...
            res[0].timeMoveTo(0, 0 - off, velres, true);
            res[1].timeMoveTo(0, 0 - off, velres, true);
            res[2].timeMoveTo(0, 0 - off, velres, true);
            res[0].sprite.renderAt(res[0].sprite.x + x, res[0].sprite.y + y);
            res[1].sprite.renderAt(res[1].sprite.x + x, res[1].sprite.y + y);
            res[2].sprite.renderAt(res[2].sprite.x + x, res[2].sprite.y + y);
        };
        return Particles;
    }(Engine.Entity));
})(Game || (Game = {}));
...
(function (Game) {
    var Spike = /** @class */ (function (_super) {
        ...
        function Spike(def, _frame, anim) {
            var _this = _super.call(this, def) || this;
            anim.frames[anim.indexArray[0]].applyToBox(_this.boxSolid);
        ...
        Spike.prototype.onDrawObjectsBack = function () {
            if (this.platformParent != null) {
                this.sprite.x += this.platformParent.xGetVelMove() * Engine.System.stepExtrapolation;
                this.sprite.y += this.platformParent.yGetVelMove() * Engine.System.stepExtrapolation;
            }
            this.sprite.render();
            if (Engine.Box.debugRender) {
    ...
    var ANIM_270;
    Game.addAction("configure", function () {
        FRAMES_ANIM = Game.FrameSelector.complex("spikes", Game.Resources.texgam, 238, 468);
        ANIM_0 = new Utils.Animation("spike 0", true, FRAMES_ANIM, 10, [0, 1], null);
        ANIM_90 = new Utils.Animation("spike 90", true, FRAMES_ANIM, 10, [4, 5], null);
        ANIM_180 = new Utils.Animation("spike 180", true, FRAMES_ANIM, 10, [2, 3], null);
        ANIM_270 = new Utils.Animation("spike 270", true, FRAMES_ANIM, 10, [6, 7], null);
    });
    var Spike0 = /** @class */ (function (_super) {
        __extends(Spike0, _super);
        function Spike0(def) {
            var _this = _super.call(this, def, FRAMES_ANIM[0], ANIM_0) || this;
            def.instance.x += 4;
            _this.xAlign = "start";
            _this.yAlign = "end";
            return _this;
    ...
    var Spike90 = /** @class */ (function (_super) {
        ...
        function Spike90(def) {
            var _this = _super.call(this, def, FRAMES_ANIM[1], ANIM_90) || this;
    ...
    var Spike180 = /** @class */ (function (_super) {
        ...
        function Spike180(def) {
            var _this = _super.call(this, def, FRAMES_ANIM[2], ANIM_180) || this;
            def.instance.x += 4;
            _this.xAlign = "start";
            _this.yAlign = "start";
            return _this;
    ...
    var Spike270 = /** @class */ (function (_super) {
        ...
        function Spike270(def) {
            var _this = _super.call(this, def, FRAMES_ANIM[3], ANIM_270) || this;
            def.instance.y += 4;
            _this.xAlign = "end";
            _this.yAlign = "start";
            return _this;
...
(function (Game) {
    ...
    //var strpri=false;
    Game.addAction("init", function () {
        fra = Game.FrameSelector.complex("star", Game.Resources.texgam, 921, 266);
        ani[0] = new Utils.Animation("star0", false, fra, 1, [0]);
        ani[1] = new Utils.Animation("star1", false, fra, 1, [1]);
        ani[2] = new Utils.Animation("star2", false, fra, 1, [2]);
        ani[3] = new Utils.Animation("star3", true, fra, 12, [0, 1, 2, 1]);
        ani[4] = new Utils.Animation("star4", true, fra, 12, [1, 2, 1, 0]);
        ani[5] = new Utils.Animation("star5", true, fra, 12, [2, 1, 0, 1]);
    });
    var Star = /** @class */ (function (_super) {
        ...
        function Star(def) {
            ...
            _this.ani = new Utils.Animator();
            _this.spr.enabled = true;
            _this.spr.x = def.instance.x + 4;
            _this.spr.y = def.instance.y - 4;
            _this.ani.owner = _this.ani.listener = _this;
            //var ind=this.getProperty("ind");
            _this.ani.setAnimation(ani[_this.getProperty("ind")]);
            return _this;
            //str+="new Start("+this.spr.x+","+this.spr.y+","+ind+");\n";
        }
        /*
        constructor(x:number,y:number,ind:number){
            super();
            this.spr.enabled=this.spr.pinned=true;
            this.spr.x=x;
            this.spr.y=y;
            this.ani.owner=this.ani.listener=this;
            this.ani.setAnimation(ani[ind]);
            str+="new Start("+this.spr.x+","+this.spr.y+","+ind+");\n";
        }
        */
        Star.prototype.onSetFrame = function (_, __, fra) {
            fra.applyToSprite(this.spr);
        };
        Star.prototype.onDrawBackgroundDecoration = function () {
            /*
            if(!strpri){
                console.log(str);
                strpri=true;
            ...
            */
            ...
            do {
                this.spr.render();
                this.spr.y += Engine.Renderer.ySizeViewIdeal;
            } while (this.spr.onScreenY());
            this.spr.y = y;
            var y = this.spr.y;
            this.spr.y -= Engine.Renderer.ySizeViewIdeal;
            while (this.spr.onScreenY()) {
            ...
            do {
                this.spr.render();
                this.spr.x += Engine.Renderer.xSizeViewIdeal;
            } while (this.spr.onScreenX());
            this.spr.x = x;
            var x = this.spr.x;
            this.spr.x -= Engine.Renderer.xSizeViewIdeal;
            while (this.spr.onScreenX()) {
...
/*
namespace Game{
    var fra:Array<Utils.AnimationFrame>;
    var ani:Array<Utils.Animation>=[];
    addAction("init",()=>{
        fra=FrameSelector.complex("star",Resources.texgam,921,266);
        ani[0]=new Utils.Animation("star0",false,fra,1,[0]);
        ani[1]=new Utils.Animation("star1",false,fra,1,[1]);
        ani[2]=new Utils.Animation("star2",false,fra,1,[2]);
        ani[3]=new Utils.Animation("star3",true,fra,12,[0,1,2,1]);
    ...
    export class Star extends Entity implements Utils.AnimatorListener{
        spr=new Engine.Sprite();
        ani=new Utils.Animator();
        constructor(def:any){
            super(def);
            this.spr.enabled=this.spr.pinned=true;
            this.spr.x=def.instance.x;
            this.spr.y=def.instance.y;
            this.ani.owner=this.ani.listener=this;
            var ind=this.getProperty("ind");
            this.ani.setAnimation(ani[this.getProperty("ind")]);
            pep+="new Start("+this.spr.x+","+this.spr.y+","+ind+");\n";
        }
        onSetFrame(_:Utils.Animator,__:Utils.Animation,fra:Utils.AnimationFrame){
            fra.applyToSprite(this.spr);
        }
        onDrawBackgroundDecoration(){
            if(!peppri){
                console.log(pep);
                peppri=true;
            }
            var xdra=this.spr.x-Engine.Renderer.xSizeView*0.5-8;
            var ydra=this.spr.y-Engine.Renderer.ySizeView*0.5-8;
            this.spr.renderAt(xdra,ydra);
            for(var x=xdra+184;x<=Engine.Renderer.xSizeView;x+=184){
                this.spr.renderAt(x,ydra);
            }
            for(var y=ydra+160;y<=Engine.Renderer.ySizeView;y+=160){
                this.spr.renderAt(xdra,y);
            }
        }
    }
}
...
(function (Game) {
    ...
    var TerrainFill = /** @class */ (function (_super) {
        ...
        function TerrainFill(type) {
            ...
            switch (type) {
                case 0:
                    spr.setFull(true, false, Game.Resources.texgam, 104, 128, 0, 0, 64, 528, 104, 128);
                    spr.x = 8 * 5;
                    spr.y = 8 * 18;
                    break;
                case 1:
                    spr.setFull(true, false, Game.Resources.texgam, 208, 128, 0, 0, 176, 528, 208, 128);
                    spr.x = 8 * 0;
                    spr.y = 8 * 15;
                    break;
                case 2:
                    spr.setFull(true, false, Game.Resources.texgam, 208, 128, 0, 0, 392, 528, 208, 128);
                    spr.x = 8 * 0;
                    spr.y = 8 * 15;
                    break;
                case 3:
                    spr.setFull(true, false, Game.Resources.texgam, 56, 128, 0, 0, 608, 528, 56, 128);
                    spr.x = 8 * 8;
                    spr.y = 8 * 18;
                    break;
            }
        ...
        TerrainFill.prototype.onDrawSceneMap = function () {
            var y = spr.y;
            do {
                spr.render();
                spr.y += spr.ySize - 8;
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("tutorial", Game.Resources.texgam, 200, 110);
    });
...
(function (Game) {
    ...
    Game.addAction("configure", function () { Game.FrameSelector.complex("AudioFrame", Game.Resources.texgam, 445, 372)[0].applyToSprite(spr); });
...
(function (Game) {
    var fra;
    Game.addAction("configure", function () { fra = Game.FrameSelector.complex("ButtonFrame", Game.Resources.texgam, 676, 177); });
...
(function (Game) {
    var spr = new Engine.Sprite();
    spr.enabled = spr.pinned = true;
    Game.addAction("configure", function () { Game.FrameSelector.complex("ClockFrame", Game.Resources.texgam, 378, 353)[0].applyToSprite(spr); });
    var ClockFrame = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ClockFrame, "spr", {
            get: function () {
                return spr;
            },
            enumerable: false,
        ...
        ClockFrame.prototype.onViewUpdate = function () {
            spr.x = Engine.Renderer.xSizeView * 0.5;
            spr.y = -Engine.Renderer.ySizeView * 0.5;
        };
        ClockFrame.prototype.onDrawBubblesDialog = function () {
            spr.render();
        };
        return ClockFrame;
    }(Engine.Entity));
    Game.ClockFrame = ClockFrame;
})(Game || (Game = {}));
var Game;
(function (Game) {
    var fra;
    ...
    spr.enabled = spr.pinned = true;
    Game.addAction("configure", function () {
        fra = Game.FrameSelector.complex("CreditsFrame", Game.Resources.texgam, 200, 225);
...
(function (Game) {
    var fra;
    Game.addAction("configure", function () {
        fra = Game.FrameSelector.complex("lasbut", Game.Resources.texgam, 501, 374, null, 0)[0];
    });
    var LastButtonFrames = /** @class */ (function (_super) {
        ...
        LastButtonFrames.prototype.onViewUpdate = function () {
            this.spr.x = Engine.Renderer.xSizeView * 0.5 + 1 + 20 + 14;
            this.spr.y = -Engine.Renderer.ySizeView * 0.5 - 1;
        };
...
(function (Game) {
    ...
    Game.addAction("configure", function () {
        var fra = Game.FrameSelector.complex("LevelFrame", Game.Resources.texgam, 326, 353);
        fra[0].applyToSprite(spr);
...
(function (Game) {
    ...
    var LevelLogoFrameLeft = /** @class */ (function (_super) {
        ...
        function LevelLogoFrameLeft() {
            var _this = _super.call(this) || this;
            _this.spr = new Engine.Sprite();
            _this.spr.setFull(true, true, Game.Resources.texgam, wid, hei, 0, 0, 261, 488, wid, hei);
            _this.onViewUpdate();
            return _this;
        }
    ...
    var LevelLogoFrameRight = /** @class */ (function (_super) {
        ...
        function LevelLogoFrameRight() {
            var _this = _super.call(this) || this;
            _this.spr = new Engine.Sprite();
            _this.spr.setFull(true, true, Game.Resources.texgam, wid, hei, 0, 0, 240, 488, wid, hei);
            _this.onViewUpdate();
            return _this;
        }
...
(function (Game) {
    var spr = new Engine.Sprite();
    spr.enabled = spr.pinned = true;
    spr.y = -54 * 0.5 - 7 + 0.5 - 20 + 2 + 20 + 0.5 + 1 - 2 - 1;
    Game.addAction("configure", function () {
        Game.FrameSelector.complex("SpeedrunMenu", Game.Resources.texgam, 417, 307)[0].applyToSprite(spr);
    });
...
(function (Game) {
    var spr = new Engine.Sprite();
    var sprpau = new Engine.Sprite();
    spr.enabled = spr.pinned = sprpau.enabled = sprpau.pinned = true;
    Game.addAction("configure", function () {
        Game.FrameSelector.complex("TimerFrame", Game.Resources.texgam, 199, 353)[0].applyToSprite(spr);
        Game.FrameSelector.complex("TimerFramePau", Game.Resources.texgam, 278, 353)[0].applyToSprite(sprpau);
    });
    var TimerFrame = /** @class */ (function (_super) {
        __extends(TimerFrame, _super);
        function TimerFrame() {
            var _this = _super.call(this) || this;
            spr.enabled = Game.Level.speedrun;
            sprpau.enabled = Game.Level.speedrun;
            _this.onViewUpdate();
            return _this;
        }
        TimerFrame.prototype.onViewUpdate = function () {
            spr.x = Engine.Renderer.xSizeView * 0.5 + 32;
            spr.y = -Engine.Renderer.ySizeView * 0.5 - 8 - (Game.Level.speedrun ? 0 : 7) - (Game.TimerButton.on ? 0 : 7);
            sprpau.y = Engine.Renderer.ySizeView * 0.5 + 8 + (Game.Level.speedrun ? 0 : 7) + (Game.TimerButton.on ? 0 : 7);
        };
        TimerFrame.prototype.onDrawBubblesDialog = function () {
            if (Game.SceneFreezer.paused) {
                sprpau.render();
            }
        };
        TimerFrame.prototype.onDrawSpeedrunDialog = function () {
            if (!Game.SceneFreezer.paused) {
                spr.render();
            }
        };
...
(function (Game) {
    ...
    var spr = new Engine.Sprite;
    spr.enabled = spr.pinned = true;
    Game.addAction("init", function () { Game.FrameSelector.complex("titlab", Game.Resources.texgam, 716, 202, null, 0)[0].applyToSprite(spr); });
    var TitleLabel = /** @class */ (function (_super) {
        __extends(TitleLabel, _super);
        function TitleLabel(y) {
            var _this = _super.call(this) || this;
            spr.y = y;
            tex = new Utils.Text();
            ...
            tex.yAligned = y + 20 + 13;
            return _this;
        }
        TitleLabel.prototype.onDrawBubblesDialog = function () {
            spr.render();
        };
        return TitleLabel;
    }(Engine.Entity));
...
(function (Game) {
    ...
    var Platform = /** @class */ (function (_super) {
        ...
        Platform.prototype.onSpell = function () {
            this.sca = this.sca == 1 ? this.spesca : 1;
        };
        ...
        Platform.prototype.xmagmov = function () {
            return this.xdis > this.xvel * this.sca ? this.xvel * this.sca : this.xdis;
        };
        ...
        Platform.prototype.ymagmov = function () {
            return this.ydis > this.yvel * this.sca ? this.yvel * this.sca : this.ydis;
        };
        ...
        Platform.prototype.onDrawObjects = function () {
            var xdra = this.box.x + this.xvelmov() * Engine.System.stepExtrapolation * (Game.SceneFreezer.stoped || Game.Player.sto() ? 0 : 1) / Engine.Box.UNIT;
            var ydra = this.box.y + this.yvelmov() * Engine.System.stepExtrapolation * (Game.SceneFreezer.stoped || Game.Player.sto() ? 0 : 1) / Engine.Box.UNIT;
            this.box.renderAt(xdra, ydra);
        };
        Platform.prototype.onClearScene = function () {
            Platform.sol = [];
        };
    ...
    var AutoPlatform = /** @class */ (function (_super) {
        ...
        AutoPlatform.prototype.onDrawPlatforms = function () {
            for (var _i = 0, _a = this.spr; _i < _a.length; _i++) {
                var spr = _a[_i];
                spr.x = this.box.x + (Game.SceneFreezer.stoped || Game.Player.sto() ? 0 : this.xvelmov() * Engine.System.stepExtrapolation / Engine.Box.UNIT);
                spr.y = this.box.y + this.box.yOffset + (Game.SceneFreezer.stoped || Game.Player.sto() ? 0 : this.yvelmov() * Engine.System.stepExtrapolation / Engine.Box.UNIT);
                spr.render();
            }
            this.box.render();
        };
...
///<reference path="../../System/Entity.ts"/>
namespace Game.Pepe{
    var interactables:Array<IPlatformInteractable>=[];

    export interface IPlatformInteractable{
        platformParent:Platform;
        boxSolid:Engine.Box;
        xMoveOnPlatform(dist:number):void;
        yMoveOnPlatform(dist:number):void;
        onPlatformOverlapX():void;
        onPlatformOverlapY():void;
    }
    
    export class Platform extends Entity{
        

        protected soundOrigin:Engine.AudioPlayer=null;
        protected soundDestiny:Engine.AudioPlayer=null;
        protected shakeOrigin=false;
        protected shakeDestiny=false;

        protected xSoundExtra=0;
        protected ySoundExtra=0;

        protected onScreenCheck=false;
        protected activeNow:boolean;

        protected xOnScreenActive:number;
        protected yOnScreenActive:number;
...
namespace Game{
    ...
    addAction("configure",function(){
        FRAMES=FrameSelector.complex("platforms",Resources.texgam,951,202,null,0,false);
    });

    export class Platform extends Arcade.Platformer.Platform{
        protected xSize:number;
        protected ySize:number;
        protected sprites:Array<Engine.Sprite>;
    
        protected constructor(def:any){
            super(def);
            this.xSize=def.instance.width/SceneMap.instance.xSizeTile;
            this.ySize=def.instance.height/SceneMap.instance.ySizeTile;
            this.sprites=[];
            for(var rig=0;rig<this.xSize;rig+=1){
                for(var yIndex=0;yIndex<this.ySize;yIndex+=1){
                    var sprite=new Engine.Sprite();
                    sprite.enabled=true;
                    if(this.xSize==1&&this.ySize==1){
                        FRAMES[0].applyToSprite(sprite);
                    }
                    else if(this.xSize==1){
                        if(yIndex==0){
                            FRAMES[4].applyToSprite(sprite);
                        }
                        else if(yIndex==this.ySize-1){
                    ...
                    else if(this.ySize==1){
                        if(rig==0){
                            FRAMES[1].applyToSprite(sprite);
                        }
                        else if(rig==this.xSize-1){
                        ...
                        else if(rig==0&&yIndex==this.ySize-1){
                            FRAMES[13].applyToSprite(sprite);
                        }
                        else if(rig==this.xSize-1&&yIndex==0){
                            FRAMES[7].applyToSprite(sprite);
                        }
                        else if(rig==this.xSize-1&&yIndex==this.ySize-1){
                    ...
                    sprite.xOffset=rig*SceneMap.instance.xSizeTile;//-(rig==0?1:0);
                    sprite.yOffset=yIndex*SceneMap.instance.ySizeTile;
                    this.sprites.push(sprite);
                }
            }
            this.box.xSize=this.xSize*SceneMap.instance.xSizeTile;
            this.box.ySize=this.ySize*SceneMap.instance.ySizeTile;
            this.box.yOffset-=(this.ySize-1)*SceneMap.instance.ySizeTile;
        }

        protected onDrawObjects(){

        }

        protected onDrawPlatforms(){
            for(var sprite of this.sprites){
                sprite.x=this.box.x+(SceneFreezer.stoped?0:this.xvelmov()*Engine.System.deltaTime);
                sprite.y=this.box.y+this.box.yOffset+(SceneFreezer.stoped?0:this.yvelmov()*Engine.System.deltaTime);
                sprite.render();
            }
            this.box.render();
        }
...
(function (Game) {
    ...
    var off;
    Game.addAction("configure", function () {
        fra = Game.FrameSelector.complex("defpla", Game.Resources.texgam, 0, 532);
        off = fra.length / 2;
    });
    var DefaultAutoPlatform = /** @class */ (function (_super) {
        __extends(DefaultAutoPlatform, _super);
        function DefaultAutoPlatform(def) {
            var _this = _super.call(this, def, fra) || this;
            _this.box.ySize -= 1;
            return _this;
        }
        DefaultAutoPlatform.prototype.fix = function (fra) {
            _super.prototype.fix.call(this, fra);
            this.bac = this.bac || [];
            for (var rig = 0; rig < this.wid; rig += 1) {
                for (var yIndex = 0; yIndex < this.hei; yIndex += 1) {
                    var bac = new Engine.Sprite();
                    bac.enabled = true;
                    if (this.wid == 1 && this.hei == 1)
                        fra[0 + off].applyToSprite(bac);
                    else if (this.wid == 1) {
                        if (yIndex == 0)
                            fra[4 + off].applyToSprite(bac);
                        else if (yIndex == this.hei - 1)
                            fra[12 + off].applyToSprite(bac);
                        else
                            fra[8 + off].applyToSprite(bac);
                    }
                    else if (this.hei == 1) {
                        if (rig == 0)
                            fra[1 + off].applyToSprite(bac);
                        else if (rig == this.wid - 1)
                            fra[3 + off].applyToSprite(bac);
                        else
                            fra[2 + off].applyToSprite(bac);
                    }
                    else {
                        if (rig == 0 && yIndex == 0)
                            fra[5 + off].applyToSprite(bac);
                        else if (rig == 0 && yIndex == this.hei - 1)
                            fra[13 + off].applyToSprite(bac);
                        else if (rig == this.wid - 1 && yIndex == 0)
                            fra[7 + off].applyToSprite(bac);
                        else if (rig == this.wid - 1 && yIndex == this.hei - 1)
                            fra[15 + off].applyToSprite(bac);
                        else if (rig == 0)
                            fra[9 + off].applyToSprite(bac);
                        else if (rig == this.wid - 1)
                            fra[11 + off].applyToSprite(bac);
                        else if (yIndex == 0)
                            fra[6 + off].applyToSprite(bac);
                        else if (yIndex == this.hei - 1)
                            fra[14 + off].applyToSprite(bac);
                        else
                            fra[10 + off].applyToSprite(bac);
                    }
                    bac.xOffset += rig * Game.SceneMap.instance.xSizeTile;
                    bac.yOffset += yIndex * Game.SceneMap.instance.ySizeTile - 1;
                    this.bac.push(bac);
                }
            }
        };
        DefaultAutoPlatform.prototype.onDrawPlatforms = function () {
            if (this.spesca != 1) {
                for (var _i = 0, _a = this.bac; _i < _a.length; _i++) {
                    var bac = _a[_i];
                    bac.x = this.box.x + (Game.SceneFreezer.stoped || Game.Player.sto() ? 0 : this.xvelmov() * Engine.System.stepExtrapolation / Engine.Box.UNIT);
                    bac.y = this.box.y + this.box.yOffset + (Game.SceneFreezer.stoped || Game.Player.sto() ? 0 : this.yvelmov() * Engine.System.stepExtrapolation / Engine.Box.UNIT);
                    Game.ColorWave.applyToSprite(bac, this.spesca, this.sca);
                    bac.render();
                }
                this.box.render();
            }
            _super.prototype.onDrawPlatforms.call(this);
        };
...
(function (Game) {
    var fra;
    Game.addAction("configure", function () { return fra = Game.FrameSelector.complex("ghopla", Game.Resources.texgam, 512, 468); });
    var GhostPlatform = /** @class */ (function (_super) {
        __extends(GhostPlatform, _super);
        function GhostPlatform(def) {
            var _this = _super.call(this, def) || this;
            _this.spr = new Engine.Sprite();
            _this.box.xSize = def.instance.width;
            _this.off = (def.instance.width / Game.SceneMap.instance.xSizeTile) - 1;
            _this.spr.enabled = true;
            _this.fad = _this.getProperty("fad");
            return _this;
        }
        GhostPlatform.prototype.onReset = function () {
            _super.prototype.onReset.call(this);
            this.spr.setRGBA(1, 1, 1, 1);
            this.box.enabled = true;
            this.hid = 0;
            this.fra = 0;
            this.alp = 1;
        };
        GhostPlatform.prototype.onSpell = function () {
        };
        GhostPlatform.prototype.onMoveUpdate = function () {
            if (Game.SceneFreezer.stoped || Game.Player.sto())
                return;
            if (this.hid == 0 && this.chi.length != 0) {
                this.hid = 2;
                Game.Resources.audhid.autoplay();
            }
            this.fra++;
            var ind = Math.floor((this.fra) / (13 * (this.hid == 2 ? 0.65 : 1.25))) % 2;
            fra[ind + this.hid + this.off * 4].applyToSprite(this.spr);
            _super.prototype.onMoveUpdate.call(this);
            if (this.hid == 2 && this.alp > 0) {
                this.alp -= this.fad;
                if (this.alp <= 0) {
                    this.alp = 0;
        ...
        GhostPlatform.prototype.onDrawPlatforms = function () {
            if (!this.box.enabled)
                return;
            if (this.hid == 2) {
                var alp = this.alp - this.fad * Engine.System.stepExtrapolation;
                if (alp < 0)
                    alp = 0;
                this.spr.setRGBA(1, 1, 1, alp);
            }
            this.spr.x = this.box.x + (Game.SceneFreezer.stoped || Game.Player.sto() ? 0 : this.xvelmov() * Engine.System.stepExtrapolation / Engine.Box.UNIT);
            this.spr.y = this.box.y + this.box.yOffset + (Game.SceneFreezer.stoped || Game.Player.sto() ? 0 : this.yvelmov() * Engine.System.stepExtrapolation / Engine.Box.UNIT);
            this.spr.render();
            this.box.render();
        };
        return GhostPlatform;
    }(Game.Platform));
    Game.GhostPlatform = GhostPlatform;
})(Game || (Game = {}));
///<reference path="../../Engine/Entity.ts"/>
var Game;
(function (Game) {
