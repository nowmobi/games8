...
(function (Game) {
    ...
    Engine.System.onInit = function () {
        if (Engine.Data.useLocalStorage) {
            Engine.Data.setID("com", "kez", "mirwiz1_5");
        }
        else {
            Engine.Data.setID("c", "k", "mirwiz1_5");
        }
...
(function (Game) {
    ...
    (function (Credits) {
        ...
        function makbacbut() {
            var pepe = -60;
            var but = new Game.DialogButton(Game.plu ? 7 : 6, 0, (Game.plu ? -2 : 0) + 44 - 10 - 5 + pepe);
...
(function (Game) {
    ...
    var LastScene = /** @class */ (function (_super) {
        ...
        function LastScene() {
            ...
            if (!hasLinks && Game.IS_TOUCH)
                pepe += 0.5;
            if (Game.Level.speedrun && Game.IS_TOUCH) {
                if (hasLinks || !Game.IS_TOUCH)
                    pepe += 0.5;
            }
            //Level.speedrun=true;
...
(function (Game) {
    ...
    (function (LevelSelection) {
        ...
        var verbut = -34 + 5 - 10 + 10 + 5 + 2 + 25 - 4;
        var vernavbut = 5 - 5 - 2 - 2 + 7 - 2 - 25 - 61 + 4;
        Game.addAction("configure", function () {
            if (Game.plu) {
                horsepbut += 5;
                versepbut += 2;
...
(function (Game) {
    ...
    (function (SpeedrunMenu) {
        var horbut = 53.5;
        var verbut = 46.5 - 80 - 0.5 + 1;
        var verconbut = 26 - 44 + 2 - 2 + 1;
        Game.addAction("configure", function () {
            if (Game.plu) {
                horbut -= 2;
                verbut += 2;
...
(function (Game) {
    ...
    var ByDevFrame = /** @class */ (function (_super) {
        ...
        function ByDevFrame() {
            ...
            but.anchor.yAligned = -1 - (Game.HAS_LINKS ? 1 : 3 - 3);
...
(function (Game) {
    ...
    Game.addAction("configure", function () {
        ...
        var pepe = 16;
        spr.y = -28 - 15 + 10 - 4 + 2 - 1 + (Game.plu ? -4 : 0) + pepe;
    });
...
(function (Game) {
    ...
    (function (goa) {
        ...
        goa.ovegot = ovegot;
        //for(var i=0;i<200;i++)console.error("DELETE SKIP LEVEL BUTTON "+i);
        function stegot() {
            /*
