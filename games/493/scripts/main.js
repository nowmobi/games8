...
;'use strict';
{
    ...
    const HANDLER_CLASS = class InstantGamesDOMHandler extends self.DOMHandler {
        constructor(iRuntime) {
            ...
            this.AddRuntimeMessageHandlers([["load", e=>this._OnLoad(e)], ["loading-progress", e=>this._OnLoadingProgress(e)], ["start-game", ()=>this._OnStartGame()], ["quit", ()=>this._OnQuit()], ["set-player-data", e=>this._OnSetPlayerData(e)], ["load-player-data", ()=>this._OnLoadPlayerData()], ["share", e=>this._OnShare(e)], ["custom-update", e=>this._OnCustomUpdate(e)], ["switch-game", e=>this._OnSwitchGame(e)], ["change-context", e=>this._OnChangeContext(e)], ["log-event", e=>this._OnLogEvent(e)], ["load-connected-players", ()=>this._OnLoadConnectedPlayers()], ["set-score", e=>this._OnSetScore(e)], ["load-player-score", e=>this._OnLoadPlayerScore(e)], ["share-leaderboard-update", e=>this._OnShareLeaderboardUpdate(e)], ["load-leaderboard", e=>this._LoadLeaderboard(e)], ["create-shortcut", ()=>this._OnCreateShortcut()], ["subscribe-bot", ()=>this._OnSubscribeBot()], ["load-ad", e=>this._OnLoadAd(e)], ["show-ad", e=>this._OnShowAd(e)]])
        }
        async _OnLoad(e) {
        ...
        async _OnLoadAd(e) {
            ...
            try {
                ...
                let adInstance;
                if (isInterstitial)
                    adInstance = await this._FBInstant["getInterstitialAdAsync"](placementId);
                else
                    adInstance = await this._FBInstant["getRewardedVideoAsync"](placementId);
                await adInstance["loadAsync"]();
                if (isInterstitial)
                    this._loadedInterstitialAd = adInstance;
                else
                    this._loadedRewardedVideoAd = adInstance;
                return true
            } catch (err) {
        ...
        async _OnShowAd(e) {
            ...
            if (typeof sdk !== 'undefined' && sdk.showBanner !== 'undefined') { 
                ...
                if(e["type"] == 1){
                    ...
                    await new Promise((resolve, reject)=>{
                        window.adsCtl.finishCall = resolve;        
                    });
                }
