function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'particle_sfx',loop:false,volume:1, ingamename: 'particle_sfx'});
        
        for(var i=1;i<11;i++){
            s_aSoundsInfo.push({path: './sounds/',filename:'miao_'+i,loop:false,volume:1, ingamename: 'miao_'+i});
        }
    ...
    this._loadImages = function(){
        ...
        for(var i=1;i<NUM_TYPES+1;i++){
            s_oSpriteLibrary.addSprite("cell_"+i,"./sprites/cell_"+i+".png");
        }
        for(var k=0;k<22;k++){
            s_oSpriteLibrary.addSprite("particle_stars_"+k,"./sprites/particle_stars/particle_stars_"+k+".png");
        }
    ...
    this.startLevelMenu = function(){
    };

    this.gotoGame = function(iDiff, iLevel){
        s_iCurDiff = iDiff;

        s_iTotalScore = getScoreTillLevel(iDiff,getSavedLevel(iDiff));
