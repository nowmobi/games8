function CMenu(){
    ...
    this._init = function(){
        ...
        _oLogo.visible = true;
        createjs.Tween.get(_oLogo).wait(500).to({scale:iFinalScale}, 1500,createjs.Ease.elasticOut);
    ...
    this.refreshButtonPos = function(){
        ...
        if(createjs.Tween.hasActiveTweens(_oLogo) === false){
            var iFinalScale =1;
            if(s_bLandscape){
                iFinalScale = 0.7;
            }

            _oLogo.scale = iFinalScale;
        }
    };
