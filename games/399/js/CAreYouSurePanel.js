function CAreYouSurePanel(oParentContainer) {
    ...
    this._init = function () {
        ...
        _oMsg = new CTLText(_oPanelContainer, 
                    oSpriteBg.width/2-320, 190, 640, 240, 
                    140, "center", "#fff", FONT, 1,
                    0, 0,
                    " ",
                    true, true, true,
                    false );
        ...
        _oButYes = new CGfxButton(oSpriteBg.width-220, 650, s_oSpriteLibrary.getSprite('but_yes'), _oPanelContainer);
        _oButYes.addEventListener(ON_MOUSE_UP, this._onButYes, this);

        _oButNo = new CGfxButton(220, 650, s_oSpriteLibrary.getSprite('but_no'), _oPanelContainer);
