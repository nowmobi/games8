var Bezier = function(t) {
    ...
    ! function() {
        ...
        var e = Math.abs,
            ...
            p = function(t) {
                ...
                var l = ["x", "y"];
                a && l.push("z"), this.dims = l, this.dimlen = l.length,
                    function(t) {
                        for (var r = t.order, n = t.points, i = y.align(n, {
                                p1: n[0],
                                p2: n[r]
                            }), o = 0; o < i.length; o++)
        ...
        p.SVGtoBeziers = function(t) {
            ...
            if ("undefined" == typeof e && (e = .5), 0 === e) return new p(n, n, i);
        ...
        p.getUtils = d, p.PolyBezier = l, p.prototype = {
            getUtils: d,
            valueOf: function() {
            ...
            toSVG: function(t) {
                ...
                for (var r = this.points, n = r[0].x, i = r[0].y, e = ["M", n, i, 2 === this.order ? "Q" : "C"], o = 1, s = r.length; o < s; o++) e.push(r[o].x), e.push(r[o].y);
                return e.join(" ")
            },
            ...
            getLUT: function(t) {
                ...
                this._lut = [], t--;
                for (var r = 0; r <= t; r++) this._lut.push(this.compute(r / t));
                return this._lut
            },
            on: function(t, r) {
                r = r || 5;
                for (var n, i = this.getLUT(), e = [], o = 0, s = 0; s < i.length; s++) n = i[s], y.dist(n, t) < r && (e.push(n), o += s / i.length);
                return !!e.length && (o /= e.length)
            },
            project: function(t) {
                var r, n, i, e, o = this.getLUT(),
                    s = o.length - 1,
                    u = y.closest(o, t),
                    a = u.mdist,
                    f = u.mpos,
                    ...
                    h = (f + 1) / s,
                    x = .1 / s;
                for (a += 1, n = c, r = n; n < h + x; n += x) i = this.compute(n), e = y.dist(t, i), e < a && (a = e, r = n);
            ...
            raise: function() {
                for (var t, r, n, i = this.points, e = [i[0]], o = i.length, t = 1; t < o; t++) r = i[t], n = i[t - 1], e[t] = {
                    x: (o - t) / o * r.x + t / o * n.x,
                    y: (o - t) / o * r.y + t / o * n.y
                };
            ...
            derivative: function(t) {
                var r, n, i = 1 - t,
                    e = 0,
                    o = this.dpoints[0];
                2 === this.order && (o = [o[0], o[1], x], r = i, n = t), 3 === this.order && (r = i * i, n = i * t * 2, e = t * t);
                var s = {
            ...
            __normal3: function(t) {
                ...
                r.x /= i, r.y /= i, r.z /= i, n.x /= e, n.y /= e, n.z /= e;
                var o = {
                        x: n.y * r.z - n.z * r.y,
                        y: n.z * r.x - n.x * r.z,
                        z: n.x * r.y - n.y * r.x
            ...
            hull: function(t) {
                var r, n = this.points,
                    ...
                    s = 0,
                    u = 0;
                for (e[o++] = n[0], e[o++] = n[1], e[o++] = n[2], 3 === this.order && (e[o++] = n[3]); n.length > 1;) {
                    for (i = [], s = 0, u = n.length - 1; s < u; s++) r = y.lerp(t, n[s], n[s + 1]), e[o++] = r, i.push(r);
                    n = i
                }
                return e
            },
            split: function(t, r) {
                ...
                var n = this.hull(t),
                    i = {
                        left: new p(2 === this.order ? [n[0], n[3], n[5]] : [n[0], n[4], n[7], n[9]]),
                        right: new p(2 === this.order ? [n[5], n[4], n[2]] : [n[9], n[8], n[6], n[3]]),
                        span: n
                    };
                if (i.left._t1 = y.map(0, 0, 1, this._t1, this._t2), i.left._t2 = y.map(t, 0, 1, this._t1, this._t2), i.right._t1 = y.map(t, 0, 1, this._t1, this._t2), i.right._t2 = y.map(1, 0, 1, this._t1, this._t2), !r) return i;
                r = y.map(r, t, 1, 0, 1);
            ...
            extrema: function() {
                ...
                return n.forEach(function(n) {
                    r = function(t) {
                        return t[n]
                    }, t = this.dpoints[0].map(r), i[n] = y.droots(t), 3 === this.order && (t = this.dpoints[1].map(r), i[n] = i[n].concat(y.droots(t))), i[n] = i[n].filter(function(t) {
                        return t >= 0 && t <= 1
                    }), e = e.concat(i[n].sort(y.numberSort))
                }.bind(this)), e = e.sort(y.numberSort).filter(function(t, r) {
            ...
            reduce: function() {
                ...
                for (a.indexOf(0) === -1 && (a = [0].concat(a)), a.indexOf(1) === -1 && a.push(1), n = a[0], t = 1; t < a.length; t++) i = a[t], r = this.split(n, i), r._t1 = n, r._t2 = i, s.push(r), n = i;
                return s.forEach(function(t) {
                    for (n = 0, i = 0; i <= 1;)
                        for (i = n + o; i <= 1 + o; i += o)
                            if (r = t.split(n, i), !r.simple()) {
                                if (i -= o, e(n - i) < o) return [];
                                r = t.split(n, i), r._t1 = y.map(n, 0, 1, t._t1, t._t2), r._t2 = y.map(i, 0, 1, t._t1, t._t2), u.push(r), n = i;
                                break
                            }
                    n < 1 && (r = t.split(n, 1), r._t1 = y.map(n, 0, 1, t._t1, t._t2), r._t2 = t._t2, u.push(r))
                }), u
            },
            scale: function(t) {
                var r = this.order,
                    n = !1;
                if ("function" == typeof t && (n = t), n && 2 === r) return this.raise().scale(n);
                ...
                return [0, 1].forEach(function(t) {
                    ...
                    n.x += (t ? o : e) * s[t].n.x, n.y += (t ? o : e) * s[t].n.y
                ...
                }.bind(this)), new p(f)) : ([0, 1].forEach(function(t) {
                    if (2 !== this.order || !t) {
                        var n = f[t * r],
                            i = this.derivative(t),
                            e = {
            ...
            outlineshapes: function(t, r, n) {
                r = r || t;
                for (var i = this.outline(t, r).curves, e = [], o = 1, s = i.length; o < s / 2; o++) {
            ...
            intersects: function(t, r) {
                return t ? t.p1 && t.p2 ? this.lineIntersects(t) : (t instanceof p && (t = t.reduce()), this.curveintersects(this.reduce(), t, r)) : this.selfintersects(r)
            },
            ...
            selfintersects: function(t) {
                var r, n, i, e, o = this.reduce(),
                    s = o.length - 2,
                    u = [];
                for (r = 0; r < s; r++) i = o.slice(r, r + 1), e = o.slice(r + 2), n = this.curveintersects(i, e, t), u = u.concat(n);
                return u
            },
            ...
            _iterate: function(t, r) {
                ...
                do {
                    ...
                    var o, s, f, c, h, x = this.get(i),
                        ...
                        m = 0;
                    do {
                        p = l, c = f, v = (i + e) / 2, m++, o = this.get(v), s = this.get(e), f = y.getccenter(x, o, s), f.interval = {
                            start: i,
                            end: e
                        };
                        var z = this._error(f, x, i, e);
                        if (l = z <= t, h = p && !l, h || (d = e), l) {
                            if (e >= 1) {
            ...
            d = {
                ...
                compute: function(t, r, n) {
                    ...
                    for (var y = JSON.parse(JSON.stringify(r)); y.length > 1;) {
                        for (var l = 0; l < y.length - 1; l++) y[l] = {
                            x: y[l].x + (y[l + 1].x - y[l].x) * t,
                            y: y[l].y + (y[l + 1].y - y[l].y) * t
                        }, "undefined" != typeof y[l].z && (y[l] = y[l].z + (y[l + 1].z - y[l].z) * t);
                ...
                computeWithRatios: function(t, r, n, i) {
                    var e, o = 1 - t,
                        ...
                        c = s[2],
                        h = s[3];
                    return a *= o, f *= t, 2 === u.length ? (e = a + f, {
                        x: (a * u[0].x + f * u[1].x) / e,
                        y: (a * u[0].y + f * u[1].y) / e,
                        z: !!i && (a * u[0].z + f * u[1].z) / e
                    }) : (a *= o, f *= 2 * o, c *= t * t, 3 === u.length ? (e = a + f + c, {
                        x: (a * u[0].x + f * u[1].x + c * u[2].x) / e,
                        y: (a * u[0].y + f * u[1].y + c * u[2].y) / e,
                        z: !!i && (a * u[0].z + f * u[1].z + c * u[2].z) / e
                    }) : (a *= o, f *= 1.5 * o, c *= 3 * o, h *= t * t * t, 4 === u.length ? (e = a + f + c + h, {
                        x: (a * u[0].x + f * u[1].x + c * u[2].x + h * u[3].x) / e,
                        y: (a * u[0].y + f * u[1].y + c * u[2].y + h * u[3].y) / e,
                        z: !!i && (a * u[0].z + f * u[1].z + c * u[2].z + h * u[3].z) / e
                    }) : void 0))
                },
                derive: function(t, r) {
                    for (var n = [], i = t, e = i.length, o = e - 1; e > 1; e--, o--) {
                        for (var s, u = [], a = 0; a < o; a++) s = {
                            x: o * (i[a + 1].x - i[a].x),
                            y: o * (i[a + 1].y - i[a].y)
                        }, r && (s.z = o * (i[a + 1].z - i[a].z)), u.push(s);
                        n.push(u), i = u
                    }
                    return n
                },
                between: function(t, r, n) {
                    return r <= t && t <= n || d.approximately(t, r) || d.approximately(t, n)
                },
                ...
                length: function(t) {
                    var r, n, i = .5,
                        e = 0,
                        o = d.Tvalues.length;
                    for (r = 0; r < o; r++) n = i * d.Tvalues[r] + i, e += d.Cvalues[r] * d.arcfn(n, t);
                    return i * e
                },
                ...
                findbbox: function(t) {
                    ...
                    return t.forEach(function(t) {
                        var o = t.bbox();
                        r > o.x.min && (r = o.x.min), n > o.y.min && (n = o.y.min), i < o.x.max && (i = o.x.max), e < o.y.max && (e = o.y.max)
                    }), {
                        x: {
                            min: r,
                            mid: (r + i) / 2,
                ...
                getminmax: function(t, r, n) {
                    ...
                    for (var u = 0, a = n.length; u < a; u++) i = n[u], e = t.get(i), e[r] < o && (o = e[r]), e[r] > s && (s = e[r]);
                    return {
                        min: o,
                        mid: (o + s) / 2,
                        max: s,
                ...
                roots: function(t, r) {
                    ...
                    if (2 === n) {
                        ...
                        return c !== x && 0 === y ? [(2 * c - x) / (2 * c - 2 * x)].filter(s) : []
                    }
                    var z = e[0].y,
                        g = e[1].y,
                        b = e[2].y,
                    ...
                    if (d.approximately(y, 0)) {
                        if (d.approximately(a, 0)) return d.approximately(c, 0) ? [] : [-x / c].filter(s);
                        var w = u(c * c - 4 * a * x),
                            E = 2 * a;
                        return [(w - c) / E, (-c - w) / E].filter(s)
                    }
                    a /= y, c /= y, x /= y;
                    var S, v, M, k, j, e = (3 * c - a * a) / 3,
                        O = e / 3,
                    ...
                    if (C < 0) {
                        var L = -e / 3,
                            ...
                            q = f(A),
                            P = 2 * q;
                        return M = P * i(I / 3) - a / 3, k = P * i((I + h) / 3) - a / 3, j = P * i((I + 2 * h) / 3) - a / 3, [M, k, j].filter(s)
                    }
                    if (0 === C) return S = T < 0 ? f(-T) : -f(T), M = 2 * S - a / 3, k = -S - a / 3, [M, k].filter(s);
                    var R = u(C);
                    return S = f(-T + R), v = f(T + R), [S - v - a / 3].filter(s)
                },
                droots: function(t) {
                    if (3 === t.length) {
                        var r = t[0],
                ...
                curvature: function(t, n, i, e) {
                    var o, s, f, c, h = d.derive(n),
                        ...
                        m = d.compute(t, y),
                        z = v.x * v.x + v.y * v.y;
                    if (i ? (o = u(a(v.y * m.z - m.y * v.z, 2) + a(v.z * m.x - m.z * v.x, 2) + a(v.x * m.y - m.x * v.y, 2)), s = a(z + v.z * v.z, 1.5)) : (o = v.x * m.y - v.y * m.x, s = a(z, 1.5)), 0 === o || 0 === s) return {
                        k: 0,
                        r: 0
                    };
                    if (l = o / s, p = s / o, !e) {
                        var g = d.curvature(t - .001, n, i, !0).k,
                            b = d.curvature(t + .001, n, i, !0).k;
                ...
                inflections: function(t) {
                    ...
                    var c = u * u - 4 * s * a,
                        h = Math.sqrt(c),
                        o = 2 * s;
                    return d.approximately(o, 0) ? [] : [(h - u) / o, -(u + h) / o].filter(function(t) {
                        return 0 <= t && t <= 1
                    })
                },
                ...
                pairiteration: function(t, r, n) {
                    var i = t.bbox(),
                        ...
                        o = 1e5,
                        s = n || .5;
                    if (i.x.size + i.y.size < s && e.x.size + e.y.size < s) return [(o * (t._t1 + t._t2) / 2 | 0) / o + "/" + (o * (r._t1 + r._t2) / 2 | 0) / o];
                    var u = t.split(.5),
                        a = r.split(.5),
                        f = [{
                            left: u.left,
                ...
                getccenter: function(t, r, n) {
                    var o, u = r.x - t.x,
                        ...
                        O = s(r.y - M.y, r.x - M.x),
                        T = s(n.y - M.y, n.x - M.x);
                    return j < T ? ((j > O || O > T) && (j += h), j > T && (o = T, T = j, j = o)) : T < O && O < j ? (o = T, T = j, j = o) : T += h, M.s = j, M.e = T, M.r = k, M
                },
    ...
    ! function() {
        ...
        i.prototype = {
            ...
            bbox: function t() {
                for (var n = this.curves, t = n[0].bbox(), i = 1; i < n.length; i++) r.expandbox(t, n[i].bbox());
                return t
            },
            offset: function t(r) {
                var t = [];
    ...
    function e(t, r) {
        for (var n, e, s, u = o(r).split(" "), a = new RegExp("[MLCQZ]", ""), f = [], c = {
                C: 6,
                Q: 4,
                L: 2,
                M: 2
            }; u.length;) n = u.splice(0, 1)[0], a.test(n) && (s = u.splice(0, c[n]).map(parseFloat), e = i(t, n, s), e && f.push(e));
    ...
    function n(t) {
        t = t.replace(/,/g, " ").replace(/-/g, " - ").replace(/-\s+/g, "-").replace(/([a-zA-Z])/g, " $1 ");
        var r, n, i, e, o, s, u = t.replace(/([a-zA-Z])\s?/g, "|$1").split("|"),
            a = u.length,
            f = [],
            c = 0,
            h = 0,
        ...
        for (r = 1; r < a; r++)
            if (n = u[r], i = n.substring(0, 1), e = i.toLowerCase(), f = n.replace(i, "").trim().split(" "), f = f.filter(function(t) {
                ...
                if (m += "M ", "m" === i ? (x += f[0], y += f[1]) : (x = f[0], y = f[1]), c = x, h = y, m += x + " " + y + " ", o > 2)
                    for (s = 0; s < o; s += 2) "m" === i ? (x += f[s], y += f[s + 1]) : (x = f[s], y = f[s + 1]), m += ["L", x, y, ""].join(" ")
            } else if ("l" === e)
            for (s = 0; s < o; s += 2) "l" === i ? (x += f[s], y += f[s + 1]) : (x = f[s], y = f[s + 1]), m += ["L", x, y, ""].join(" ");
        else if ("h" === e)
            for (s = 0; s < o; s++) "h" === i ? x += f[s] : x = f[s], m += ["L", x, y, ""].join(" ");
        else if ("v" === e)
            for (s = 0; s < o; s++) "v" === i ? y += f[s] : y = f[s], m += ["L", x, y, ""].join(" ");
        else if ("q" === e)
            for (s = 0; s < o; s += 4) "q" === i ? (l = x + f[s], p = y + f[s + 1], x += f[s + 2], y += f[s + 3]) : (l = f[s], p = f[s + 1], x = f[s + 2], y = f[s + 3]), m += ["Q", l, p, x, y, ""].join(" ");
        else if ("t" === e)
            for (s = 0; s < o; s += 2) l = x + (x - l), p = y + (y - p), "t" === i ? (x += f[s], y += f[s + 1]) : (x = f[s], y = f[s + 1]), m += ["Q", l, p, x, y, ""].join(" ");
        else if ("c" === e)
            for (s = 0; s < o; s += 6) "c" === i ? (l = x + f[s], p = y + f[s + 1], v = x + f[s + 2], d = y + f[s + 3], x += f[s + 4], y += f[s + 5]) : (l = f[s], p = f[s + 1], v = f[s + 2], d = f[s + 3], x = f[s + 4], y = f[s + 5]), m += ["C", l, p, v, d, x, y, ""].join(" ");
        else if ("s" === e)
            for (s = 0; s < o; s += 4) l = x + (x - v), p = y + (y - d), "s" === i ? (v = x + f[s], d = y + f[s + 1], x += f[s + 2], y += f[s + 3]) : (v = f[s], d = f[s + 1], x = f[s + 2], y = f[s + 3]), m += ["C", l, p, v, d, x, y, ""].join(" ");
