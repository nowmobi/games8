...
var Box2D = {};
! function(t, o) {
    function i() {}!(Object.prototype.defineProperty instanceof Function) && Object.prototype.__defineGetter__ instanceof Function && Object.prototype.__defineSetter__ instanceof Function && (Object.defineProperty = function(t, o, i) {
        i.get instanceof Function && t.__defineGetter__(o, i.get), i.set instanceof Function && t.__defineSetter__(o, i.set)
        ...
        void 0 === t && (t = 0);
        for (var o = new Array(t || 0), i = 0; i < t; ++i) o[i] = 0;
        return o
    }, t.is = function(t, o) {
        return null !== t && (o instanceof Function && t instanceof o || !(void 0 == t.constructor.__implements || !t.constructor.__implements[o]))
...
void 0 === Box2D && (Box2D = {}), void 0 === Box2D.Collision && (Box2D.Collision = {}), void 0 === Box2D.Collision.Shapes && (Box2D.Collision.Shapes = {}), void 0 === Box2D.Common && (Box2D.Common = {}), void 0 === Box2D.Common.Math && (Box2D.Common.Math = {}), void 0 === Box2D.Dynamics && (Box2D.Dynamics = {}), void 0 === Box2D.Dynamics.Contacts && (Box2D.Dynamics.Contacts = {}), void 0 === Box2D.Dynamics.Controllers && (Box2D.Dynamics.Controllers = {}), void 0 === Box2D.Dynamics.Joints && (Box2D.Dynamics.Joints = {}),
    function() {
        ...
        function ot() {
            ot.b2Island.apply(this, arguments), this.constructor === ot && this.b2Island.apply(this, arguments)
        }
        ...
        function mt() {
            mt.b2ContactFactory.apply(this, arguments), this.constructor === mt && this.b2ContactFactory.apply(this, arguments)
        }
    ...
    function() {
        ...
        l.b2AABB = function() {
            ...
            var o = !0;
            return o = o && this.lowerBound.x <= t.lowerBound.x, o = o && this.lowerBound.y <= t.lowerBound.y, o = o && t.upperBound.x <= this.upperBound.x, o = o && t.upperBound.y <= this.upperBound.y
            ...
            } else if (h = 1 / r, _ = (this.lowerBound.x - n) * h, p = (this.upperBound.x - n) * h, u = -1, _ > p && (y = _, _ = p, p = y, u = 1), _ > i && (c.x = u, c.y = 0, i = _), e = Math.min(e, p), i > e) return !1;
            if (m < Number.MIN_VALUE) {
                if (s < this.lowerBound.y || this.upperBound.y < s) return !1
            } else if (h = 1 / a, _ = (this.lowerBound.y - s) * h, p = (this.upperBound.y - s) * h, u = -1, _ > p && (y = _, _ = p, p = y, u = 1), _ > i && (c.y = u, c.x = 0, i = _), e = Math.min(e, p), i > e) return !1;
            ...
            this.lowerBound.x = Math.min(t.lowerBound.x, o.lowerBound.x), this.lowerBound.y = Math.min(t.lowerBound.y, o.lowerBound.y), this.upperBound.x = Math.max(t.upperBound.x, o.upperBound.x), this.upperBound.y = Math.max(t.upperBound.y, o.upperBound.y)
            ...
            this.value = t.value, this.proxy = t.proxy, this.stabbingCount = t.stabbingCount, t.value = o, t.proxy = i, t.stabbingCount = e
        ...
        }, h.b2Collision = function() {}, h.ClipSegmentToLine = function(t, o, i, e) {
            void 0 === e && (e = 0);
            var n, s = 0;
            n = o[0];
            var r = n.v;
            ...
            var a = n.v,
                l = i.x * r.x + i.y * r.y - e,
                m = i.x * a.x + i.y * a.y - e;
            if (l <= 0 && t[s++].Set(o[0]), m <= 0 && t[s++].Set(o[1]), l * m < 0) {
                var c = l / (l - m);
                n = t[s];
                var h = n.v;
                h.x = r.x + c * (a.x - r.x), h.y = r.y + c * (a.y - r.y), n = t[s];
                var _;
                l > 0 ? (_ = o[0], n.id = _.id) : (_ = o[1], n.id = _.id), ++s
            }
            return s
        }, h.EdgeSeparation = function(t, o, i, e, n) {
            void 0 === i && (i = 0);
            ...
            s = n.R;
            for (var p = s.col1.x * h + s.col1.y * _, y = s.col2.x * h + s.col2.y * _, u = 0, x = Number.MAX_VALUE, f = 0; f < m; ++f) {
                r = c[f];
                var d = r.x * p + r.y * y;
                d < x && (x = d, u = f)
            }
        ...
        }, h.FindMaxSeparation = function(t, o, i, e, n) {
            var s, r, a = parseInt(o.m_vertexCount),
                l = o.m_normals;
            r = n.R, s = e.m_centroid;
            var m = n.position.x + (r.col1.x * s.x + r.col2.x * s.y),
                c = n.position.y + (r.col1.y * s.x + r.col2.y * s.y);
            r = i.R, s = o.m_centroid, m -= i.position.x + (r.col1.x * s.x + r.col2.x * s.y), c -= i.position.y + (r.col1.y * s.x + r.col2.y * s.y);
            for (var _ = m * i.R.col1.x + c * i.R.col1.y, p = m * i.R.col2.x + c * i.R.col2.y, y = 0, u = -Number.MAX_VALUE, x = 0; x < a; ++x) {
                s = l[x];
                var f = s.x * _ + s.y * p;
                f > u && (u = f, y = x)
            }
            var d = h.EdgeSeparation(o, i, y, e, n),
                b = parseInt(y - 1 >= 0 ? y - 1 : a - 1),
                v = h.EdgeSeparation(o, i, b, e, n),
                D = parseInt(y + 1 < a ? y + 1 : 0),
                B = h.EdgeSeparation(o, i, D, e, n),
                C = 0,
                A = 0,
                g = 0;
            ...
            for (;;) {
                if (y = -1 == g ? C - 1 >= 0 ? C - 1 : a - 1 : C + 1 < a ? C + 1 : 0, !((d = h.EdgeSeparation(o, i, y, e, n)) > A)) break;
                C = y, A = d
            }
            return t[0] = C, A
        }, h.FindIncidentEdge = function(t, o, i, e, n, s) {
            void 0 === e && (e = 0);
            var r, a, l = (parseInt(o.m_vertexCount), o.m_normals),
        ...
        }, h.CollidePolygons = function(t, o, i, n, s) {
            var r;
            t.m_pointCount = 0;
            var a = o.m_radius + n.m_radius,
                l = 0;
            h.s_edgeAO[0] = l;
            var m = h.FindMaxSeparation(h.s_edgeAO, o, i, n, s);
            if (l = h.s_edgeAO[0], !(m > a)) {
                var c = 0;
                h.s_edgeBO[0] = c;
                var _ = h.FindMaxSeparation(h.s_edgeBO, n, s, o, i);
                if (c = h.s_edgeBO[0], !(_ > a)) {
                    var p, y, u, x, f, d = 0,
                        b = 0;
                    _ > .98 * m + .001 ? (p = n, y = o, u = s, x = i, d = c, t.m_type = B.e_faceB, b = 1) : (p = o, y = n, u = i, x = s, d = l, t.m_type = B.e_faceA, b = 0);
        ...
        }, h.CollideCircles = function(t, o, i, e, n) {
            t.m_pointCount = 0;
            var s, r;
            s = i.R, r = o.m_p;
            ...
            p > y * y || (t.m_type = B.e_circles, t.m_localPoint.SetV(o.m_p), t.m_localPlaneNormal.SetZero(), t.m_pointCount = 1, t.m_points[0].m_localPoint.SetV(e.m_p), t.m_points[0].m_id.key = 0)
        }, h.CollidePolygonAndCircle = function(t, o, i, e, n) {
            t.m_pointCount = 0;
            var s, r, a = 0,
                l = 0;
            r = n.R, s = e.m_p;
            ...
            for (var h = a * r.col1.x + l * r.col1.y, _ = a * r.col2.x + l * r.col2.y, p = 0, y = -Number.MAX_VALUE, u = o.m_radius + e.m_radius, x = parseInt(o.m_vertexCount), f = o.m_vertices, d = o.m_normals, b = 0; b < x; ++b) {
                s = f[b], a = h - s.x, l = _ - s.y, s = d[b];
                var v = s.x * a + s.y * l;
                if (v > u) return;
                v > y && (y = v, p = b)
            }
        ...
        }, y.b2Distance = function() {}, y.Distance = function(t, o, i) {
            ++y.b2_gjkCalls;
            var s = i.proxyA,
                r = i.proxyB,
                l = i.transformA,
            ...
            for (var h, _ = c.m_vertices, p = y.s_saveA, u = y.s_saveB, x = 0, f = c.GetClosestPoint(), d = f.LengthSquared(), b = d, v = 0, D = 0; D < 20;) {
                ...
                var C = _[c.m_count];
                C.indexA = s.GetSupport(n.MulTMV(l.R, B.GetNegative())), C.wA = n.MulX(l, s.GetVertex(C.indexA)), C.indexB = r.GetSupport(n.MulTMV(m.R, B)), C.wB = n.MulX(m, r.GetVertex(C.indexB)), C.w = n.SubtractVV(C.wB, C.wA), ++D, ++y.b2_gjkIters;
                var A = !1;
                for (v = 0; v < x; v++)
            ...
            if (y.b2_gjkMaxIters = n.Max(y.b2_gjkMaxIters, D), c.GetWitnessPoints(t.pointA, t.pointB), t.distance = n.SubtractVV(t.pointA, t.pointB).Length(), t.iterations = D, c.WriteCache(o), i.useRadii) {
                var g = s.m_radius,
                    S = r.m_radius;
            ...
            for (var o = 0, i = this.m_vertices[0].x * t.x + this.m_vertices[0].y * t.y, e = 1; e < this.m_count; ++e) {
            ...
            return i.aabb.lowerBound.x = t.lowerBound.x - n, i.aabb.lowerBound.y = t.lowerBound.y - s, i.aabb.upperBound.x = t.upperBound.x + n, i.aabb.upperBound.y = t.upperBound.y + s, i.userData = o, this.InsertLeaf(i), i
            ...
            this.RemoveLeaf(t);
            var n = e.b2_aabbExtension + e.b2_aabbMultiplier * (i.x > 0 ? i.x : -i.x),
                s = e.b2_aabbExtension + e.b2_aabbMultiplier * (i.y > 0 ? i.y : -i.y);
            return t.aabb.lowerBound.x = o.lowerBound.x - n, t.aabb.lowerBound.y = o.lowerBound.y - s, t.aabb.upperBound.x = o.upperBound.x + n, t.aabb.upperBound.y = o.upperBound.y + s, this.InsertLeaf(t), !0
        }, d.prototype.Rebalance = function(t) {
            if (void 0 === t && (t = 0), null != this.m_root)
                for (var o = 0; o < t; o++) {
                    for (var i = this.m_root, e = 0; 0 == i.IsLeaf();) i = this.m_path >> e & 1 ? i.child2 : i.child1, e = e + 1 & 31;
            ...
            if (null != this.m_root) {
                ...
                var r = n.CrossFV(1, s),
                    ...
                    h = 0,
                    _ = 0;
                h = i.x + m * (e.x - i.x), _ = i.y + m * (e.y - i.y), c.lowerBound.x = Math.min(i.x, h), c.lowerBound.y = Math.min(i.y, _), c.upperBound.x = Math.max(i.x, h), c.upperBound.y = Math.max(i.y, _);
                var p = new Vector,
                    y = 0;
                for (p[y++] = this.m_root; y > 0;) {
                    ...
                    if (0 != u.aabb.TestOverlap(c)) {
                        var x = u.aabb.GetCenter(),
                            f = u.aabb.GetExtents();
                        if (!(Math.abs(r.x * (i.x - x.x) + r.y * (i.y - x.y)) - a.x * f.x - a.y * f.y > 0))
                            if (u.IsLeaf()) {
                                var d = new g;
                                if (d.p1 = o.p1, d.p2 = o.p2, d.maxFraction = o.maxFraction, 0 == (m = t(d, u))) return;
                                m > 0 && (h = i.x + m * (e.x - i.x), _ = i.y + m * (e.y - i.y), c.lowerBound.x = Math.min(i.x, h), c.lowerBound.y = Math.min(i.y, _), c.upperBound.x = Math.max(i.x, h), c.upperBound.y = Math.max(i.y, _))
            ...
            if (0 == i.IsLeaf())
                do {
                    var e = i.child1,
                        n = i.child2,
                        s = Math.abs((e.aabb.lowerBound.x + e.aabb.upperBound.x) / 2 - o.x) + Math.abs((e.aabb.lowerBound.y + e.aabb.upperBound.y) / 2 - o.y),
                        r = Math.abs((n.aabb.lowerBound.x + n.aabb.upperBound.x) / 2 - o.x) + Math.abs((n.aabb.lowerBound.y + n.aabb.upperBound.y) / 2 - o.y);
                    i = s < r ? e : n
                } while (0 == i.IsLeaf());
            var a = i.parent,
                l = this.AllocateNode();
            if (l.parent = a, l.userData = null, l.aabb.Combine(t.aabb, i.aabb), a) {
                i.parent.child1 == i ? a.child1 = l : a.child2 = l, l.child1 = i, l.child2 = t, i.parent = l, t.parent = l;
                do {
                    if (a.aabb.Contains(l.aabb)) break;
                    a.aabb.Combine(a.child1.aabb, a.child2.aabb), l = a, a = a.parent
                } while (a)
            } else l.child1 = i, l.child2 = t, i.parent = l, t.parent = l, this.m_root = l
        }, d.prototype.RemoveLeaf = function(t) {
            if (t == this.m_root) return void(this.m_root = null);
            var o, i = t.parent,
                e = i.parent;
            if (o = i.child1 == t ? i.child2 : i.child1, e)
                for (e.child1 == i ? e.child1 = o : e.child2 = o, o.parent = e, this.FreeNode(i); e;) {
                    var n = e.aabb;
                    if (e.aabb = l.Combine(e.child1.aabb, e.child2.aabb), n.Contains(e.aabb)) break;
                    e = e.parent
            ...
            this.m_tree.MoveProxy(t, o, i) && this.BufferMove(t)
            ...
            for (e = 0; e < o.m_moveBuffer.length; ++e) {
                ...
                i = o.m_moveBuffer[e];
                var s = o.m_tree.GetFatAABB(i);
                o.m_tree.Query(n, s)
            }
            o.m_moveBuffer.length = 0;
            for (var e = 0; e < o.m_pairCount;) {
                var r = o.m_pairBuffer[e],
                    a = o.m_tree.GetUserData(r.proxyA),
                    l = o.m_tree.GetUserData(r.proxyB);
                for (t(a, l), ++e; e < o.m_pairCount;) {
                    var m = o.m_pairBuffer[e];
            ...
            for (var o = 0; o < e.b2_maxManifoldPoints; o++)(this.m_points[o] instanceof C ? this.m_points[o] : null).Set(t.m_points[o]);
        ...
        }, g.prototype.b2RayCastInput = function(t, o, i) {
            void 0 === t && (t = null), void 0 === o && (o = null), void 0 === i && (i = 1), t && this.p1.SetV(t), o && this.p2.SetV(o), this.maxFraction = i
        }, S.b2RayCastOutput = function() {
            this.normal = new a
        }, w.b2Segment = function() {
            this.p1 = new a, this.p2 = new a
        }, w.prototype.TestSegment = function(t, o, i, e) {
            void 0 === e && (e = 0);
            var n = i.p1,
                s = i.p2.x - n.x,
                r = i.p2.y - n.y,
            ...
            var o = this.p2.x - this.p1.x,
                ...
                e = Math.min(o > 0 ? (t.upperBound.x - this.p1.x) / o : o < 0 ? (t.lowerBound.x - this.p1.x) / o : Number.POSITIVE_INFINITY, i > 0 ? (t.upperBound.y - this.p1.y) / i : i < 0 ? (t.lowerBound.y - this.p1.y) / i : Number.POSITIVE_INFINITY);
            this.p2.x = this.p1.x + o * e, this.p2.y = this.p1.y + i * e
        }, w.prototype.ExtendBackward = function(t) {
            var o = -this.p2.x + this.p1.x,
                i = -this.p2.y + this.p1.y,
                e = Math.min(o > 0 ? (t.upperBound.x - this.p2.x) / o : o < 0 ? (t.lowerBound.x - this.p2.x) / o : Number.POSITIVE_INFINITY, i > 0 ? (t.upperBound.y - this.p2.y) / i : i < 0 ? (t.lowerBound.y - this.p2.y) / i : Number.POSITIVE_INFINITY);
            ...
            if (1 == l) this.m_type = M.e_points, m = this.m_proxyA.GetVertex(t.indexA[0]), _ = this.m_proxyB.GetVertex(t.indexB[0]), x = m, u = i.R, f = i.position.x + (u.col1.x * x.x + u.col2.x * x.y), d = i.position.y + (u.col1.y * x.x + u.col2.y * x.y), x = _, u = r.R, b = r.position.x + (u.col1.x * x.x + u.col2.x * x.y), v = r.position.y + (u.col1.y * x.x + u.col2.y * x.y), this.m_axis.x = b - f, this.m_axis.y = v - d, this.m_axis.Normalize();
                ...
                var A = (n.MulX(i, m), n.MulMV(i.R, n.SubtractVV(h, c))),
                ...
                var F = (J * C + G) / w;
                F < 0 && (F = 0, C = n.Clamp((J - I) / S, 0, 1)), m = new a, m.x = c.x + C * (h.x - c.x), m.y = c.y + C * (h.y - c.y), _ = new a, _.x = p.x + C * (y.x - p.x), _.y = p.y + C * (y.y - p.y), 0 == C || 1 == C ? (this.m_type = M.e_faceB, this.m_axis = n.CrossVF(n.SubtractVV(y, p), 1), this.m_axis.Normalize(), this.m_localPoint = _, x = this.m_axis, u = r.R, D = u.col1.x * x.x + u.col2.x * x.y, B = u.col1.y * x.x + u.col2.y * x.y, x = this.m_localPoint, u = r.R, b = r.position.x + (u.col1.x * x.x + u.col2.x * x.y), v = r.position.y + (u.col1.y * x.x + u.col2.y * x.y), x = m, u = i.R, f = i.position.x + (u.col1.x * x.x + u.col2.x * x.y), d = i.position.y + (u.col1.y * x.x + u.col2.y * x.y), (f - b) * D + (d - v) * B, C < 0 && this.m_axis.NegativeSelf()) : (this.m_type = M.e_faceA, this.m_axis = n.CrossVF(n.SubtractVV(h, c), 1), this.m_localPoint = m, x = this.m_axis, u = i.R, D = u.col1.x * x.x + u.col2.x * x.y, B = u.col1.y * x.x + u.col2.y * x.y, x = this.m_localPoint, u = i.R, f = i.position.x + (u.col1.x * x.x + u.col2.x * x.y), d = i.position.y + (u.col1.y * x.x + u.col2.y * x.y), x = _, u = r.R, b = r.position.x + (u.col1.x * x.x + u.col2.x * x.y), v = r.position.y + (u.col1.y * x.x + u.col2.y * x.y), (b - f) * D + (v - d) * B, C < 0 && this.m_axis.NegativeSelf())
            }
        }, M.prototype.Evaluate = function(t, o) {
            var i, s, r, a, l, m, c;
            switch (this.m_type) {
                case M.e_points:
                    return i = n.MulTMV(t.R, this.m_axis), s = n.MulTMV(o.R, this.m_axis.GetNegative()), r = this.m_proxyA.GetSupportVertex(i), a = this.m_proxyB.GetSupportVertex(s), l = n.MulX(t, r), m = n.MulX(o, a), (m.x - l.x) * this.m_axis.x + (m.y - l.y) * this.m_axis.y;
                case M.e_faceA:
                    return c = n.MulMV(t.R, this.m_axis), l = n.MulX(t, this.m_localPoint), s = n.MulTMV(o.R, c.GetNegative()), a = this.m_proxyB.GetSupportVertex(s), m = n.MulX(o, a), (m.x - l.x) * c.x + (m.y - l.y) * c.y;
                case M.e_faceB:
                    return c = n.MulMV(o.R, this.m_axis), m = n.MulX(o, this.m_localPoint), i = n.MulTMV(t.R, c.GetNegative()), r = this.m_proxyA.GetSupportVertex(i), l = n.MulX(t, r), (l.x - m.x) * c.x + (l.y - m.y) * c.y;
                default:
            ...
            for (var m = this.m_vertices, c = 0; c < this.m_count; c++) {
                var h = m[c];
                h.indexA = t.indexA[c], h.indexB = t.indexB[c], a = o.GetVertex(h.indexA), l = s.GetVertex(h.indexB), h.wA = n.MulX(i, a), h.wB = n.MulX(r, l), h.w = n.SubtractVV(h.wB, h.wA), h.a = 0
            }
            if (this.m_count > 1) {
                var _ = t.metric,
                    p = this.GetMetric();
            ...
            0 == this.m_count && (h = m[0], h.indexA = 0, h.indexB = 0, a = o.GetVertex(0), l = s.GetVertex(0), h.wA = n.MulX(i, a), h.wB = n.MulX(r, l), h.w = n.SubtractVV(h.wB, h.wA), this.m_count = 1)
        }, V.prototype.WriteCache = function(t) {
            t.metric = this.GetMetric(), t.count = Box2D.parseUInt(this.m_count);
            for (var o = this.m_vertices, i = 0; i < this.m_count; i++) t.indexA[i] = Box2D.parseUInt(o[i].indexA), t.indexB[i] = Box2D.parseUInt(o[i].indexB)
            ...
            switch (this.m_count) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    t.x = this.m_v1.a * this.m_v1.wA.x + this.m_v2.a * this.m_v2.wA.x, t.y = this.m_v1.a * this.m_v1.wA.y + this.m_v2.a * this.m_v2.wA.y, o.x = this.m_v1.a * this.m_v1.wB.x + this.m_v2.a * this.m_v2.wB.x, o.y = this.m_v1.a * this.m_v1.wB.y + this.m_v2.a * this.m_v2.wB.y;
                    break;
                case 3:
                    o.x = t.x = this.m_v1.a * this.m_v1.wA.x + this.m_v2.a * this.m_v2.wA.x + this.m_v3.a * this.m_v3.wA.x, o.y = t.y = this.m_v1.a * this.m_v1.wA.y + this.m_v2.a * this.m_v2.wA.y + this.m_v3.a * this.m_v3.wA.y;
                    break;
                default:
                    e.b2Assert(!1)
            }
            ...
            if (a > 0 && l > 0 && B <= 0) {
                var C = 1 / (a + l);
                return this.m_v1.a = a * C, this.m_v2.a = l * C, void(this.m_count = 2)
            }
            if (_ > 0 && p > 0 && D <= 0) {
                var A = 1 / (_ + p);
            ...
            for (J.s_cache.count = 0, J.s_distanceInput.useRadii = !1;;) {
                if (s.GetTransform(J.s_xfA, m), r.GetTransform(J.s_xfB, m), J.s_distanceInput.proxyA = o, J.s_distanceInput.proxyB = i, J.s_distanceInput.transformA = J.s_xfA, J.s_distanceInput.transformB = J.s_xfB, y.Distance(J.s_distanceOutput, J.s_cache, J.s_distanceInput), J.s_distanceOutput.distance <= 0) {
                    m = 1;
                    break
                }
                J.s_fcn.Initialize(J.s_cache, o, J.s_xfA, i, J.s_xfB);
                var _ = J.s_fcn.Evaluate(J.s_xfA, J.s_xfB);
                if (_ <= 0) {
                    m = 1;
                    break
                }
                if (0 == c && (h = _ > a ? n.Max(a - l, .75 * a) : n.Max(_ - l, .02 * a)), _ - h < .5 * l) {
                    if (0 == c) {
                        m = 1;
                        break
                    }
                ...
                if (J.b2_toiMaxRootIters = n.Max(J.b2_toiMaxRootIters, b), p < (1 + 100 * Number.MIN_VALUE) * m) break;
                if (m = p, c++, ++J.b2_toiIters, 1e3 == c) break
            }
            return J.b2_toiMaxIters = n.Max(J.b2_toiMaxIters, c), m
        }, Box2D.postDefs.push(function() {
            ...
            if (void 0 === i && (i = 0), void 0 === n && (n = 0), 0 != t.m_pointCount) {
                ...
                switch (t.m_type) {
                    case B.e_circles:
                        ...
                        break;
                    case B.e_faceA:
                        for (r = o.R, s = t.m_localPlaneNormal, l = r.col1.x * s.x + r.col2.x * s.y, m = r.col1.y * s.x + r.col2.y * s.y, r = o.R, s = t.m_localPoint, c = o.position.x + r.col1.x * s.x + r.col2.x * s.y, h = o.position.y + r.col1.y * s.x + r.col2.y * s.y, this.m_normal.x = l, this.m_normal.y = m, a = 0; a < t.m_pointCount; a++) r = e.R, s = t.m_points[a].m_localPoint, _ = e.position.x + r.col1.x * s.x + r.col2.x * s.y, p = e.position.y + r.col1.y * s.x + r.col2.y * s.y, this.m_points[a].x = _ + .5 * (i - (_ - c) * l - (p - h) * m - n) * l, this.m_points[a].y = p + .5 * (i - (_ - c) * l - (p - h) * m - n) * m;
                        break;
                    case B.e_faceB:
                        for (r = e.R, s = t.m_localPlaneNormal, l = r.col1.x * s.x + r.col2.x * s.y, m = r.col1.y * s.x + r.col2.y * s.y, r = e.R, s = t.m_localPoint, c = e.position.x + r.col1.x * s.x + r.col2.x * s.y, h = e.position.y + r.col1.y * s.x + r.col2.y * s.y, this.m_normal.x = -l, this.m_normal.y = -m, a = 0; a < t.m_pointCount; a++) r = o.R, s = t.m_points[a].m_localPoint, _ = o.position.x + r.col1.x * s.x + r.col2.x * s.y, p = o.position.y + r.col1.y * s.x + r.col2.y * s.y, this.m_points[a].x = _ + .5 * (n - (_ - c) * l - (p - h) * m - i) * l, this.m_points[a].y = p + .5 * (n - (_ - c) * l - (p - h) * m - i) * m
                }
            }
    ...
    function() {
        ...
        Box2D.inherit(o, Box2D.Collision.Shapes.b2Shape), o.prototype.__super = Box2D.Collision.Shapes.b2Shape.prototype, o.b2CircleShape = function() {
            ...
            return e = o.x - e, n = o.y - n, e * e + n * n <= this.m_radius * this.m_radius
            ...
            var y = -(h + Math.sqrt(p));
            return 0 <= y && y <= o.maxFraction * _ && (y /= _, t.fraction = y, t.normal.x = r + y * m, t.normal.y = a + y * c, t.normal.Normalize(), !0)
            ...
            void 0 === i && (i = 0), o.mass = i * t.b2_pi * this.m_radius * this.m_radius, o.center.SetV(this.m_p), o.I = o.mass * (.5 * this.m_radius * this.m_radius + (this.m_p.x * this.m_p.x + this.m_p.y * this.m_p.y))
            ...
            var e, n = o.p2.x - o.p1.x,
                s = o.p2.y - o.p1.y;
            e = i.R;
            var r = i.position.x + (e.col1.x * this.m_v1.x + e.col2.x * this.m_v1.y),
                a = i.position.y + (e.col1.y * this.m_v1.x + e.col2.y * this.m_v1.y),
                l = i.position.y + (e.col1.y * this.m_v2.x + e.col2.y * this.m_v2.y) - a,
                m = -(i.position.x + (e.col1.x * this.m_v2.x + e.col2.x * this.m_v2.y) - r),
            ...
            void 0 === o && (o = 0), t.mass = 0, t.center.SetV(this.m_v1), t.I = 0
            ...
            if (a > 0) {
                if (m > 0) return 0;
                s.x = -m / (a - m) * s.x + a / (a - m) * r.x, s.y = -m / (a - m) * s.y + a / (a - m) * r.y
            } else m > 0 && (r.x = -m / (a - m) * s.x + a / (a - m) * r.x, r.y = -m / (a - m) * s.y + a / (a - m) * r.y);
            ...
            var o = t.R;
            return new c(t.position.x + (o.col1.x * this.m_coreV1.x + o.col2.x * this.m_coreV1.y), t.position.y + (o.col1.y * this.m_coreV1.x + o.col2.y * this.m_coreV1.y))
            ...
            return n * o + s * i > r * o + a * i ? (this.s_supportVec.x = n, this.s_supportVec.y = s) : (this.s_supportVec.x = r, this.s_supportVec.y = a), this.s_supportVec
        }, e.prototype.b2EdgeShape = function(o, i) {
            this.__super.b2Shape.call(this), this.m_type = r.e_edgeShape, this.m_prevEdge = null, this.m_nextEdge = null, this.m_v1 = o, this.m_v2 = i, this.m_direction.Set(this.m_v2.x - this.m_v1.x, this.m_v2.y - this.m_v1.y), this.m_length = this.m_direction.Normalize(), this.m_normal.Set(this.m_direction.y, -this.m_direction.x), this.m_coreV1.Set(-t.b2_toiSlop * (this.m_normal.x - this.m_direction.x) + this.m_v1.x, -t.b2_toiSlop * (this.m_normal.y - this.m_direction.y) + this.m_v1.y), this.m_coreV2.Set(-t.b2_toiSlop * (this.m_normal.x + this.m_direction.x) + this.m_v2.x, -t.b2_toiSlop * (this.m_normal.y + this.m_direction.y) + this.m_v2.y), this.m_cornerDir1 = this.m_normal, this.m_cornerDir2.Set(-this.m_normal.x, -this.m_normal.y)
        }, e.prototype.SetPrevEdge = function(t, o, i, e) {
            this.m_prevEdge = t, this.m_coreV1 = o, this.m_cornerDir1 = i, this.m_cornerConvex1 = e
        }, e.prototype.SetNextEdge = function(t, o, i, e) {
            this.m_nextEdge = t, this.m_coreV2 = o, this.m_cornerDir2 = i, this.m_cornerConvex2 = e
            ...
            if (this.__super.Set.call(this, t), Box2D.is(t, s)) {
                ...
                this.m_centroid.SetV(o.m_centroid), this.m_vertexCount = o.m_vertexCount, this.Reserve(this.m_vertexCount);
                for (var i = 0; i < this.m_vertexCount; i++) this.m_vertices[i].SetV(o.m_vertices[i]), this.m_normals[i].SetV(o.m_normals[i])
            }
            ...
            void 0 === i && (i = 0), 0 == i && (i = o.length), t.b2Assert(2 <= i), this.m_vertexCount = i, this.Reserve(i);
            var e = 0;
            ...
            for (e = 0; e < this.m_vertexCount; ++e) {
                ...
                t.b2Assert(a.LengthSquared() > Number.MIN_VALUE), this.m_normals[e].SetV(l.CrossVF(a, 1)), this.m_normals[e].Normalize()
            }
            ...
            void 0 === t && (t = 0), void 0 === o && (o = 0), this.m_vertexCount = 4, this.Reserve(4), this.m_vertices[0].Set(-t, -o), this.m_vertices[1].Set(t, -o), this.m_vertices[2].Set(t, o), this.m_vertices[3].Set(-t, o), this.m_normals[0].Set(0, -1), this.m_normals[1].Set(1, 0), this.m_normals[2].Set(0, 1), this.m_normals[3].Set(-1, 0), this.m_centroid.SetZero()
        }, s.AsBox = function(t, o) {
            void 0 === t && (t = 0), void 0 === o && (o = 0);
            var i = new s;
            return i.SetAsBox(t, o), i
        }, s.prototype.SetAsOrientedBox = function(t, o, i, e) {
            void 0 === t && (t = 0), void 0 === o && (o = 0), void 0 === i && (i = null), void 0 === e && (e = 0), this.m_vertexCount = 4, this.Reserve(4), this.m_vertices[0].Set(-t, -o), this.m_vertices[1].Set(t, -o), this.m_vertices[2].Set(t, o), this.m_vertices[3].Set(-t, o), this.m_normals[0].Set(0, -1), this.m_normals[1].Set(1, 0), this.m_normals[2].Set(0, 1), this.m_normals[3].Set(-1, 0), this.m_centroid = i;
            var n = new m;
            ...
            void 0 === t && (t = 0), void 0 === o && (o = 0), void 0 === i && (i = null), void 0 === e && (e = 0);
            var n = new s;
            return n.SetAsOrientedBox(t, o, i, e), n
        }, s.prototype.SetAsEdge = function(t, o) {
            this.m_vertexCount = 2, this.Reserve(2), this.m_vertices[0].SetV(t), this.m_vertices[1].SetV(o), this.m_centroid.x = .5 * (t.x + o.x), this.m_centroid.y = .5 * (t.y + o.y), this.m_normals[0] = l.CrossVF(l.SubtractVV(o, t), 1), this.m_normals[0].Normalize(), this.m_normals[1].x = -this.m_normals[0].x, this.m_normals[1].y = -this.m_normals[0].y
        }, s.AsEdge = function(t, o) {
            var i = new s;
            return i.SetAsEdge(t, o), i
        }, s.prototype.TestPoint = function(t, o) {
            for (var i, e = t.R, n = o.x - t.position.x, s = o.y - t.position.y, r = n * e.col1.x + s * e.col1.y, a = n * e.col2.x + s * e.col2.y, l = 0; l < this.m_vertexCount; ++l) {
                i = this.m_vertices[l], n = r - i.x, s = a - i.y, i = this.m_normals[l];
                if (i.x * n + i.y * s > 0) return !1
            }
            return !0
            ...
            for (var h = a * e.col1.x + l * e.col1.y, _ = a * e.col2.x + l * e.col2.y, p = h - m, y = _ - c, u = parseInt(-1), x = 0; x < this.m_vertexCount; ++x) {
                n = this.m_vertices[x],
                    a = n.x - m, l = n.y - c, n = this.m_normals[x];
                var f = n.x * a + n.y * l,
                    d = n.x * p + n.y * y;
                if (0 == d) {
                    if (f < 0) return !1
            ...
            return u >= 0 && (t.fraction = s, e = i.R, n = this.m_normals[u], t.normal.x = e.col1.x * n.x + e.col2.x * n.y, t.normal.y = e.col1.y * n.x + e.col2.y * n.y, !0)
        }, s.prototype.ComputeAABB = function(t, o) {
            for (var i = o.R, e = this.m_vertices[0], n = o.position.x + (i.col1.x * e.x + i.col2.x * e.y), s = o.position.y + (i.col1.y * e.x + i.col2.y * e.y), r = n, a = s, l = 1; l < this.m_vertexCount; ++l) {
                e = this.m_vertices[l];
                var m = o.position.x + (i.col1.x * e.x + i.col2.x * e.y),
                    c = o.position.y + (i.col1.y * e.x + i.col2.y * e.y);
                n = n < m ? n : m, s = s < c ? s : c, r = r > m ? r : m, a = a > c ? a : c
            }
            ...
            if (void 0 === o && (o = 0), 2 == this.m_vertexCount) return t.center.x = .5 * (this.m_vertices[0].x + this.m_vertices[1].x), t.center.y = .5 * (this.m_vertices[0].y + this.m_vertices[1].y), t.mass = 0, void(t.I = 0);
            for (var i = 0, e = 0, n = 0, s = 0, r = 0; r < this.m_vertexCount; ++r) {
                var a = this.m_vertices[r],
                    l = r + 1 < this.m_vertexCount ? this.m_vertices[parseInt(r + 1)] : this.m_vertices[0],
                    m = a.x - 0,
                    c = a.y - 0,
                    h = l.x - 0,
                    _ = l.y - 0,
                    p = m * _ - c * h,
                    y = .5 * p;
                n += y, i += y * (1 / 3) * (0 + a.x + l.x), e += y * (1 / 3) * (0 + a.y + l.y);
                var u = m,
                    x = c,
                    f = h,
                    d = _;
            ...
            t.mass = o * n, i *= 1 / n, e *= 1 / n, t.center.Set(i, e), t.I = o * s
            ...
            for (y = 0; y < this.m_vertexCount; ++y) {
                ...
                y > 0 && (u ? p || (h = y - 1, m++) : p && (_ = y - 1, m++)), p = u
            }
            switch (m) {
                case 0:
                    if (p) {
                        var x = new n;
                        return this.ComputeMass(x, 1), e.SetV(l.MulX(i, x.center)), x.mass
                    }
                    return 0;
                case 1:
            ...
            return g.Multiply(1 / A), e.SetV(l.MulX(i, g)), A
            ...
            for (var o = 0, i = this.m_vertices[0].x * t.x + this.m_vertices[0].y * t.y, e = 1; e < this.m_vertexCount; ++e) {
                var n = this.m_vertices[e].x * t.x + this.m_vertices[e].y * t.y;
                n > i && (o = e, i = n)
            }
            return o
            ...
            void 0 === t && (t = 0);
            for (var o = parseInt(this.m_vertices.length); o < t; o++) this.m_vertices[o] = new c, this.m_normals[o] = new c
        }, s.prototype.ComputeCentroid = function(t, o) {
            void 0 === o && (o = 0);
            for (var i = new c, e = 0, n = 0; n < o; ++n) {
                var s = t[n],
                    r = n + 1 < o ? t[parseInt(n + 1)] : t[0],
                    a = s.x - 0,
                    l = s.y - 0,
                    m = r.x - 0,
                    h = r.y - 0,
                    _ = a * h - l * m,
                    p = .5 * _;
                e += p, i.x += p * (1 / 3) * (0 + s.x + r.x), i.y += p * (1 / 3) * (0 + s.y + r.y)
            }
            ...
            for (e = 1; e <= i; ++e) {
                var r = n[parseInt(e - 1)],
                    ...
                    m = Math.sqrt(a * a + l * l);
                a /= m, l /= m;
                for (var c = -l, h = a, _ = Number.MAX_VALUE, p = Number.MAX_VALUE, y = -Number.MAX_VALUE, u = -Number.MAX_VALUE, x = 0; x < i; ++x) {
                    var f = n[x].x - r.x,
                        d = n[x].y - r.y,
                        b = a * f + l * d,
                        v = c * f + h * d;
                ...
                var D = (y - _) * (u - p);
                if (D < .95 * s) {
                    s = D, t.R.col1.x = a, t.R.col1.y = l, t.R.col2.x = c, t.R.col2.y = h;
                    var B = .5 * (_ + y),
                        C = .5 * (p + u),
                        A = t.R;
            ...
            return !1
        }, r.prototype.ComputeAABB = function(t, o) {}, r.prototype.ComputeMass = function(t, o) {
            void 0 === o && (o = 0)
        }, r.prototype.ComputeSubmergedArea = function(t, o, i, e) {
            return void 0 === o && (o = 0), 0
        }, r.TestOverlap = function(t, o, i, e) {
            var n = new _;
            n.proxyA = new y, n.proxyA.Set(t), n.proxyB = new y, n.proxyB.Set(i), n.transformA = o, n.transformB = e, n.useRadii = !0;
            var s = new u;
            s.count = 0;
            var r = new p;
    ...
    function() {
        ...
        t.b2Color = function() {
            ...
            void 0 === t && (t = 0), void 0 === o && (o = 0), void 0 === e && (e = 0), this._r = Box2D.parseUInt(255 * i.Clamp(t, 0, 1)), this._g = Box2D.parseUInt(255 * i.Clamp(o, 0, 1)), this._b = Box2D.parseUInt(255 * i.Clamp(e, 0, 1))
    ...
    function() {
        ...
        t.b2Mat22 = function() {
            ...
            var o = Math.cos(t),
                i = Math.sin(t);
            this.col1.x = o, this.col2.x = -i, this.col1.y = i, this.col2.y = o
            ...
            var o = this.col1.x,
                ...
                n = this.col2.y,
                s = o * n - i * e;
            return 0 != s && (s = 1 / s), t.col1.x = s * n, t.col2.x = -s * i, t.col1.y = -s * e, t.col2.y = s * o, t
            ...
            var e = this.col1.x,
                ...
                r = this.col2.y,
                a = e * r - n * s;
            return 0 != a && (a = 1 / a), t.x = a * (r * o - n * i), t.y = a * (e * i - s * o), t
        }, t.prototype.Abs = function() {
            this.col1.Abs(), this.col2.Abs()
        }, o.b2Mat33 = function() {
            this.col1 = new r, this.col2 = new r, this.col3 = new r
        }, o.prototype.b2Mat33 = function(t, o, i) {
            void 0 === t && (t = null), void 0 === o && (o = null), void 0 === i && (i = null), t || o || i ? (this.col1.SetV(t), this.col2.SetV(o), this.col3.SetV(i)) : (this.col1.SetZero(), this.col2.SetZero(), this.col3.SetZero())
            ...
            void 0 === o && (o = 0), void 0 === i && (i = 0), void 0 === e && (e = 0);
            var n = this.col1.x,
                s = this.col1.y,
                r = this.col1.z,
                a = this.col2.x,
            ...
            return 0 != p && (p = 1 / p), t.x = p * (o * (l * _ - m * h) + i * (m * c - a * _) + e * (a * h - l * c)), t.y = p * (n * (i * _ - e * h) + s * (e * c - o * _) + r * (o * h - i * c)), t.z = p * (n * (l * e - m * i) + s * (m * o - a * e) + r * (a * i - l * o)), t
            ...
            return void 0 === o && (o = 0), new s(o * t.y, -o * t.x)
        }, i.CrossFV = function(t, o) {
            return void 0 === t && (t = 0), new s(-t * o.y, t * o.x)
        }, i.MulMV = function(t, o) {
            return new s(t.col1.x * o.x + t.col2.x * o.y, t.col1.y * o.x + t.col2.y * o.y)
        }, i.MulTMV = function(t, o) {
            return new s(i.Dot(o, t.col1), i.Dot(o, t.col2))
        }, i.MulX = function(t, o) {
            var e = i.MulMV(t.R, o);
            ...
            return void 0 === t && (t = 0), new s(t * o.x, t * o.y)
        }, i.AddMM = function(o, e) {
            return t.FromVV(i.AddVV(o.col1, e.col1), i.AddVV(o.col2, e.col2))
        }, i.MulMM = function(o, e) {
            return t.FromVV(i.MulMV(o, e.col1), i.MulMV(o, e.col2))
            ...
            return t.FromVV(i.AbsV(o.col1), i.AbsV(o.col2))
        }, i.Min = function(t, o) {
            return void 0 === t && (t = 0), void 0 === o && (o = 0), t < o ? t : o
        }, i.MinV = function(t, o) {
            return new s(i.Min(t.x, o.x), i.Min(t.y, o.y))
        }, i.Max = function(t, o) {
            return void 0 === t && (t = 0), void 0 === o && (o = 0), t > o ? t : o
        }, i.MaxV = function(t, o) {
            return new s(i.Max(t.x, o.x), i.Max(t.y, o.y))
        }, i.Clamp = function(t, o, i) {
            return void 0 === t && (t = 0), void 0 === o && (o = 0), void 0 === i && (i = 0), t < o ? o : t > i ? i : t
            ...
            void 0 === o && (o = 0), t.position.x = (1 - o) * this.c0.x + o * this.c.x, t.position.y = (1 - o) * this.c0.y + o * this.c.y;
            ...
            if (void 0 === t && (t = 0), this.t0 < t && 1 - this.t0 > Number.MIN_VALUE) {
                ...
                this.c0.x = (1 - o) * this.c0.x + o * this.c.x, this.c0.y = (1 - o) * this.c0.y + o * this.c.y, this.a0 = (1 - o) * this.a0 + o * this.a, this.t0 = t
            }
        }, n.b2Transform = function() {
            this.position = new s, this.R = new t
        }, n.prototype.b2Transform = function(t, o) {
            void 0 === t && (t = null), void 0 === o && (o = null), t && (this.position.SetV(t), this.R.SetM(o))
        ...
        }, s.b2Vec2 = function() {}, s.prototype.b2Vec2 = function(t, o) {
            void 0 === t && (t = 0), void 0 === o && (o = 0), this.x = t, this.y = o
            ...
            var o = this.x;
            this.x = t.col1.x * o + t.col2.x * this.y, this.y = t.col1.y * o + t.col2.y * this.y
        ...
        }, r.b2Vec3 = function() {}, r.prototype.b2Vec3 = function(t, o, i) {
            void 0 === t && (t = 0), void 0 === o && (o = 0), void 0 === i && (i = 0), this.x = t, this.y = o, this.z = i
    ...
    function() {
        var t = (Box2D.Dynamics.Controllers.b2ControllerEdge, Box2D.Common.Math.b2Mat22, Box2D.Common.Math.b2Mat33, Box2D.Common.Math.b2Math),
            ...
            m = (Box2D.Collision.b2DynamicTreeNode, Box2D.Collision.b2DynamicTreePair, Box2D.Collision.b2Manifold, Box2D.Collision.b2ManifoldPoint, Box2D.Collision.b2Point, Box2D.Collision.b2RayCastInput),
        ...
        x.b2Body = function() {
            this.m_xf = new i, this.m_sweep = new o, this.m_linearVelocity = new e, this.m_force = new e
            ...
            return o.m_next = this.m_fixtureList, this.m_fixtureList = o, ++this.m_fixtureCount, o.m_body = this, o.m_density > 0 && this.ResetMassData(), this.m_world.m_flags |= V.e_newFixture, o
            ...
            if (1 != this.m_world.IsLocked()) {
                for (var o = this.m_fixtureList, i = null; null != o;) {
                    if (o == t) {
            ...
            if (1 != this.m_world.IsLocked()) {
                ...
                this.m_sweep.c.x = e.col1.x * n.x + e.col2.x * n.y, this.m_sweep.c.y = e.col1.y * n.x + e.col2.y * n.y, this.m_sweep.c.x += this.m_xf.position.x, this.m_sweep.c.y += this.m_xf.position.y, this.m_sweep.c0.SetV(this.m_sweep.c), this.m_sweep.a0 = this.m_sweep.a = o;
            ...
            this.m_type == x.b2_dynamicBody && (0 == this.IsAwake() && this.SetAwake(!0), this.m_force.x += t.x, this.m_force.y += t.y, this.m_torque += (o.x - this.m_sweep.c.x) * t.y - (o.y - this.m_sweep.c.y) * t.x)
            ...
            this.m_type == x.b2_dynamicBody && (0 == this.IsAwake() && this.SetAwake(!0), this.m_linearVelocity.x += this.m_invMass * t.x, this.m_linearVelocity.y += this.m_invMass * t.y, this.m_angularVelocity += this.m_invI * ((o.x - this.m_sweep.c.x) * t.y - (o.y - this.m_sweep.c.y) * t.x))
        }, x.prototype.Split = function(o) {
            for (var i, e = this.GetLinearVelocity().Copy(), n = this.GetAngularVelocity(), s = this.GetWorldCenter(), r = this, a = this.m_world.CreateBody(this.GetDefinition()), l = r.m_fixtureList; l;)
                if (o(l)) {
                    var m = l.m_next;
                    i ? i.m_next = m : r.m_fixtureList = m, r.m_fixtureCount--, l.m_next = a.m_fixtureList, a.m_fixtureList = l, a.m_fixtureCount++, l.m_body = a, l = m
                } else i = l, l = l.m_next;
            ...
            for (o = t.m_fixtureList; o;) {
                var i = o.m_next;
                t.m_fixtureCount--, o.m_next = this.m_fixtureList, this.m_fixtureList = o, this.m_fixtureCount++, o.m_body = n, o = i
            }
            e.m_fixtureCount = 0;
            var e = this,
                n = t;
            ...
            if (s.b2Assert(0 == this.m_world.IsLocked()), 1 != this.m_world.IsLocked() && this.m_type == x.b2_dynamicBody) {
                this.m_invMass = 0, this.m_I = 0, this.m_invI = 0, this.m_mass = o.mass, this.m_mass <= 0 && (this.m_mass = 1), this.m_invMass = 1 / this.m_mass, o.I > 0 && 0 == (this.m_flags & x.e_fixedRotationFlag) && (this.m_I = o.I - this.m_mass * (o.center.x * o.center.x + o.center.y * o.center.y), this.m_invI = 1 / this.m_I);
                var i = this.m_sweep.c.Copy();
                this.m_sweep.localCenter.SetV(o.center), this.m_sweep.c0.SetV(t.MulX(this.m_xf, this.m_sweep.localCenter)), this.m_sweep.c.SetV(this.m_sweep.c0), this.m_linearVelocity.x += this.m_angularVelocity * -(this.m_sweep.c.y - i.y), this.m_linearVelocity.y += this.m_angularVelocity * +(this.m_sweep.c.x - i.x)
            }
            ...
            if (this.m_mass = 0, this.m_invMass = 0, this.m_I = 0, this.m_invI = 0, this.m_sweep.localCenter.SetZero(), this.m_type != x.b2_staticBody && this.m_type != x.b2_kinematicBody) {
                for (var o = e.Make(0, 0), i = this.m_fixtureList; i; i = i.m_next)
                    if (0 != i.m_density) {
                        var n = i.GetMassData();
                        this.m_mass += n.mass, o.x += n.center.x * n.mass, o.y += n.center.y * n.mass, this.m_I += n.I
                    }
                this.m_mass > 0 ? (this.m_invMass = 1 / this.m_mass, o.x *= this.m_invMass, o.y *= this.m_invMass) : (this.m_mass = 1, this.m_invMass = 1), this.m_I > 0 && 0 == (this.m_flags & x.e_fixedRotationFlag) ? (this.m_I -= this.m_mass * (o.x * o.x + o.y * o.y), this.m_I *= this.m_inertiaScale, s.b2Assert(this.m_I > 0), this.m_invI = 1 / this.m_I) : (this.m_I = 0, this.m_invI = 0);
                var r = this.m_sweep.c.Copy();
                this.m_sweep.localCenter.SetV(o), this.m_sweep.c0.SetV(t.MulX(this.m_xf, this.m_sweep.localCenter)), this.m_sweep.c.SetV(this.m_sweep.c0), this.m_linearVelocity.x += this.m_angularVelocity * -(this.m_sweep.c.y - r.y), this.m_linearVelocity.y += this.m_angularVelocity * +(this.m_sweep.c.x - r.x)
            }
        }, x.prototype.GetWorldPoint = function(t) {
            var o = this.m_xf.R,
                i = new e(o.col1.x * t.x + o.col2.x * t.y, o.col1.y * t.x + o.col2.y * t.y);
            ...
            var o = this.m_xf.R,
                i = new e(o.col1.x * t.x + o.col2.x * t.y, o.col1.y * t.x + o.col2.y * t.y);
            return i.x += this.m_xf.position.x, i.y += this.m_xf.position.y, new e(this.m_linearVelocity.x - this.m_angularVelocity * (i.y - this.m_sweep.c.y), this.m_linearVelocity.y + this.m_angularVelocity * (i.x - this.m_sweep.c.x))
            ...
            if (void 0 === t && (t = 0), this.m_type != t) {
                ...
                for (var o = this.m_contactList; o; o = o.next) o.contact.FlagForFiltering()
            }
            ...
            if (t != this.IsActive()) {
                var o, i;
                if (t)
                    for (this.m_flags |= x.e_activeFlag, o = this.m_world.m_contactManager.m_broadPhase, i = this.m_fixtureList; i; i = i.m_next) i.CreateProxy(o, this.m_xf);
                else {
                    for (this.m_flags &= ~x.e_activeFlag, o = this.m_world.m_contactManager.m_broadPhase, i = this.m_fixtureList; i; i = i.m_next) i.DestroyProxy(o);
                    for (var e = this.m_contactList; e;) {
                        var n = e;
            ...
            this.m_flags = 0, t.bullet && (this.m_flags |= x.e_bulletFlag), t.fixedRotation && (this.m_flags |= x.e_fixedRotationFlag), t.allowSleep && (this.m_flags |= x.e_allowSleepFlag), t.awake && (this.m_flags |= x.e_awakeFlag), t.active && (this.m_flags |= x.e_activeFlag), this.m_world = o, this.m_xf.position.SetV(t.position), this.m_xf.R.Set(t.angle), this.m_sweep.localCenter.SetZero(), this.m_sweep.t0 = 1, this.m_sweep.a0 = this.m_sweep.a = t.angle;
            var i = this.m_xf.R,
                e = this.m_sweep.localCenter;
            this.m_sweep.c.x = i.col1.x * e.x + i.col2.x * e.y, this.m_sweep.c.y = i.col1.y * e.x + i.col2.y * e.y, this.m_sweep.c.x += this.m_xf.position.x, this.m_sweep.c.y += this.m_xf.position.y, this.m_sweep.c0.SetV(this.m_sweep.c), this.m_jointList = null, this.m_controllerList = null, this.m_contactList = null, this.m_controllerCount = 0, this.m_prev = null, this.m_next = null, this.m_linearVelocity.SetV(t.linearVelocity), this.m_angularVelocity = t.angularVelocity, this.m_linearDamping = t.linearDamping, this.m_angularDamping = t.angularDamping, this.m_force.Set(0, 0), this.m_torque = 0, this.m_sleepTime = 0, this.m_type = t.type, this.m_type == x.b2_dynamicBody ? (this.m_mass = 1, this.m_invMass = 1) : (this.m_mass = 0, this.m_invMass = 0), this.m_I = 0, this.m_invI = 0, this.m_inertiaScale = t.inertiaScale, this.m_userData = t.userData, this.m_fixtureList = null, this.m_fixtureCount = 0
        }, x.prototype.SynchronizeFixtures = function() {
            var t = x.s_xf1;
            t.R.Set(this.m_sweep.a0);
            var o = t.R,
                i = this.m_sweep.localCenter;
            t.position.x = this.m_sweep.c0.x - (o.col1.x * i.x + o.col2.x * i.y), t.position.y = this.m_sweep.c0.y - (o.col1.y * i.x + o.col2.y * i.y);
            ...
            this.m_xf.position.x = this.m_sweep.c.x - (t.col1.x * o.x + t.col2.x * o.y), this.m_xf.position.y = this.m_sweep.c.y - (t.col1.y * o.x + t.col2.y * o.y)
            ...
            this.userData = null, this.position.Set(0, 0), this.angle = 0, this.linearVelocity.Set(0, 0), this.angularVelocity = 0, this.linearDamping = 0, this.angularDamping = 0, this.allowSleep = !0, this.awake = !0, this.fixedRotation = !1, this.bullet = !1, this.type = x.b2_staticBody, this.active = !0, this.inertiaScale = 1
        }, d.b2ContactFilter = function() {}, d.prototype.ShouldCollide = function(t, o) {
            var i = t.GetFilterData(),
                e = o.GetFilterData();
            return i.groupIndex == e.groupIndex && 0 != i.groupIndex ? i.groupIndex > 0 : 0 != (i.maskBits & e.categoryBits) && 0 != (i.categoryBits & e.maskBits)
        }, d.prototype.RayCollide = function(t, o) {
            return !t || this.ShouldCollide(t instanceof g ? t : null, o)
        }, Box2D.postDefs.push(function() {
        ...
        }, v.b2ContactListener = function(t) {
            this.that = t
        }, v.prototype.BeginContact = function(t) {}, v.prototype.EndContact = function(t) {}, v.prototype.PreSolve = function(t, o) {}, v.prototype.PostSolve = function(t, o) {}, Box2D.postDefs.push(function() {
            ...
            this.m_world = null, this.m_contactCount = 0, this.m_contactFilter = d.b2_defaultFilter, this.m_contactListener = v.b2_defaultListener, this.m_contactFactory = new G(this.m_allocator), this.m_broadPhase = new l
        }, D.prototype.AddPair = function(t, o) {
            var i = t instanceof g ? t : null,
                e = o instanceof g ? o : null,
                n = i.GetBody(),
                s = e.GetBody();
            if (n != s) {
                ...
                if (0 != s.ShouldCollide(n) && 0 != this.m_contactFilter.ShouldCollide(i, e)) {
                    var m = this.m_contactFactory.Create(i, e);
                    i = m.GetFixtureA(), e = m.GetFixtureB(), n = i.m_body, s = e.m_body, m.m_prev = null, m.m_next = this.m_world.m_contactList, null != this.m_world.m_contactList && (this.m_world.m_contactList.m_prev = m), this.m_world.m_contactList = m, m.m_nodeA.contact = m, m.m_nodeA.other = s, m.m_nodeA.prev = null, m.m_nodeA.next = n.m_contactList, null != n.m_contactList && (n.m_contactList.prev = m.m_nodeA), n.m_contactList = m.m_nodeA, m.m_nodeB.contact = m, m.m_nodeB.other = n, m.m_nodeB.prev = null, m.m_nodeB.next = s.m_contactList, null != s.m_contactList && (s.m_contactList.prev = m.m_nodeB), s.m_contactList = m.m_nodeB, ++this.m_world.m_contactCount
                }
            }
        ...
        }), B.b2DebugDraw = function() {}, B.prototype.b2DebugDraw = function() {}, B.prototype.SetFlags = function(t) {
            void 0 === t && (t = 0)
        }, B.prototype.GetFlags = function() {}, B.prototype.AppendFlags = function(t) {
            void 0 === t && (t = 0)
        }, B.prototype.ClearFlags = function(t) {
            void 0 === t && (t = 0)
        }, B.prototype.SetSprite = function(t) {}, B.prototype.GetSprite = function() {}, B.prototype.SetDrawScale = function(t) {
            void 0 === t && (t = 0)
        }, B.prototype.GetDrawScale = function() {}, B.prototype.SetLineThickness = function(t) {
            void 0 === t && (t = 0)
        }, B.prototype.GetLineThickness = function() {}, B.prototype.SetAlpha = function(t) {
            void 0 === t && (t = 0)
        }, B.prototype.GetAlpha = function() {}, B.prototype.SetFillAlpha = function(t) {
            void 0 === t && (t = 0)
        }, B.prototype.GetFillAlpha = function() {}, B.prototype.SetXFormScale = function(t) {
            void 0 === t && (t = 0)
        }, B.prototype.GetXFormScale = function() {}, B.prototype.DrawPolygon = function(t, o, i) {
            void 0 === o && (o = 0)
            ...
            void 0 === o && (o = 0)
        }, B.prototype.DrawSegment = function(t, o, i) {}, B.prototype.DrawTransform = function(t) {}, Box2D.postDefs.push(function() {
            ...
            if (this.m_isSensor != t && (this.m_isSensor = t, null != this.m_body))
                for (var o = this.m_body.GetContactList(); o;) {
                    var i = o.contact,
                        e = i.GetFixtureA(),
                        n = i.GetFixtureB();
                    e != this && n != this || i.SetSensor(e.IsSensor() || n.IsSensor()), o = o.next
                }
        ...
        }, g.prototype.RayCast = function(t, o) {
        ...
        }, g.prototype.Create = function(t, o, i) {
            this.m_userData = i.userData, this.m_friction = i.friction, this.m_restitution = i.restitution, this.m_body = t, this.m_body.id = i.id, this.m_next = null, this.m_filter = i.filter.Copy(), this.m_isSensor = i.isSensor, this.m_shape = i.shape.Copy(), this.m_density = i.density
        }, g.prototype.Destroy = function() {
            this.m_shape = null
        }, g.prototype.CreateProxy = function(t, o) {
            this.m_shape.ComputeAABB(this.m_aabb, o), this.m_proxy = t.CreateProxy(this.m_aabb, this)
        }, g.prototype.DestroyProxy = function(t) {
            null != this.m_proxy && (t.DestroyProxy(this.m_proxy), this.m_proxy = null)
        }, g.prototype.Synchronize = function(o, i, e) {
            if (this.m_proxy) {
                var n = new r,
                    s = new r;
                this.m_shape.ComputeAABB(n, i), this.m_shape.ComputeAABB(s, e), this.m_aabb.Combine(n, s);
        ...
        }, w.prototype.Initialize = function(t, o, i, e, n, s) {
            void 0 === t && (t = 0), void 0 === o && (o = 0), void 0 === i && (i = 0);
            var r = 0;
            for (this.m_bodyCapacity = t, this.m_contactCapacity = o, this.m_jointCapacity = i, this.m_bodyCount = 0, this.m_contactCount = 0, this.m_jointCount = 0, this.m_allocator = e, this.m_listener = n, this.m_contactSolver = s, r = this.m_bodies.length; r < t; r++) this.m_bodies[r] = null;
        ...
        }, w.prototype.Solve = function(o, i, e) {
            var n, r, a = 0,
                l = 0;
            for (a = 0; a < this.m_bodyCount; ++a) n = this.m_bodies[a], n.GetType() == x.b2_dynamicBody && (n.m_linearVelocity.x += o.dt * (i.x + n.m_invMass * n.m_force.x), n.m_linearVelocity.y += o.dt * (i.y + n.m_invMass * n.m_force.y), n.m_angularVelocity += o.dt * n.m_invI * n.m_torque, n.m_linearVelocity.Multiply(t.Clamp(1 - o.dt * n.m_linearDamping, 0, 1)), n.m_angularVelocity *= t.Clamp(1 - o.dt * n.m_angularDamping, 0, 1));
            this.m_contactSolver.Initialize(o, this.m_contacts, this.m_contactCount, this.m_allocator);
            var m = this.m_contactSolver;
            for (m.InitVelocityConstraints(o), a = 0; a < this.m_jointCount; ++a) r = this.m_joints[a], r.InitVelocityConstraints(o);
            for (a = 0; a < o.velocityIterations; ++a) {
                for (l = 0; l < this.m_jointCount; ++l) r = this.m_joints[l], r.SolveVelocityConstraints(o);
                m.SolveVelocityConstraints()
            }
            for (a = 0; a < this.m_jointCount; ++a) r = this.m_joints[a], r.FinalizeVelocityConstraints();
            for (m.FinalizeVelocityConstraints(), a = 0; a < this.m_bodyCount; ++a)
                if (n = this.m_bodies[a], n.GetType() != x.b2_staticBody) {
                    var c = o.dt * n.m_linearVelocity.x,
                        h = o.dt * n.m_linearVelocity.y;
                    c * c + h * h > s.b2_maxTranslationSquared && (n.m_linearVelocity.Normalize(), n.m_linearVelocity.x *= s.b2_maxTranslation * o.inv_dt, n.m_linearVelocity.y *= s.b2_maxTranslation * o.inv_dt);
                    var _ = o.dt * n.m_angularVelocity;
                    _ * _ > s.b2_maxRotationSquared && (n.m_angularVelocity < 0 ? n.m_angularVelocity = -s.b2_maxRotation * o.inv_dt : n.m_angularVelocity = s.b2_maxRotation * o.inv_dt), n.m_sweep.c0.SetV(n.m_sweep.c), n.m_sweep.a0 = n.m_sweep.a, n.m_sweep.c.x += o.dt * n.m_linearVelocity.x, n.m_sweep.c.y += o.dt * n.m_linearVelocity.y, n.m_sweep.a += o.dt * n.m_angularVelocity, n.SynchronizeTransform()
                }
            ...
            if (this.Report(m.m_constraints), e) {
                var f = Number.MAX_VALUE,
                    d = s.b2_linearSleepTolerance * s.b2_linearSleepTolerance,
                    b = s.b2_angularSleepTolerance * s.b2_angularSleepTolerance;
                for (a = 0; a < this.m_bodyCount; ++a) n = this.m_bodies[a], n.GetType() != x.b2_staticBody && (0 == (n.m_flags & x.e_allowSleepFlag) && (n.m_sleepTime = 0, f = 0), 0 == (n.m_flags & x.e_allowSleepFlag) || n.m_angularVelocity * n.m_angularVelocity > b || t.Dot(n.m_linearVelocity, n.m_linearVelocity) > d ? (n.m_sleepTime = 0, f = 0) : (n.m_sleepTime += o.dt, f = t.Min(f, n.m_sleepTime)));
            ...
            for (o = 0; o < this.m_jointCount; ++o) this.m_joints[o].InitVelocityConstraints(t);
            for (o = 0; o < t.velocityIterations; ++o)
                for (e.SolveVelocityConstraints(), i = 0; i < this.m_jointCount; ++i) this.m_joints[i].SolveVelocityConstraints(t);
            ...
            for (o = 0; o < t.positionIterations; ++o) {
                var m = e.SolvePositionConstraints(.75),
                    c = !0;
                for (i = 0; i < this.m_jointCount; ++i) {
                    var h = this.m_joints[i].SolvePositionConstraints(s.b2_contactBaumgarte);
                    c = c && h
                }
                if (m && c) break
            }
            ...
            if (null != this.m_listener)
                for (var o = 0; o < this.m_contactCount; ++o) {
                    for (var i = this.m_contacts[o], e = t[o], n = 0; n < e.pointCount; ++n) w.s_impulse.normalImpulses[n] = e.points[n].normalImpulse, w.s_impulse.tangentImpulses[n] = e.points[n].tangentImpulse;
                    this.m_listener.PostSolve(i, w.s_impulse)
                }
            ...
            for (var i = this.m_bodyList; i; i = i.m_next)
                for (var e = i.m_fixtureList; e; e = e.m_next) e.m_proxy = t.CreateProxy(o.GetFatAABB(e.m_proxy), e)
            ...
            var o = new x(t, this);
            return o.m_prev = null, o.m_next = this.m_bodyList, this.m_bodyList && (this.m_bodyList.m_prev = o), this.m_bodyList = o, ++this.m_bodyCount, o
        }, V.prototype.DestroyBody = function(t) {
            if (1 != this.IsLocked()) {
                for (var o = t.m_jointList; o;) {
                    var i = o;
                    o = o.next, this.m_destructionListener && this.m_destructionListener.SayGoodbyeJoint(i.joint), this.DestroyJoint(i.joint)
                }
            ...
            var o = L.Create(t, null);
            o.m_prev = null, o.m_next = this.m_jointList, this.m_jointList && (this.m_jointList.m_prev = o), this.m_jointList = o, ++this.m_jointCount, o.m_edgeA.joint = o, o.m_edgeA.other = o.m_bodyB, o.m_edgeA.prev = null, o.m_edgeA.next = o.m_bodyA.m_jointList, o.m_bodyA.m_jointList && (o.m_bodyA.m_jointList.prev = o.m_edgeA), o.m_bodyA.m_jointList = o.m_edgeA, o.m_edgeB.joint = o, o.m_edgeB.other = o.m_bodyA, o.m_edgeB.prev = null, o.m_edgeB.next = o.m_bodyB.m_jointList, o.m_bodyB.m_jointList && (o.m_bodyB.m_jointList.prev = o.m_edgeB), o.m_bodyB.m_jointList = o.m_edgeB;
            var i = t.bodyA,
                e = t.bodyB;
            if (0 == t.collideConnected)
                for (var n = e.GetContactList(); n;) n.other == i && n.contact.FlagForFiltering(), n = n.next;
            return o
            ...
            var i = t.m_bodyA,
                e = t.m_bodyB;
            if (i.SetAwake(!0), e.SetAwake(!0), t.m_edgeA.prev && (t.m_edgeA.prev.next = t.m_edgeA.next), t.m_edgeA.next && (t.m_edgeA.next.prev = t.m_edgeA.prev), t.m_edgeA == i.m_jointList && (i.m_jointList = t.m_edgeA.next), t.m_edgeA.prev = null, t.m_edgeA.next = null, t.m_edgeB.prev && (t.m_edgeB.prev.next = t.m_edgeB.next), t.m_edgeB.next && (t.m_edgeB.next.prev = t.m_edgeB.prev), t.m_edgeB == e.m_jointList && (e.m_jointList = t.m_edgeB.next), t.m_edgeB.prev = null, t.m_edgeB.next = null, L.Destroy(t, null), --this.m_jointCount, 0 == o)
                for (var n = e.GetContactList(); n;) n.other == i && n.contact.FlagForFiltering(), n = n.next
            ...
            void 0 === t && (t = 0), void 0 === o && (o = 0), void 0 === i && (i = 0), this.m_flags & V.e_newFixture && (this.m_contactManager.FindNewContacts(), this.m_flags &= ~V.e_newFixture), this.m_flags |= V.e_locked;
            var e = V.s_timestep2;
            e.dt = t, e.velocityIterations = o, e.positionIterations = i, e.inv_dt = t > 0 ? 1 / t : 0, e.dtRatio = this.m_inv_dt0 * t, e.warmStarting = V.m_warmStarting, this.m_contactManager.Collide(), e.dt > 0 && this.Solve(e), V.m_continuousPhysics && e.dt > 0 && this.SolveTOI(e), e.dt > 0 && (this.m_inv_dt0 = e.inv_dt), this.m_flags &= ~V.e_locked
            ...
            if (null != this.m_debugDraw) {
                ...
                var t, o, i, s, a, l, m = this.m_debugDraw.GetFlags(),
                    c = (new e, new e, new e, new r, new r, [new e, new e, new e, new e]),
                    h = new n(0, 0, 0);
                if (m & B.e_shapeBit)
                    for (t = this.m_bodyList; t; t = t.m_next)
                        for (l = t.m_xf, o = t.GetFixtureList(); o; o = o.m_next) i = o.GetShape(), 0 == t.IsActive() ? (h.Set(.5, .5, .3), this.DrawShape(i, l, h)) : t.GetType() == x.b2_staticBody ? (h.Set(.5, .9, .5), this.DrawShape(i, l, h)) : t.GetType() == x.b2_kinematicBody ? (h.Set(.5, .5, .9), this.DrawShape(i, l, h)) : 0 == t.IsAwake() ? (h.Set(.6, .6, .6), this.DrawShape(i, l, h)) : (h.Set(.9, .7, .7), this.DrawShape(i, l, h));
                if (m & B.e_jointBit)
                ...
                if (m & B.e_centerOfMassBit)
                    for (t = this.m_bodyList; t; t = t.m_next) l = V.s_xf, l.R = t.m_xf.R, l.position = t.GetWorldCenter(), this.m_debugDraw.DrawTransform(l)
            }
            ...
            function n(i) {
                var n = a.GetUserData(i) instanceof g ? a.GetUserData(i) : null;
                return !u.TestOverlap(o, e, n.GetShape(), n.GetBody().GetTransform()) || t(n)
            }
            var s = this;
            void 0 === e && (e = null), null == e && (e = new i, e.SetIdentity());
            var a = s.m_contactManager.m_broadPhase,
                l = new r;
            o.ComputeAABB(l, e), a.Query(n, l)
        }, V.prototype.QueryPoint = function(t, o) {
            function i(i) {
                var e = n.GetUserData(i) instanceof g ? n.GetUserData(i) : null;
                return !e.TestPoint(o) || t(e)
            }
            var e = this,
                n = e.m_contactManager.m_broadPhase,
                a = new r;
            a.lowerBound.Set(o.x - s.b2_linearSlop, o.y - s.b2_linearSlop), a.upperBound.Set(o.x + s.b2_linearSlop, o.y + s.b2_linearSlop), n.Query(i, a)
        }, V.prototype.RayCast = function(t, o, i) {
            function n(n, s) {
                var l = r.GetUserData(s),
                    m = l instanceof g ? l : null;
                if (m.RayCast(a, n)) {
                    var c = a.fraction,
                        h = new e((1 - c) * o.x + c * i.x, (1 - c) * o.y + c * i.y);
                    return t(m, h, a.normal, c)
                }
            ...
            var e = this.m_island;
            for (e.Initialize(this.m_bodyCount, this.m_contactCount, this.m_jointCount, null, this.m_contactManager.m_contactListener, this.m_contactSolver), o = this.m_bodyList; o; o = o.m_next) o.m_flags &= ~x.e_islandFlag;
            ...
            for (var r = (parseInt(this.m_bodyCount), this.s_stack), a = this.m_bodyList; a; a = a.m_next)
                if (!(a.m_flags & x.e_islandFlag) && 0 != a.IsAwake() && 0 != a.IsActive() && a.GetType() != x.b2_staticBody) {
                    ...
                    for (r[l++] = a, a.m_flags |= x.e_islandFlag; l > 0;)
                        if (o = r[--l], e.AddBody(o), 0 == o.IsAwake() && o.SetAwake(!0), o.GetType() != x.b2_staticBody) {
                            for (var m, c = o.m_contactList; c; c = c.next) c.contact.m_flags & I.e_islandFlag || 1 != c.contact.IsSensor() && 0 != c.contact.IsEnabled() && 0 != c.contact.IsTouching() && (e.AddContact(c.contact), c.contact.m_flags |= I.e_islandFlag, m = c.other, m.m_flags & x.e_islandFlag || (r[l++] = m, m.m_flags |= x.e_islandFlag));
                            for (var h = o.m_jointList; h; h = h.next) 1 != h.joint.m_islandFlag && (m = h.other, 0 != m.IsActive() && (e.AddJoint(h.joint), h.joint.m_islandFlag = !0, m.m_flags & x.e_islandFlag || (r[l++] = m, m.m_flags |= x.e_islandFlag)))
                        }
                    e.Solve(t, this.m_gravity, this.m_allowSleep);
                    for (var _ = 0; _ < e.m_bodyCount; ++_) o = e.m_bodies[_], o.GetType() == x.b2_staticBody && (o.m_flags &= ~x.e_islandFlag)
                }
            for (_ = 0; _ < r.length && r[_]; ++_) r[_] = null;
            for (o = this.m_bodyList; o; o = o.m_next) 0 != o.IsAwake() && 0 != o.IsActive() && o.GetType() != x.b2_staticBody && o.SynchronizeFixtures();
            this.m_contactManager.FindNewContacts()
        }, V.prototype.SolveTOI = function(t) {
            var o, i, e, n, r, a, l, m = this.m_island;
            ...
            var c = V.s_queue;
            for (o = this.m_bodyList; o; o = o.m_next) o.m_flags &= ~x.e_islandFlag, o.m_sweep.t0 = 0;
            var h;
            ...
            for (;;) {
                ...
                for (h = this.m_contactList; h; h = h.m_next)
                    if (1 != h.IsSensor() && 0 != h.IsEnabled() && 0 != h.IsContinuous()) {
                        ...
                        if (h.m_flags & I.e_toiFlag) y = h.m_toi;
                            ...
                            if (i = h.m_fixtureA, e = h.m_fixtureB, n = i.m_body, r = e.m_body, !(n.GetType() == x.b2_dynamicBody && 0 != n.IsAwake() || r.GetType() == x.b2_dynamicBody && 0 != r.IsAwake())) continue;
                            var u = n.m_sweep.t0;
                ...
                if (i = _.m_fixtureA, e = _.m_fixtureB, n = i.m_body, r = e.m_body, V.s_backupA.Set(n.m_sweep), V.s_backupB.Set(r.m_sweep), n.Advance(p), r.Advance(p), _.Update(this.m_contactManager.m_contactListener), _.m_flags &= ~I.e_toiFlag, 1 != _.IsSensor() && 0 != _.IsEnabled()) {
                    if (0 != _.IsTouching()) {
                        var f = n;
                        ...
                        for (c[d + b++] = f, f.m_flags |= x.e_islandFlag; b > 0;)
                            if (o = c[d++], --b, m.AddBody(o), 0 == o.IsAwake() && o.SetAwake(!0), o.GetType() == x.b2_dynamicBody) {
                                for (a = o.m_contactList; a && m.m_contactCount != m.m_contactCapacity; a = a.next)
                                    if (!(a.contact.m_flags & I.e_islandFlag) && 1 != a.contact.IsSensor() && 0 != a.contact.IsEnabled() && 0 != a.contact.IsTouching()) {
                                        m.AddContact(a.contact), a.contact.m_flags |= I.e_islandFlag;
                                        var v = a.other;
                                        v.m_flags & x.e_islandFlag || (v.GetType() != x.b2_staticBody && (v.Advance(p), v.SetAwake(!0)), c[d + b] = v, ++b, v.m_flags |= x.e_islandFlag)
                                    }
                                for (var D = o.m_jointList; D; D = D.next) m.m_jointCount != m.m_jointCapacity && 1 != D.joint.m_islandFlag && (v = D.other, 0 != v.IsActive() && (m.AddJoint(D.joint), D.joint.m_islandFlag = !0, v.m_flags & x.e_islandFlag || (v.GetType() != x.b2_staticBody && (v.Advance(p), v.SetAwake(!0)), c[d + b] = v, ++b, v.m_flags |= x.e_islandFlag)))
                            }
                        var B = V.s_timestep;
                        B.warmStarting = !1, B.dt = (1 - p) * t.dt, B.inv_dt = 1 / B.dt, B.dtRatio = 0, B.velocityIterations = t.velocityIterations, B.positionIterations = t.positionIterations, m.SolveTOI(B);
                        var C = 0;
                        for (C = 0; C < m.m_bodyCount; ++C)
                            if (o = m.m_bodies[C], o.m_flags &= ~x.e_islandFlag, 0 != o.IsAwake() && o.GetType() == x.b2_dynamicBody)
                                for (o.SynchronizeFixtures(), a = o.m_contactList; a; a = a.next) a.contact.m_flags &= ~I.e_toiFlag;
                        for (C = 0; C < m.m_contactCount; ++C) h = m.m_contacts[C], h.m_flags &= ~(I.e_toiFlag | I.e_islandFlag);
                        for (C = 0; C < m.m_jointCount; ++C) l = m.m_joints[C], l.m_islandFlag = !1;
                        this.m_contactManager.FindNewContacts()
                    }
            ...
            switch (t.m_type) {
                ...
                case L.e_pulleyJoint:
                    ...
                    this.m_debugDraw.DrawSegment(h, a, m), this.m_debugDraw.DrawSegment(_, l, m), this.m_debugDraw.DrawSegment(h, _, m);
                    break;
                case L.e_mouseJoint:
                    this.m_debugDraw.DrawSegment(a, l, m);
                    break;
                default:
                    o != this.m_groundBody && this.m_debugDraw.DrawSegment(s, a, m), this.m_debugDraw.DrawSegment(a, l, m),
                        i != this.m_groundBody && this.m_debugDraw.DrawSegment(r, l, m)
            }
        }, V.prototype.DrawShape = function(o, i, e) {
            switch (o.m_type) {
                case u.e_circleShape:
                    var n = o instanceof h ? o : null,
                        s = t.MulX(i, n.m_p),
                        r = n.m_radius,
                        a = i.R.col1;
                ...
                case u.e_polygonShape:
                    ...
                    break;
                case u.e_edgeShape:
                    var f = o instanceof _ ? o : null;
                    this.m_debugDraw.DrawSegment(t.MulX(i, f.GetVertex1()), t.MulX(i, f.GetVertex2()), e)
            }
        }, Box2D.postDefs.push(function() {
            Box2D.Dynamics.b2World.s_timestep2 = new M, Box2D.Dynamics.b2World.s_xf = new i, Box2D.Dynamics.b2World.s_backupA = new o, Box2D.Dynamics.b2World.s_backupB = new o, Box2D.Dynamics.b2World.s_timestep = new M, Box2D.Dynamics.b2World.s_queue = new Vector, Box2D.Dynamics.b2World.s_jointColor = new n(.5, .8, .8), Box2D.Dynamics.b2World.e_newFixture = 1, Box2D.Dynamics.b2World.e_locked = 2
        })
    }(),
    function() {
        var t = Box2D.Collision.Shapes.b2CircleShape,
            o = (Box2D.Collision.Shapes.b2EdgeChainDef, Box2D.Collision.Shapes.b2EdgeShape),
        ...
        Box2D.inherit(n, Box2D.Dynamics.Contacts.b2Contact), n.prototype.__super = Box2D.Dynamics.Contacts.b2Contact.prototype, n.b2CircleContact = function() {
            ...
            return new n
        }, n.Destroy = function(t, o) {}, n.prototype.Reset = function(t, o) {
            this.__super.Reset.call(this, t, o)
        }, n.prototype.Evaluate = function() {
            var o = this.m_fixtureA.GetBody(),
                i = this.m_fixtureB.GetBody();
            g.CollideCircles(this.m_manifold, this.m_fixtureA.GetShape() instanceof t ? this.m_fixtureA.GetShape() : null, o.m_xf, this.m_fixtureB.GetShape() instanceof t ? this.m_fixtureB.GetShape() : null, i.m_xf)
        }, s.b2Contact = function() {
            this.m_nodeA = new l, this.m_nodeB = new l, this.m_manifold = new w, this.m_oldManifold = new w
            ...
            t.Initialize(this.m_manifold, o.GetTransform(), e.m_radius, i.GetTransform(), n.m_radius)
        ...
        }, s.prototype.b2Contact = function() {}, s.prototype.Reset = function(t, o) {
            if (void 0 === t && (t = null), void 0 === o && (o = null), this.m_flags = s.e_enabledFlag, !t || !o) return this.m_fixtureA = null, void(this.m_fixtureB = null);
            (t.IsSensor() || o.IsSensor()) && (this.m_flags |= s.e_sensorFlag);
            var i = t.GetBody(),
                e = o.GetBody();
            (i.GetType() != b.b2_dynamicBody || i.IsBullet() || e.GetType() != b.b2_dynamicBody || e.IsBullet()) && (this.m_flags |= s.e_continuousFlag), this.m_fixtureA = t, this.m_fixtureB = o, this.m_manifold.m_pointCount = 0, this.m_prev = null, this.m_next = null, this.m_nodeA.contact = null, this.m_nodeA.prev = null, this.m_nodeA.next = null, this.m_nodeA.other = null, this.m_nodeB.contact = null, this.m_nodeB.prev = null, this.m_nodeB.next = null, this.m_nodeB.other = null
        }, s.prototype.Update = function(t) {
            var o = this.m_oldManifold;
            this.m_oldManifold = this.m_manifold, this.m_manifold = o, this.m_flags |= s.e_enabledFlag;
            var i = !1,
            ...
            if (this.m_flags & s.e_sensorFlag) {
                if (l) {
                    var m = this.m_fixtureA.GetShape(),
                        ...
                        h = r.GetTransform(),
                        _ = a.GetTransform();
                    i = e.TestOverlap(m, h, c, _)
                }
                this.m_manifold.m_pointCount = 0
            } else {
                if (r.GetType() != b.b2_dynamicBody || r.IsBullet() || a.GetType() != b.b2_dynamicBody || a.IsBullet() ? this.m_flags |= s.e_continuousFlag : this.m_flags &= ~s.e_continuousFlag, l) {
        ...
        }, s.prototype.Evaluate = function() {}, s.prototype.ComputeTOI = function(t, o) {
            return s.s_input.proxyA.Set(this.m_fixtureA.GetShape()), s.s_input.proxyB.Set(this.m_fixtureB.GetShape()), s.s_input.sweepA = t, s.s_input.sweepB = o, s.s_input.tolerance = D.b2_linearSlop, M.TimeOfImpact(s.s_input)
        }, Box2D.postDefs.push(function() {
        ...
        }, l.b2ContactEdge = function() {}, m.b2ContactFactory = function() {}, m.prototype.b2ContactFactory = function(t) {
            this.m_allocator = t, this.InitializeRegisters()
        }, m.prototype.AddType = function(t, o, i, e) {
            void 0 === i && (i = 0), void 0 === e && (e = 0), this.m_registers[i][e].createFcn = t, this.m_registers[i][e].destroyFcn = o, this.m_registers[i][e].primary = !0, i != e && (this.m_registers[e][i].createFcn = t, this.m_registers[e][i].destroyFcn = o, this.m_registers[e][i].primary = !1)
            ...
            for (var t = 0; t < e.e_shapeTypeCount; t++) {
                ...
                for (var o = 0; o < e.e_shapeTypeCount; o++) this.m_registers[t][o] = new c
            }
            ...
            var i, e = parseInt(t.GetType()),
                n = parseInt(o.GetType()),
                s = this.m_registers[e][n];
            if (s.pool) return i = s.pool, s.pool = i.m_next, s.poolCount--, i.Reset(t, o), i;
            var r = s.createFcn;
            return null != r ? s.primary ? (i = r(this.m_allocator), i.Reset(t, o), i) : (i = r(this.m_allocator), i.Reset(o, t), i) : null
        ...
        }, _.prototype.b2ContactSolver = function() {}, _.prototype.Initialize = function(t, o, i, e) {
            void 0 === i && (i = 0);
            var n;
            this.m_step.Set(t), this.m_allocator = e;
            var s = 0;
            for (this.m_constraintCount = i; this.m_constraints.length < this.m_constraintCount;) this.m_constraints[this.m_constraints.length] = new r;
            for (s = 0; s < i; ++s) {
                n = o[s];
                var a = n.m_fixtureA,
                    l = n.m_fixtureB,
                ...
                if (2 == M.pointCount) {
                    var X = M.points[0],
                        ...
                        ot = X.rB.x * w - X.rB.y * S,
                        it = Z.rA.x * w - Z.rA.y * S,
            ...
            for (var t, o, i = 0, e = 0, n = 0, s = 0, r = 0, a = 0, l = 0, m = 0, c = 0, h = 0, _ = 0, p = 0, y = 0, u = 0, x = 0, f = 0, d = 0; d < this.m_constraintCount; ++d) {
                var b = this.m_constraints[d],
                    ...
                    F = -G,
                    P = b.friction;
                for (i = 0; i < b.pointCount; i++) t = b.points[i], e = S.x - A * t.rB.y - g.x + B * t.rA.y, n = S.y + A * t.rB.x - g.y - B * t.rA.x, r = e * L + n * F, a = t.tangentMass * -r, l = P * t.normalImpulse, m = C.Clamp(t.tangentImpulse + a, -l, l), a = m - t.tangentImpulse, c = a * L, h = a * F, g.x -= w * c, g.y -= w * h, B -= M * (t.rA.x * h - t.rA.y * c), S.x += V * c, S.y += V * h, A += I * (t.rB.x * h - t.rB.y * c), t.tangentImpulse = m;
                parseInt(b.pointCount);
                if (1 == b.pointCount) t = b.points[0], e = S.x + -A * t.rB.y - g.x - -B * t.rA.y, n = S.y + A * t.rB.x - g.y - B * t.rA.x, s = e * G + n * J, a = -t.normalMass * (s - t.velocityBias), m = t.normalImpulse + a, m = m > 0 ? m : 0, a = m - t.normalImpulse, c = a * G, h = a * J, g.x -= w * c, g.y -= w * h, B -= M * (t.rA.x * h - t.rA.y * c), S.x += V * c, S.y += V * h, A += I * (t.rB.x * h - t.rB.y * c), t.normalImpulse = m;
                else {
                    var R = b.points[0],
                        T = b.points[1],
                        k = R.normalImpulse,
                        ...
                        K = U - R.velocityBias,
                        W = O - T.velocityBias;
                    o = b.K, K -= o.col1.x * k + o.col2.x * N, W -= o.col1.y * k + o.col2.y * N;
                    for (;;) {
                        o = b.normalMass;
            ...
            for (var t = 0; t < this.m_constraintCount; ++t)
                for (var o = this.m_constraints[t], i = o.manifold, e = 0; e < o.pointCount; ++e) {
                    var n = i.m_points[e],
                        s = o.points[e];
            ...
            for (var o = 0, i = 0; i < this.m_constraintCount; i++) {
                ...
                for (var c = _.s_psm.m_normal, h = 0; h < e.pointCount; h++) {
                    ...
                    var v = C.Clamp(t * (u + D.b2_linearSlop), -D.b2_maxLinearCorrection, 0),
                        ...
                        A = B * c.x,
                        g = B * c.y;
                    n.m_sweep.c.x -= r * A, n.m_sweep.c.y -= r * g, n.m_sweep.a -= a * (x * g - f * A), n.SynchronizeTransform(), s.m_sweep.c.x += l * A, s.m_sweep.c.y += l * g, s.m_sweep.a += m * (d * g - b * A), s.SynchronizeTransform()
                }
            }
            ...
            return new p
        }, p.Destroy = function(t, o) {}, p.prototype.Reset = function(t, o) {
            this.__super.Reset.call(this, t, o)
        }, p.prototype.Evaluate = function() {
            var i = this.m_fixtureA.GetBody(),
                e = this.m_fixtureB.GetBody();
            this.b2CollideEdgeAndCircle(this.m_manifold, this.m_fixtureA.GetShape() instanceof o ? this.m_fixtureA.GetShape() : null, i.m_xf, this.m_fixtureB.GetShape() instanceof t ? this.m_fixtureB.GetShape() : null, e.m_xf)
        }, p.prototype.b2CollideEdgeAndCircle = function(t, o, i, e, n) {}, Box2D.inherit(y, Box2D.Dynamics.Contacts.b2Contact), y.prototype.__super = Box2D.Dynamics.Contacts.b2Contact.prototype, y.b2NullContact = function() {
            Box2D.Dynamics.Contacts.b2Contact.b2Contact.apply(this, arguments)
            ...
            return new u
        }, u.Destroy = function(t, o) {}, u.prototype.Reset = function(t, o) {
            this.__super.Reset.call(this, t, o), D.b2Assert(t.GetType() == e.e_polygonShape), D.b2Assert(o.GetType() == e.e_circleShape)
        }, u.prototype.Evaluate = function() {
            var o = this.m_fixtureA.m_body,
                e = this.m_fixtureB.m_body;
            g.CollidePolygonAndCircle(this.m_manifold, this.m_fixtureA.GetShape() instanceof i ? this.m_fixtureA.GetShape() : null, o.m_xf, this.m_fixtureB.GetShape() instanceof t ? this.m_fixtureB.GetShape() : null, e.m_xf)
            ...
            return new x
        }, x.Destroy = function(t, o) {}, x.prototype.Reset = function(t, o) {
            this.__super.Reset.call(this, t, o), D.b2Assert(t.GetType() == e.e_polygonShape), D.b2Assert(o.GetType() == e.e_edgeShape)
        }, x.prototype.Evaluate = function() {
            var t = this.m_fixtureA.GetBody(),
                e = this.m_fixtureB.GetBody();
            this.b2CollidePolyAndEdge(this.m_manifold, this.m_fixtureA.GetShape() instanceof i ? this.m_fixtureA.GetShape() : null, t.m_xf, this.m_fixtureB.GetShape() instanceof o ? this.m_fixtureB.GetShape() : null, e.m_xf)
        }, x.prototype.b2CollidePolyAndEdge = function(t, o, i, e, n) {}, Box2D.inherit(f, Box2D.Dynamics.Contacts.b2Contact), f.prototype.__super = Box2D.Dynamics.Contacts.b2Contact.prototype, f.b2PolygonContact = function() {
            Box2D.Dynamics.Contacts.b2Contact.b2Contact.apply(this, arguments)
        }, f.Create = function(t) {
            return new f
        }, f.Destroy = function(t, o) {}, f.prototype.Reset = function(t, o) {
            this.__super.Reset.call(this, t, o)
        }, f.prototype.Evaluate = function() {
            var t = this.m_fixtureA.GetBody(),
                o = this.m_fixtureB.GetBody();
            g.CollidePolygons(this.m_manifold, this.m_fixtureA.GetShape() instanceof i ? this.m_fixtureA.GetShape() : null, t.m_xf, this.m_fixtureB.GetShape() instanceof i ? this.m_fixtureB.GetShape() : null, o.m_xf)
            ...
            switch (t.type) {
                case w.e_circles:
                    ...
                    var c = t.bodyB.m_xf.position.x + (o.col1.x * i.x + o.col2.x * i.y),
                        h = t.bodyB.m_xf.position.y + (o.col1.y * i.x + o.col2.y * i.y),
                        _ = c - l,
                        p = h - m,
                        y = _ * _ + p * p;
        ...
        Box2D.inherit(n, Box2D.Dynamics.Controllers.b2Controller), n.prototype.__super = Box2D.Dynamics.Controllers.b2Controller.prototype, n.b2BuoyancyController = function() {
            ...
            if (this.m_bodyList) {
                ...
                for (var o = this.m_bodyList; o; o = o.nextBody) {
                    var e = o.body;
                    if (0 != e.IsAwake()) {
                        for (var n = new i, s = new i, r = 0, a = 0, l = e.GetFixtureList(); l; l = l.GetNext()) {
                            var m = new i,
                                c = l.GetShape().ComputeSubmergedArea(this.normal, this.offset, e.GetTransform(), m);
                            r += c, n.x += c * m.x, n.y += c * m.y;
                            var h = 0;
                            h = (this.useDensity, 1), a += c * h, s.x += c * m.x * h, s.y += c * m.y * h
                        }
            ...
            var o = 1e3,
                n = new i,
                s = new i;
            n.x = this.normal.x * this.offset + this.normal.y * o, n.y = this.normal.y * this.offset - this.normal.x * o, s.x = this.normal.x * this.offset - this.normal.y * o, s.y = this.normal.y * this.offset + this.normal.x * o;
            var r = new e(0, 0, 1);
            t.DrawSegment(n, s, r)
            ...
            for (var o = new i(this.A.x * t.dt, this.A.y * t.dt), e = this.m_bodyList; e; e = e.nextBody) {
                var n = e.body;
                n.IsAwake() && n.SetLinearVelocity(new i(n.GetLinearVelocity().x + o.x, n.GetLinearVelocity().y + o.y))
            }
            ...
            var o = new l;
            o.controller = this, o.body = t, o.nextBody = this.m_bodyList, o.prevBody = null, this.m_bodyList = o, o.nextBody && (o.nextBody.prevBody = o), this.m_bodyCount++, o.nextController = t.m_controllerList, o.prevController = null, t.m_controllerList = o, o.nextController && (o.nextController.prevController = o), t.m_controllerCount++
        }, a.prototype.RemoveBody = function(t) {
            for (var o = t.m_controllerList; o && o.controller != this;) o = o.nextController;
            o.prevBody && (o.prevBody.nextBody = o.nextBody), o.nextBody && (o.nextBody.prevBody = o.prevBody), o.nextController && (o.nextController.prevController = o.prevController), o.prevController && (o.prevController.nextController = o.nextController), this.m_bodyList == o && (this.m_bodyList = o.nextBody), t.m_controllerList == o && (t.m_controllerList = o.nextController), t.m_controllerCount--, this.m_bodyCount--
            ...
            return this.m_bodyList
        }, l.b2ControllerEdge = function() {}, Box2D.inherit(m, Box2D.Dynamics.Controllers.b2Controller), m.prototype.__super = Box2D.Dynamics.Controllers.b2Controller.prototype, m.b2GravityController = function() {
            ...
            if (this.invSqr)
                for (o = this.m_bodyList; o; o = o.nextBody)
                    for (e = o.body, n = e.GetWorldCenter(), s = e.GetMass(), r = this.m_bodyList; r != o; r = r.nextBody) a = r.body, l = a.GetWorldCenter(), m = l.x - n.x, c = l.y - n.y, (h = m * m + c * c) < Number.MIN_VALUE || (_ = new i(m, c), _.Multiply(this.G / h / Math.sqrt(h) * s * a.GetMass()), e.IsAwake() && e.ApplyForce(_, n), _.Multiply(-1), a.IsAwake() && a.ApplyForce(_, l));
            else
                for (o = this.m_bodyList; o; o = o.nextBody)
                    for (e = o.body, n = e.GetWorldCenter(), s = e.GetMass(), r = this.m_bodyList; r != o; r = r.nextBody) a = r.body, l = a.GetWorldCenter(), m = l.x - n.x, c = l.y - n.y, (h = m * m + c * c) < Number.MIN_VALUE || (_ = new i(m, c), _.Multiply(this.G / h * s * a.GetMass()), e.IsAwake() && e.ApplyForce(_, n), _.Multiply(-1), a.IsAwake() && a.ApplyForce(_, l))
            ...
            void 0 === t && (t = 0), void 0 === o && (o = 0), this.T.col1.x = -t, this.T.col1.y = 0, this.T.col2.x = 0, this.T.col2.y = -o, this.maxTimestep = t > 0 || o > 0 ? 1 / Math.max(t, o) : 0
            ...
            if (!(e <= Number.MIN_VALUE)) {
                ...
                for (var n = this.m_bodyList; n; n = n.nextBody) {
                    var s = n.body;
                    if (s.IsAwake()) {
                        var r = s.GetWorldVector(o.MulMV(this.T, s.GetLocalVector(s.GetLinearVelocity())));
                        s.SetLinearVelocity(new i(s.GetLinearVelocity().x + r.x * e, s.GetLinearVelocity().y + r.y * e))
                    }
                }
            }
        }
    ...
    function() {
        ...
        Box2D.inherit(r, Box2D.Dynamics.Joints.b2Joint), r.prototype.__super = Box2D.Dynamics.Joints.b2Joint.prototype, r.b2DistanceJoint = function() {
            ...
            this.m_localAnchor1.SetV(t.localAnchorA),
                this.m_localAnchor2.SetV(t.localAnchorB), this.m_length = t.length, this.m_frequencyHz = t.frequencyHz, this.m_dampingRatio = t.dampingRatio, this.m_impulse = 0, this.m_gamma = 0, this.m_bias = 0
            ...
            e = i.col1.x * r + i.col2.x * a, a = i.col1.y * r + i.col2.y * a, r = e, i = s.m_xf.R;
            var l = this.m_localAnchor2.x - s.m_sweep.localCenter.x,
                m = this.m_localAnchor2.y - s.m_sweep.localCenter.y;
            e = i.col1.x * l + i.col2.x * m, m = i.col1.y * l + i.col2.y * m, l = e, this.m_u.x = s.m_sweep.c.x + l - n.m_sweep.c.x - r, this.m_u.y = s.m_sweep.c.y + m - n.m_sweep.c.y - a;
            ...
            if (this.m_mass = 0 != p ? 1 / p : 0, this.m_frequencyHz > 0) {
                var y = c - this.m_length,
                    ...
                    f = this.m_mass * u * u;
                this.m_gamma = o.dt * (x + o.dt * f), this.m_gamma = 0 != this.m_gamma ? 1 / this.m_gamma : 0, this.m_bias = y * o.dt * f * this.m_gamma, this.m_mass = p + this.m_gamma, this.m_mass = 0 != this.m_mass ? 1 / this.m_mass : 0
            }
            if (o.warmStarting) {
                this.m_impulse *= o.dtRatio;
                var d = this.m_impulse * this.m_u.x,
                    b = this.m_impulse * this.m_u.y;
                n.m_linearVelocity.x -= n.m_invMass * d, n.m_linearVelocity.y -= n.m_invMass * b, n.m_angularVelocity -= n.m_invI * (r * b - a * d), s.m_linearVelocity.x += s.m_invMass * d, s.m_linearVelocity.y += s.m_invMass * b, s.m_angularVelocity += s.m_invI * (l * b - m * d)
            } else this.m_impulse = 0
        }, r.prototype.SolveVelocityConstraints = function(t) {
            var o, i = this.m_bodyA,
                e = this.m_bodyB;
            o = i.m_xf.R;
            ...
            r = o.col1.x * a + o.col2.x * l, l = o.col1.y * a + o.col2.y * l, a = r;
            var m = i.m_linearVelocity.x + -i.m_angularVelocity * s,
                c = i.m_linearVelocity.y + i.m_angularVelocity * n,
                h = e.m_linearVelocity.x + -e.m_angularVelocity * l,
                _ = e.m_linearVelocity.y + e.m_angularVelocity * a,
                p = this.m_u.x * (h - m) + this.m_u.y * (_ - c),
                y = -this.m_mass * (p + this.m_bias + this.m_gamma * this.m_impulse);
            this.m_impulse += y;
            var u = y * this.m_u.x,
                x = y * this.m_u.y;
            i.m_linearVelocity.x -= i.m_invMass * u, i.m_linearVelocity.y -= i.m_invMass * x, i.m_angularVelocity -= i.m_invI * (n * x - s * u), e.m_linearVelocity.x += e.m_invMass * u, e.m_linearVelocity.y += e.m_invMass * x, e.m_angularVelocity += e.m_invI * (a * x - l * u)
            ...
            l = i.col1.x * m + i.col2.x * c, c = i.col1.y * m + i.col2.y * c, m = l;
            ...
            var x = u * this.m_u.x,
                f = u * this.m_u.y;
            return n.m_sweep.c.x -= n.m_invMass * x, n.m_sweep.c.y -= n.m_invMass * f, n.m_sweep.a -= n.m_invI * (r * f - a * x), s.m_sweep.c.x += s.m_invMass * x, s.m_sweep.c.y += s.m_invMass * f, s.m_sweep.a += s.m_invI * (m * f - c * x), n.SynchronizeTransform(), s.SynchronizeTransform(), e.Abs(y) < t.b2_linearSlop
            ...
            this.bodyA = t, this.bodyB = o, this.localAnchorA.SetV(this.bodyA.GetLocalPoint(i)), this.localAnchorB.SetV(this.bodyB.GetLocalPoint(e));
            var n = e.x - i.x,
                s = e.y - i.y;
            ...
            Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments), this.m_localAnchorA = new n, this.m_localAnchorB = new n, this.m_linearMass = new o, this.m_linearImpulse = new n
            ...
            e = i.col1.x * l + i.col2.x * m, m = i.col1.y * l + i.col2.y * m, l = e;
            var c = n.m_invMass,
                h = s.m_invMass,
                _ = n.m_invI,
                p = s.m_invI,
                y = new o;
            if (y.col1.x = c + h, y.col2.x = 0, y.col1.y = 0, y.col2.y = c + h, y.col1.x += _ * a * a, y.col2.x += -_ * r * a, y.col1.y += -_ * r * a, y.col2.y += _ * r * r, y.col1.x += p * m * m, y.col2.x += -p * l * m, y.col1.y += -p * l * m, y.col2.y += p * l * l, y.GetInverse(this.m_linearMass), this.m_angularMass = _ + p, this.m_angularMass > 0 && (this.m_angularMass = 1 / this.m_angularMass), t.warmStarting) {
                ...
                n.m_linearVelocity.x -= c * u.x, n.m_linearVelocity.y -= c * u.y, n.m_angularVelocity -= _ * (r * u.y - a * u.x + this.m_angularImpulse), s.m_linearVelocity.x += h * u.x, s.m_linearVelocity.y += h * u.y, s.m_angularVelocity += p * (l * u.y - m * u.x + this.m_angularImpulse)
            ...
            i = o.col1.x * u + o.col2.x * x, x = o.col1.y * u + o.col2.y * x, u = i, o = r.m_xf.R;
            var f = this.m_localAnchorB.x - r.m_sweep.localCenter.x,
                d = this.m_localAnchorB.y - r.m_sweep.localCenter.y;
            i = o.col1.x * f + o.col2.x * d, d = o.col1.y * f + o.col2.y * d, f = i;
            var b = 0,
                v = c - l,
                D = -this.m_angularMass * v,
                B = this.m_angularImpulse;
            b = t.dt * this.m_maxTorque, this.m_angularImpulse = e.Clamp(this.m_angularImpulse + D, -b, b), D = this.m_angularImpulse - B, l -= p * D, c += y * D;
            var C = m.x - c * d - a.x + l * x,
                A = m.y + c * f - a.y - l * u,
                g = e.MulMV(this.m_linearMass, new n(-C, -A)),
                S = this.m_linearImpulse.Copy();
            this.m_linearImpulse.Add(g), b = t.dt * this.m_maxForce, this.m_linearImpulse.LengthSquared() > b * b && (this.m_linearImpulse.Normalize(), this.m_linearImpulse.Multiply(b)), g = e.SubtractVV(this.m_linearImpulse, S), a.x -= h * g.x, a.y -= h * g.y, l -= p * (u * g.y - x * g.x), m.x += _ * g.x, m.y += _ * g.y, c += y * (f * g.y - d * g.x), s.m_angularVelocity = l, r.m_angularVelocity = c
        }, l.prototype.SolvePositionConstraints = function(t) {
            return void 0 === t && (t = 0), !0
        }, Box2D.inherit(m, Box2D.Dynamics.Joints.b2JointDef), m.prototype.__super = Box2D.Dynamics.Joints.b2JointDef.prototype, m.b2FrictionJointDef = function() {
            Box2D.Dynamics.Joints.b2JointDef.b2JointDef.apply(this, arguments), this.localAnchorA = new n, this.localAnchorB = new n
            ...
            this.bodyA = t, this.bodyB = o, this.localAnchorA.SetV(this.bodyA.GetLocalPoint(i)), this.localAnchorB.SetV(this.bodyB.GetLocalPoint(i))
        ...
        }, _.prototype.Set = function(t, o, i, e) {
            void 0 === o && (o = 0), void 0 === e && (e = 0), this.linearA.SetV(t), this.angularA = o, this.linearB.SetV(i), this.angularB = e
        }, _.prototype.Compute = function(t, o, i, e) {
            return void 0 === o && (o = 0), void 0 === e && (e = 0), this.linearA.x * t.x + this.linearA.y * t.y + this.angularA * o + (this.linearB.x * i.x + this.linearB.y * i.y) + this.angularB * e
        }, p.b2Joint = function() {
            ...
            return i
        }, p.Destroy = function(t, o) {}, p.prototype.b2Joint = function(o) {
            t.b2Assert(o.bodyA != o.bodyB), this.m_type = o.type, this.m_prev = null, this.m_next = null, this.m_bodyA = o.bodyA, this.m_bodyB = o.bodyB, this.m_collideConnected = o.collideConnected, this.m_islandFlag = !1, this.m_userData = o.userData
            ...
            Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments), this.m_localAnchor1 = new n, this.m_localAnchor2 = new n, this.m_localXAxis1 = new n, this.m_localYAxis1 = new n, this.m_axis = new n, this.m_perp = new n, this.m_K = new o, this.m_impulse = new n
            ...
            void 0 === t && (t = 0), void 0 === o && (o = 0), this.m_bodyA.SetAwake(!0), this.m_bodyB.SetAwake(!0), this.m_lowerTranslation = t, this.m_upperTranslation = o
            ...
            if (0 == this.m_enableMotor && (this.m_motorImpulse = 0), o.warmStarting) {
                this.m_impulse.x *= o.dtRatio, this.m_impulse.y *= o.dtRatio, this.m_motorImpulse *= o.dtRatio;
            ...
            if (this.m_enableMotor && this.m_limitState != p.e_equalLimits) {
                ...
                this.m_motorImpulse = e.Clamp(this.m_motorImpulse + u, -f, f), u = this.m_motorImpulse - x, m = u * this.m_axis.x, c = u * this.m_axis.y, h = u * this.m_a1, _ = u * this.m_a2, s.x -= this.m_invMassA * m, s.y -= this.m_invMassA * c, r -= this.m_invIA * h, a.x += this.m_invMassB * m, a.y += this.m_invMassB * c, l += this.m_invIB * _
            }
            var d = this.m_perp.x * (a.x - s.x) + this.m_perp.y * (a.y - s.y) + this.m_s2 * l - this.m_s1 * r;
            if (this.m_enableLimit && this.m_limitState != p.e_inactiveLimit) {
                ...
                var B = -d - (this.m_impulse.y - v.y) * this.m_K.col2.x,
                    C = 0;
                C = 0 != this.m_K.col1.x ? B / this.m_K.col1.x + v.x : v.x, this.m_impulse.x = C, D.x = this.m_impulse.x - v.x, D.y = this.m_impulse.y - v.y, m = D.x * this.m_perp.x + D.y * this.m_axis.x, c = D.x * this.m_perp.y + D.y * this.m_axis.y, h = D.x * this.m_s1 + D.y * this.m_a1, _ = D.x * this.m_s2 + D.y * this.m_a2, s.x -= this.m_invMassA * m, s.y -= this.m_invMassA * c, r -= this.m_invIA * h, a.x += this.m_invMassB * m, a.y += this.m_invMassB * c, l += this.m_invIB * _
            } else {
                var A = 0;
                A = 0 != this.m_K.col1.x ? -d / this.m_K.col1.x : 0, this.m_impulse.x += A, m = A * this.m_perp.x, c = A * this.m_perp.y, h = A * this.m_s1, _ = A * this.m_s2, s.x -= this.m_invMassA * m, s.y -= this.m_invMassA * c, r -= this.m_invIA * h, a.x += this.m_invMassB * m, a.y += this.m_invMassB * c, l += this.m_invIB * _
            }
            o.m_linearVelocity.SetV(s), o.m_angularVelocity = r, i.m_linearVelocity.SetV(a), i.m_angularVelocity = l
            ...
            return l.x -= this.m_invMassA * F, l.y -= this.m_invMassA * P, m -= this.m_invIA * R, c.x += this.m_invMassB * F, c.y += this.m_invMassB * P, h += this.m_invIB * T, r.m_sweep.a = m, a.m_sweep.a = h, r.SynchronizeTransform(), a.SynchronizeTransform(), f <= t.b2_linearSlop && d <= t.b2_angularSlop
            ...
            this.bodyA = t, this.bodyB = o, this.localAnchorA = this.bodyA.GetLocalPoint(i), this.localAnchorB = this.bodyB.GetLocalPoint(i), this.localAxisA = this.bodyA.GetLocalVector(e)
            ...
            Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments), this.K = new o, this.K1 = new o, this.K2 = new o, this.m_localAnchor = new n, this.m_target = new n, this.m_impulse = new n, this.m_mass = new o, this.m_C = new n
            ...
            this.m_localAnchor.x = o * e.col1.x + i * e.col1.y, this.m_localAnchor.y = o * e.col2.x + i * e.col2.y, this.m_maxForce = t.maxForce, this.m_impulse.SetZero(), this.m_frequencyHz = t.frequencyHz, this.m_dampingRatio = t.dampingRatio, this.m_beta = 0, this.m_gamma = 0
            ...
            var c = o.m_invMass,
                h = o.m_invI;
            this.K1.col1.x = c, this.K1.col2.x = 0, this.K1.col1.y = 0, this.K1.col2.y = c, this.K2.col1.x = h * l * l, this.K2.col2.x = -h * a * l, this.K2.col1.y = -h * a * l, this.K2.col2.y = h * a * a, this.K.SetM(this.K1), this.K.AddM(this.K2), this.K.col1.x += this.m_gamma, this.K.col2.y += this.m_gamma, this.K.GetInverse(this.m_mass), this.m_C.x = o.m_sweep.c.x + a - this.m_target.x, this.m_C.y = o.m_sweep.c.y + l - this.m_target.y, o.m_angularVelocity *= .98, this.m_impulse.x *= t.dtRatio, this.m_impulse.y *= t.dtRatio, o.m_linearVelocity.x += c * this.m_impulse.x, o.m_linearVelocity.y += c * this.m_impulse.y, o.m_angularVelocity += h * (a * this.m_impulse.y - l * this.m_impulse.x)
        }, d.prototype.SolveVelocityConstraints = function(t) {
            var o, i = this.m_bodyB,
                e = 0,
                n = 0;
            o = i.m_xf.R;
            var s = this.m_localAnchor.x - i.m_sweep.localCenter.x,
                r = this.m_localAnchor.y - i.m_sweep.localCenter.y;
            e = o.col1.x * s + o.col2.x * r, r = o.col1.y * s + o.col2.y * r, s = e;
            var a = i.m_linearVelocity.x + -i.m_angularVelocity * r,
                l = i.m_linearVelocity.y + i.m_angularVelocity * s;
            o = this.m_mass, e = a + this.m_beta * this.m_C.x + this.m_gamma * this.m_impulse.x, n = l + this.m_beta * this.m_C.y + this.m_gamma * this.m_impulse.y;
            ...
            this.m_impulse.LengthSquared() > p * p && this.m_impulse.Multiply(p / this.m_impulse.Length()), m = this.m_impulse.x - h, c = this.m_impulse.y - _, i.m_linearVelocity.x += i.m_invMass * m, i.m_linearVelocity.y += i.m_invMass * c, i.m_angularVelocity += i.m_invI * (s * c - r * m)
            ...
            Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments), this.m_localAnchor1 = new n, this.m_localAnchor2 = new n, this.m_u = new n, this.m_impulse = 0, this.m_mass = 0, this.m_length = 0, this.m_maxLength = 0, this.m_state = 0
            ...
            var l = this.m_localAnchor2.x - s.m_sweep.localCenter.x,
                m = this.m_localAnchor2.y - s.m_sweep.localCenter.y;
            e = i.col1.x * l + i.col2.x * m, m = i.col1.y * l + i.col2.y * m, l = e, this.m_u.x = s.m_sweep.c.x + l - n.m_sweep.c.x - r, this.m_u.y = s.m_sweep.c.y + m - n.m_sweep.c.y - a, this.m_length = Math.sqrt(this.m_u.x * this.m_u.x + this.m_u.y * this.m_u.y);
            ...
            if (this.m_mass = 0 != y ? 1 / y : 0, o.warmStarting) {
                this.m_impulse *= o.dtRatio;
                var u = this.m_impulse * this.m_u.x,
                    x = this.m_impulse * this.m_u.y;
                n.m_linearVelocity.x -= n.m_invMass * u, n.m_linearVelocity.y -= n.m_invMass * x, n.m_angularVelocity -= n.m_invI * (r * x - a * u), s.m_linearVelocity.x += s.m_invMass * u, s.m_linearVelocity.y += s.m_invMass * x, s.m_angularVelocity += s.m_invI * (l * x - m * u)
            }
            ...
            a = o.col1.x * l + o.col2.x * m, m = o.col1.y * l + o.col2.y * m, l = a;
            var c = i.m_linearVelocity.x + -i.m_angularVelocity * r,
                h = i.m_linearVelocity.y + i.m_angularVelocity * s,
                _ = n.m_linearVelocity.x + -n.m_angularVelocity * m,
                p = n.m_linearVelocity.y + n.m_angularVelocity * l,
            ...
            var d = x * this.m_u.x,
                b = x * this.m_u.y;
            i.m_linearVelocity.x -= i.m_invMass * d, i.m_linearVelocity.y -= i.m_invMass * b, i.m_angularVelocity -= i.m_invI * (s * b - r * d), n.m_linearVelocity.x += n.m_invMass * d, n.m_linearVelocity.y += n.m_invMass * b, n.m_angularVelocity += n.m_invI * (l * b - m * d)
        }, v.prototype.SolvePositionConstraints = function(o) {
            var i, n = this.m_bodyA,
                s = this.m_bodyB;
            i = n.m_xf.R;
            var r = this.m_localAnchor1.x - n.m_sweep.localCenter.x,
            ...
            var x = u * this.m_u.x,
                f = u * this.m_u.y;
            return n.m_sweep.c.x -= n.m_invMass * x, n.m_sweep.c.y -= n.m_invMass * f, n.m_sweep.a -= n.m_invI * (r * f - a * x), s.m_sweep.c.x += s.m_invMass * x, s.m_sweep.c.y += s.m_invMass * f, s.m_sweep.a += s.m_invI * (m * f - c * x), n.SynchronizeTransform(), s.SynchronizeTransform(), p - this.m_maxLength < t.b2_linearSlop
        ...
        }, D.prototype.Initialize = function(t, o, i, e, n) {
            this.bodyA = t, this.bodyB = o, this.localAnchorA.SetV(this.bodyA.GetLocalPoint(i)), this.localAnchorB.SetV(this.bodyB.GetLocalPoint(e));
            var s = e.x - i.x,
                r = e.y - i.y;
            ...
            return this.m_upperTranslation
        }, B.prototype.SetLimits = function(t, o) {
            void 0 === t && (t = 0), void 0 === o && (o = 0), this.m_bodyA.SetAwake(!0), this.m_bodyB.SetAwake(!0), this.m_lowerTranslation = t, this.m_upperTranslation = o
            ...
            var o = this.m_bodyA,
                ...
                y = 0;
            if (this.m_enableMotor && this.m_limitState != p.e_equalLimits) {
                var u = this.m_axis.x * (l.x - r.x) + this.m_axis.y * (l.y - r.y) + this.m_a2 * m - this.m_a1 * a,
                    x = this.m_motorMass * (this.m_motorSpeed - u),
                    f = this.m_motorImpulse,
                    d = t.dt * this.m_maxMotorForce;
                this.m_motorImpulse = e.Clamp(this.m_motorImpulse + x, -d, d), x = this.m_motorImpulse - f, c = x * this.m_axis.x, h = x * this.m_axis.y, _ = x * this.m_a1, y = x * this.m_a2, r.x -= this.m_invMassA * c, r.y -= this.m_invMassA * h, a -= this.m_invIA * _, l.x += this.m_invMassB * c, l.y += this.m_invMassB * h, m += this.m_invIB * y
            }
            var b = this.m_perp.x * (l.x - r.x) + this.m_perp.y * (l.y - r.y) + this.m_s2 * m - this.m_s1 * a,
                v = m - a;
            if (this.m_enableLimit && this.m_limitState != p.e_inactiveLimit) {
                var D = this.m_axis.x * (l.x - r.x) + this.m_axis.y * (l.y - r.y) + this.m_a2 * m - this.m_a1 * a,
                ...
                S.x += B.x, S.y += B.y, this.m_impulse.x = S.x, this.m_impulse.y = S.y, C.x = this.m_impulse.x - B.x, C.y = this.m_impulse.y - B.y, C.z = this.m_impulse.z - B.z, c = C.x * this.m_perp.x + C.z * this.m_axis.x, h = C.x * this.m_perp.y + C.z * this.m_axis.y, _ = C.x * this.m_s1 + C.y + C.z * this.m_a1, y = C.x * this.m_s2 + C.y + C.z * this.m_a2, r.x -= this.m_invMassA * c, r.y -= this.m_invMassA * h, a -= this.m_invIA * _, l.x += this.m_invMassB * c, l.y += this.m_invMassB * h, m += this.m_invIB * y
            } else {
                var w = this.m_K.Solve22(new n, -b, -v);
                this.m_impulse.x += w.x, this.m_impulse.y += w.y, c = w.x * this.m_perp.x, h = w.x * this.m_perp.y, _ = w.x * this.m_s1 + w.y, y = w.x * this.m_s2 + w.y, r.x -= this.m_invMassA * c, r.y -= this.m_invMassA * h, a -= this.m_invIA * _, l.x += this.m_invMassB * c, l.y += this.m_invMassB * h, m += this.m_invIB * y
            }
            o.m_linearVelocity.SetV(r), o.m_angularVelocity = a, i.m_linearVelocity.SetV(l), i.m_angularVelocity = m
            ...
            return m.x -= this.m_invMassA * k, m.y -= this.m_invMassA * N, c -= this.m_invIA * z, h.x += this.m_invMassB * k, h.y += this.m_invMassB * N, _ += this.m_invIB * E, a.m_sweep.a = c, l.m_sweep.a = _, a.SynchronizeTransform(), l.SynchronizeTransform(), d <= t.b2_linearSlop && b <= t.b2_angularSlop
        ...
        }, C.prototype.Initialize = function(t, o, i, e) {
            this.bodyA = t, this.bodyB = o, this.localAnchorA = this.bodyA.GetLocalPoint(i), this.localAnchorB = this.bodyB.GetLocalPoint(i), this.localAxisA = this.bodyA.GetLocalVector(e), this.referenceAngle = this.bodyB.GetAngle() - this.bodyA.GetAngle()
        ...
        A.prototype.GetLength2 = function() {
            ...
            var l = this.m_localAnchor2.x - n.m_sweep.localCenter.x,
                m = this.m_localAnchor2.y - n.m_sweep.localCenter.y;
            a = i.col1.x * l + i.col2.x * m, m = i.col1.y * l + i.col2.y * m, l = a;
            ...
            var D = s * this.m_u1.y - r * this.m_u1.x,
                B = l * this.m_u2.y - m * this.m_u2.x;
            if (this.m_limitMass1 = e.m_invMass + e.m_invI * D * D, this.m_limitMass2 = n.m_invMass + n.m_invI * B * B, this.m_pulleyMass = this.m_limitMass1 + this.m_ratio * this.m_ratio * this.m_limitMass2, this.m_limitMass1 = 1 / this.m_limitMass1, this.m_limitMass2 = 1 / this.m_limitMass2, this.m_pulleyMass = 1 / this.m_pulleyMass, o.warmStarting) {
                this.m_impulse *= o.dtRatio, this.m_limitImpulse1 *= o.dtRatio, this.m_limitImpulse2 *= o.dtRatio;
                ...
                e.m_linearVelocity.x += e.m_invMass * C, e.m_linearVelocity.y += e.m_invMass * A, e.m_angularVelocity += e.m_invI * (s * A - r * C), n.m_linearVelocity.x += n.m_invMass * g, n.m_linearVelocity.y += n.m_invMass * S, n.m_angularVelocity += n.m_invI * (l * S - m * g)
        ...
        }, g.prototype.Initialize = function(t, o, i, e, n, s, r) {
            void 0 === r && (r = 0), this.bodyA = t, this.bodyB = o, this.groundAnchorA.SetV(i), this.groundAnchorB.SetV(e), this.localAnchorA = this.bodyA.GetLocalPoint(n), this.localAnchorB = this.bodyB.GetLocalPoint(s);
            var a = n.x - i.x,
                l = n.y - i.y;
            ...
            Box2D.Dynamics.Joints.b2Joint.b2Joint.apply(this, arguments), this.K = new o, this.K1 = new o, this.K2 = new o, this.K3 = new o, this.impulse3 = new s, this.impulse2 = new n, this.reduced = new n, this.m_localAnchor1 = new n, this.m_localAnchor2 = new n, this.m_impulse = new s, this.m_mass = new i
        ...
        }, S.prototype.SetLimits = function(t, o) {
            void 0 === t && (t = 0), void 0 === o && (o = 0), this.m_lowerAngle = t, this.m_upperAngle = o
        ...
        }, S.prototype.InitVelocityConstraints = function(o) {
            var i, n = this.m_bodyA,
                s = this.m_bodyB,
                r = 0;
            ...
            r = i.col1.x * a + i.col2.x * l, l = i.col1.y * a + i.col2.y * l, a = r, i = s.m_xf.R;
            var m = this.m_localAnchor2.x - s.m_sweep.localCenter.x,
                c = this.m_localAnchor2.y - s.m_sweep.localCenter.y;
            r = i.col1.x * m + i.col2.x * c, c = i.col1.y * m + i.col2.y * c, m = r;
            var h = n.m_invMass,
                _ = s.m_invMass,
                y = n.m_invI,
                u = s.m_invI;
            if (this.m_mass.col1.x = h + _ + l * l * y + c * c * u, this.m_mass.col2.x = -l * a * y - c * m * u, this.m_mass.col3.x = -l * y - c * u, this.m_mass.col1.y = this.m_mass.col2.x, this.m_mass.col2.y = h + _ + a * a * y + m * m * u, this.m_mass.col3.y = a * y + m * u, this.m_mass.col1.z = this.m_mass.col3.x, this.m_mass.col2.z = this.m_mass.col3.y, this.m_mass.col3.z = y + u, this.m_motorMass = 1 / (y + u), 0 == this.m_enableMotor && (this.m_motorImpulse = 0), this.m_enableLimit) {
            ...
            if (o.warmStarting) {
                ...
                var f = this.m_impulse.x,
                    d = this.m_impulse.y;
                n.m_linearVelocity.x -= h * f, n.m_linearVelocity.y -= h * d, n.m_angularVelocity -= y * (a * d - l * f + this.m_motorImpulse + this.m_impulse.z), s.m_linearVelocity.x += _ * f, s.m_linearVelocity.y += _ * d, s.m_angularVelocity += u * (m * d - c * f + this.m_motorImpulse + this.m_impulse.z)
            } else this.m_impulse.SetZero(), this.m_motorImpulse = 0
            ...
            if (this.m_enableLimit && this.m_limitState != p.e_inactiveLimit) {
                o = i.m_xf.R, r = this.m_localAnchor1.x - i.m_sweep.localCenter.x, a = this.m_localAnchor1.y - i.m_sweep.localCenter.y, s = o.col1.x * r + o.col2.x * a, a = o.col1.y * r + o.col2.y * a, r = s, o = n.m_xf.R, l = this.m_localAnchor2.x - n.m_sweep.localCenter.x, m = this.m_localAnchor2.y - n.m_sweep.localCenter.y, s = o.col1.x * l + o.col2.x * m, m = o.col1.y * l + o.col2.y * m, l = s;
                var C = _.x + -y * m - c.x - -h * a,
                    A = _.y + y * l - c.y - h * r,
                    g = y - h;
                this.m_mass.Solve33(this.impulse3, -C, -A, -g), this.m_limitState == p.e_equalLimits ? this.m_impulse.Add(this.impulse3) : this.m_limitState == p.e_atLowerLimit ? this.m_impulse.z + this.impulse3.z < 0 && (this.m_mass.Solve22(this.reduced, -C, -A), this.impulse3.x = this.reduced.x, this.impulse3.y = this.reduced.y, this.impulse3.z = -this.m_impulse.z, this.m_impulse.x += this.reduced.x, this.m_impulse.y += this.reduced.y, this.m_impulse.z = 0) : this.m_limitState == p.e_atUpperLimit && this.m_impulse.z + this.impulse3.z > 0 && (this.m_mass.Solve22(this.reduced, -C, -A), this.impulse3.x = this.reduced.x, this.impulse3.y = this.reduced.y, this.impulse3.z = -this.m_impulse.z, this.m_impulse.x += this.reduced.x, this.m_impulse.y += this.reduced.y, this.m_impulse.z = 0), c.x -= u * this.impulse3.x, c.y -= u * this.impulse3.y, h -= f * (r * this.impulse3.y - a * this.impulse3.x + this.impulse3.z), _.x += x * this.impulse3.x, _.y += x * this.impulse3.y, y += d * (l * this.impulse3.y - m * this.impulse3.x + this.impulse3.z)
            } else {
                o = i.m_xf.R, r = this.m_localAnchor1.x - i.m_sweep.localCenter.x, a = this.m_localAnchor1.y - i.m_sweep.localCenter.y, s = o.col1.x * r + o.col2.x * a, a = o.col1.y * r + o.col2.y * a, r = s, o = n.m_xf.R, l = this.m_localAnchor2.x - n.m_sweep.localCenter.x, m = this.m_localAnchor2.y - n.m_sweep.localCenter.y, s = o.col1.x * l + o.col2.x * m, m = o.col1.y * l + o.col2.y * m, l = s;
                var S = _.x + -y * m - c.x - -h * a,
                    w = _.y + y * l - c.y - h * r;
                this.m_mass.Solve22(this.impulse2, -S, -w), this.m_impulse.x += this.impulse2.x, this.m_impulse.y += this.impulse2.y, c.x -= u * this.impulse2.x, c.y -= u * this.impulse2.y, h -= f * (r * this.impulse2.y - a * this.impulse2.x), _.x += x * this.impulse2.x, _.y += x * this.impulse2.y, y += d * (l * this.impulse2.y - m * this.impulse2.x)
            }
            i.m_linearVelocity.SetV(c), i.m_angularVelocity = h, n.m_linearVelocity.SetV(_), n.m_angularVelocity = y
        }, S.prototype.SolvePositionConstraints = function(o) {
            void 0 === o && (o = 0);
            var i, n = 0,
                s = this.m_bodyA,
                r = this.m_bodyB,
            ...
            m = i.col1.x * u + i.col2.x * x, x = i.col1.y * u + i.col2.y * x, u = m, i = r.m_xf.R;
            var f = this.m_localAnchor2.x - r.m_sweep.localCenter.x,
                d = this.m_localAnchor2.y - r.m_sweep.localCenter.y;
            m = i.col1.x * f + i.col2.x * d, d = i.col1.y * f + i.col2.y * d, f = m;
        ...
        }, w.prototype.Initialize = function(t, o, i) {
            this.bodyA = t, this.bodyB = o, this.localAnchorA = this.bodyA.GetLocalPoint(i), this.localAnchorB = this.bodyB.GetLocalPoint(i), this.referenceAngle = this.bodyB.GetAngle() - this.bodyA.GetAngle()
            ...
            i = o.col1.x * s + o.col2.x * r, r = o.col1.y * s + o.col2.y * r, s = i, o = n.m_xf.R;
            var a = this.m_localAnchorB.x - n.m_sweep.localCenter.x,
                l = this.m_localAnchorB.y - n.m_sweep.localCenter.y;
            i = o.col1.x * a + o.col2.x * l, l = o.col1.y * a + o.col2.y * l, a = i;
            var m = e.m_invMass,
                c = n.m_invMass,
                h = e.m_invI,
                _ = n.m_invI;
            this.m_mass.col1.x = m + c + r * r * h + l * l * _, this.m_mass.col2.x = -r * s * h - l * a * _, this.m_mass.col3.x = -r * h - l * _, this.m_mass.col1.y = this.m_mass.col2.x, this.m_mass.col2.y = m + c + s * s * h + a * a * _, this.m_mass.col3.y = s * h + a * _, this.m_mass.col1.z = this.m_mass.col3.x, this.m_mass.col2.z = this.m_mass.col3.y, this.m_mass.col3.z = h + _, t.warmStarting ? (this.m_impulse.x *= t.dtRatio, this.m_impulse.y *= t.dtRatio, this.m_impulse.z *= t.dtRatio, e.m_linearVelocity.x -= m * this.m_impulse.x, e.m_linearVelocity.y -= m * this.m_impulse.y, e.m_angularVelocity -= h * (s * this.m_impulse.y - r * this.m_impulse.x + this.m_impulse.z), n.m_linearVelocity.x += c * this.m_impulse.x, n.m_linearVelocity.y += c * this.m_impulse.y, n.m_angularVelocity += _ * (a * this.m_impulse.y - l * this.m_impulse.x + this.m_impulse.z)) : this.m_impulse.SetZero()
            ...
            i = o.col1.x * y + o.col2.x * u, u = o.col1.y * y + o.col2.y * u, y = i, o = n.m_xf.R;
            var x = this.m_localAnchorB.x - n.m_sweep.localCenter.x,
                f = this.m_localAnchorB.y - n.m_sweep.localCenter.y;
            i = o.col1.x * x + o.col2.x * f, f = o.col1.y * x + o.col2.y * f, x = i;
            var d = l.x - m * f - r.x + a * u,
                b = l.y + m * x - r.y - a * y,
                v = m - a,
                D = new s;
            this.m_mass.Solve33(D, -d, -b, -v), this.m_impulse.Add(D), r.x -= c * D.x, r.y -= c * D.y, a -= _ * (y * D.y - u * D.x + D.z), l.x += h * D.x, l.y += h * D.y, m += p * (x * D.y - f * D.x + D.z), e.m_angularVelocity = a, n.m_angularVelocity = m
        }, M.prototype.SolvePositionConstraints = function(o) {
            void 0 === o && (o = 0);
            var i, n = 0,
                r = this.m_bodyA,
                a = this.m_bodyB;
            ...
            n = i.col1.x * l + i.col2.x * m, m = i.col1.y * l + i.col2.y * m, l = n, i = a.m_xf.R;
            var c = this.m_localAnchorB.x - a.m_sweep.localCenter.x,
                h = this.m_localAnchorB.y - a.m_sweep.localCenter.y;
            n = i.col1.x * c + i.col2.x * h, h = i.col1.y * c + i.col2.y * h, c = n;
            var _ = r.m_invMass,
                p = a.m_invMass,
                y = r.m_invI,
                u = a.m_invI,
                ...
                v = Math.sqrt(x * x + f * f),
                D = e.Abs(d);
            v > b && (y *= 1, u *= 1), this.m_mass.col1.x = _ + p + m * m * y + h * h * u, this.m_mass.col2.x = -m * l * y - h * c * u, this.m_mass.col3.x = -m * y - h * u, this.m_mass.col1.y = this.m_mass.col2.x, this.m_mass.col2.y = _ + p + l * l * y + c * c * u, this.m_mass.col3.y = l * y + c * u, this.m_mass.col1.z = this.m_mass.col3.x, this.m_mass.col2.z = this.m_mass.col3.y, this.m_mass.col3.z = y + u;
            var B = new s;
            return this.m_mass.Solve33(B, -x, -f, -d), r.m_sweep.c.x -= _ * B.x, r.m_sweep.c.y -= _ * B.y, r.m_sweep.a -= y * (l * B.y - m * B.x + B.z), a.m_sweep.c.x += p * B.x, a.m_sweep.c.y += p * B.y, a.m_sweep.a += u * (c * B.y - h * B.x + B.z), r.SynchronizeTransform(), a.SynchronizeTransform(), v <= t.b2_linearSlop && D <= t.b2_angularSlop
        ...
        }, V.prototype.Initialize = function(t, o, i) {
            this.bodyA = t, this.bodyB = o, this.localAnchorA.SetV(this.bodyA.GetLocalPoint(i)), this.localAnchorB.SetV(this.bodyB.GetLocalPoint(i)), this.referenceAngle = this.bodyB.GetAngle() - this.bodyA.GetAngle()
        }
    }(),
    function() {
        ...
        t.b2DebugDraw = function() {
            ...
            return "rgba(" + ((16711680 & t) >> 16) + "," + ((65280 & t) >> 8) + "," + (255 & t) + "," + o + ")"
            ...
            if (o) {
                var e = this.m_ctx,
                    n = this.m_drawScale;
                e.graphics.lineStyle(this.m_lineThickness, i.color, this.m_alpha), e.graphics.moveTo(t[0].x * n, t[0].y * n);
                for (var s = 1; s < o; s++) e.graphics.lineTo(t[s].x * n, t[s].y * n);
            ...
            if (o) {
                var e = this.m_ctx,
                    n = this.m_drawScale;
                e.graphics.lineStyle(this.m_lineThickness, i.color, this.m_alpha), e.graphics.beginFill(i.color, this.m_fillAlpha), e.graphics.moveTo(t[0].x * n, t[0].y * n);
                for (var s = 1; s < o; s++) e.graphics.lineTo(t[s].x * n, t[s].y * n);
            ...
            if (o) {
                var e = this.m_ctx,
                    n = this.m_drawScale;
                e.graphics.lineStyle(this.m_lineThickness, i.color, this.m_alpha), e.graphics.drawCircle(t.x * n, t.y * n, o * n), e.graphics.endFill()
            }
            ...
            if (o) {
                var n = this.m_ctx,
                    s = this.m_drawScale;
                t.x, t.y;
                n.graphics.moveTo(0, 0), n.graphics.lineStyle(this.m_lineThickness, e.color, this.m_alpha), n.graphics.beginFill(e.color, this.m_fillAlpha), n.graphics.drawCircle(t.x * s, t.y * s, o * s), n.graphics.endFill(), n.graphics.moveTo(0, 0), n.graphics.lineTo((t.x + i.x * o) * s, (t.y + i.y * o) * s)
            }
        }, t.prototype.DrawSegment = function(t, o, i) {
            var e = this.m_ctx,
                n = this.m_drawScale;
            e.graphics.lineStyle(this.m_lineThickness, i.color, this.m_alpha), e.graphics.moveTo(t.x * n, t.y * n), e.graphics.lineTo(o.x * n, o.y * n)
        }, t.prototype.DrawTransform = function(t) {
            var o = this.m_ctx,
                i = this.m_drawScale;
            o.graphics.lineStyle(this.m_lineThickness, 16711680, this.m_alpha), o.graphics.moveTo(t.position.x * i, t.position.y * i), o.graphics.lineTo((t.position.x + this.m_xformScale * t.R.col1.x) * i, (t.position.y + this.m_xformScale * t.R.col1.y) * i), o.graphics.lineStyle(this.m_lineThickness, 65280, this.m_alpha), o.graphics.moveTo(t.position.x * i, t.position.y * i), o.graphics.lineTo((t.position.x + this.m_xformScale * t.R.col2.x) * i, (t.position.y + this.m_xformScale * t.R.col2.y) * i)
        }
    }();
var i;
