! function(t, e) {
    ...
    class p extends n {
        ...
        destroy(t = !0) {
            super.destroy(t), this._colorPanel && this._colorPanel.destroy(t), this._colorButton && this._colorButton.destroy(t), this._colorPanel = null, this._colorTiles = null, this._colorBlock = null, this._colorInput = null, this._colorButton = null, this._colors = null, this.changeHandler = null
        }
        createChildren() {
    ...
    class v extends n {
        constructor(t = null) {
            super(), this.isVertical = !0, this.showLabel = !0, this._max = 100, this._min = 0, this._tick = 1, this._value = 0, v.label || (v.label = new C), this.skin = t
        }
        destroy(t = !0) {
    ...
    class m extends n {
        constructor(t = null) {
            super(), this.rollRatio = .97, this.scaleBar = !0, this.autoHide = !1, this.elasticDistance = 0, this.elasticBackTime = 500, this._showButtons = s.showButtons, this._scrollSize = 1, this._thumbPercent = 1, this._lastOffset = 0, this._checkElastic = !1, this._isElastic = !1, this._hide = !1, this._clickOnly = !0, this._touchScrollEnable = s.touchScrollEnable, this._mouseWheelEnable = s.mouseWheelEnable, this.skin = t, this.max = 1
        }
        destroy(t = !0) {
    ...
    class y extends n {
        ...
        destroy(t = !0) {
            super.destroy(t), this._button && this._button.destroy(t), this._list && this._list.destroy(t), this._button = null, this._list = null, this._itemColors = null, this._labels = null, this._selectHandler = null
        }
        createChildren() {
    ...
    class L extends c {
        ...
        delItem(t, e = !0) {
            ...
            if (-1 != s) {
                ...
                this.initItems(), this._selectedIndex > -1 && (i = this._selectedIndex < this._items.length ? this._selectedIndex : this._selectedIndex - 1, this._selectedIndex = -1, this.selectedIndex = i)
            }
        }
        _afterInited() {
            this.initItems()
    ...
    class A extends c {
        ...
        removeChildAt(t) {
            return this.getChildAt(t).off(e.Event.RESIZE, this, this.onResize), this._setItemChanged(), super.removeChildAt(t)
        }
        refresh() {
            this._setItemChanged()
        }
    ...
    class H extends A {
        ...
        changeItems() {
            ...
            this.sortItem(t);
            var a = 0;
            for (s = 0, i = t.length; s < i; s++)(h = t[s]).x = a, a += h.width * h.scaleX + this._space, this._align == H.TOP ? h.y = 0 : this._align == H.MIDDLE ? h.y = .5 * (e - h.height * h.scaleY) : this._align == H.BOTTOM && (h.y = e - h.height * h.scaleY);
            this._sizeChanged()
        }
    }
    H.NONE = "none", H.TOP = "top", H.MIDDLE = "middle", H.BOTTOM = "bottom", e.ILaya.regClass(H), e.ClassUtils.regClass("laya.ui.HBox", H), e.ClassUtils.regClass("Laya.HBox", H);
    class N extends A {
        set width(t) {
        ...
        changeItems() {
            ...
            this.sortItem(t);
            var a = 0;
            for (s = 0, i = t.length; s < i; s++)(h = t[s]).y = a, a += h.height * h.scaleY + this._space, this._align == N.LEFT ? h.x = 0 : this._align == N.CENTER ? h.x = .5 * (e - h.width * h.scaleX) : this._align == N.RIGHT && (h.x = e - h.width * h.scaleX);
            this._sizeChanged()
        }
    }
    ...
    class Y extends e.Scene {
        ...
        changeData(t) {
            ...
            if (e)
                for (var s = 0, i = e.length; s < i; s++) e[s].exe(this)
        }
        get top() {
            return this._widget.top
        }
